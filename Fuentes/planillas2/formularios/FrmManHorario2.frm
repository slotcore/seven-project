...
Begin VB.Form FrmManHorario2 
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManHorario2.frx":0000
            Key             =   "IMG1"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManHorario2.frx":0544
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManHorario2.frx":08D6
            Key             =   "IMG2"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManHorario2.frx":0A5A
            Key             =   "IMG3"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManHorario2.frx":0EAE
            Key             =   "IMG4"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManHorario2.frx":0FC6
            Key             =   "IMG5"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManHorario2.frx":150A
            Key             =   "IMG6"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManHorario2.frx":1A4E
            Key             =   "IMG7"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManHorario2.frx":1B62
            Key             =   "IMG8"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManHorario2.frx":1C76
            Key             =   "IMG9"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManHorario2.frx":20CA
            Key             =   "IMG10"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManHorario2.frx":2236
            Key             =   "IMG11"
         EndProperty
      EndProperty
   End
   ...
   Begin SizerOneLibCtl.TabOne TabOne1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton cb 
            ...
            Index           =   0
            Left            =   2520
            Picture         =   "FrmManHorario2.frx":277E
            Style           =   1  'Graphical
            TabIndex        =   20
            Top             =   1095
            Width           =   255
         ...
         Begin VB.Frame Frame4 
            ...
            Begin VSFlex7Ctl.VSFlexGrid fg 
               ...
               FormatString    =   $"FrmManHorario2.frx":28B0
               ScrollTrack     =   0   'False
               ScrollBars      =   3
               ScrollTips      =   0   'False
               MergeCells      =   0
         ...
         Begin VB.Frame Frame3 
            ...
            Begin VSFlex7Ctl.VSFlexGrid fg 
               ...
               ColWidthMax     =   0
               ExtendLastCol   =   0   'False
               FormatString    =   $"FrmManHorario2.frx":2934
               ScrollTrack     =   0   'False
               ScrollBars      =   3
               ScrollTips      =   0   'False
               MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "FrmManHorario2"
...
Private Sub pRegistroAdd(Index As Integer, Optional fSeleccionVarios As Boolean = False)
    ...
    Select Case Index
        Case 0 '--
            ...
            xCampos(2, 0) = "DNI":               xCampos(2, 1) = "numdoc":         xCampos(2, 2) = "500":      xCampos(2, 3) = "c":    xCampos(2, 4) = "N"
            '---------
            nSQLId = GRID_GENERAR_SQL_ID(fg(0), 1, "pla_empleados.id", " NOT IN ", True)
            If nSQLId <> "" Then nSQLId = " AND " & nSQLId
            '---------
            nTitulo = "Buscando Personal"
            nSQL = "SELECT 0 AS xsel, pla_empleados.id, pla_empleados.nombre AS nombres,format(pla_empleados.fching,'dd/mm/yyyy') as fching1, pla_empleados.numdoc " _
    ...
    Do While Not xRs.EOF
        With fg(Index)
            ...
            .TextMatrix(.Rows - 1, 3) = NulosC(xRs.Fields("numdoc"))
...
'    On Error GoTo error
    With RstFrm
        ...
        If IsDate(.Fields("tolerancia")) = True Then
            dtpk(0).Value = Format(.Fields("tolerancia"), "HH:mm")
        End If
        '---
        MuestraDetalle
    End With
...
Private Sub MuestraDetalle()
    ...
    '--del personal
    nSQL = "SELECT pla_empleados.id, UCase([nombre]) AS nombres, mae_sexo.abrev AS sexo, pla_empleados.numdoc " _
        + vbCr + "FROM (mae_sexo RIGHT JOIN pla_empleados ON mae_sexo.id = pla_empleados.idsex) INNER JOIN mae_horarioemp ON pla_empleados.id = mae_horarioemp.idemp " _
        ...
        If xRs.RecordCount <> 0 Then
            ...
            Do While Not xRs.EOF
                With fg(1)
                    ...
                    .TextMatrix(.Rows - 1, 3) = Format(NulosC(xRs.Fields("hingreso")), FORMAT_HORA_SIN_SEGUNDO)
                    .TextMatrix(.Rows - 1, 4) = Format(NulosC(xRs.Fields("hsalida")), FORMAT_HORA_SIN_SEGUNDO)
                    xRs.MoveNext
                End With
            Loop
        End If
...
Private Sub pConfigurarGrilla()
    With fg(0) '--del personal
        ...
        .TextMatrix(0, 2) = "Apellidos y Nombres":  .ColWidth(2) = 4500:    .ColAlignment(2) = flexAlignLeftCenter:     .Row = 0: .Col = 2: .CellAlignment = flexAlignLeftCenter
        .TextMatrix(0, 3) = "DNI":                  .ColWidth(3) = 1000:    .ColAlignment(3) = flexAlignGeneral:    .Row = 0: .Col = 3: .CellAlignment = flexAlignCenterCenter
