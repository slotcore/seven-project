...
Begin VB.Form FrmResumenHoras 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Planillas - Resumen de Horas"
   ClientHeight    =   7590
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   11850
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmResumenHoras.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmResumenHoras.frx":0544
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmResumenHoras.frx":06C8
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmResumenHoras.frx":0B1C
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmResumenHoras.frx":0C34
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmResumenHoras.frx":1178
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmResumenHoras.frx":16BC
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmResumenHoras.frx":17D0
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmResumenHoras.frx":18E4
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmResumenHoras.frx":1D38
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmResumenHoras.frx":1EA4
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin SizerOneLibCtl.TabOne TabOne1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.Label Label1 
            Alignment       =   2  'Center
            Caption         =   "Consulta de Resumen de Horas"
            BeginProperty Font 
               Name            =   "Courier"
               Size            =   9.75
               Charset         =   0
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton cb 
            ...
            Index           =   1
            Left            =   6420
            Picture         =   "FrmResumenHoras.frx":23EC
            Style           =   1  'Graphical
            TabIndex        =   26
         ...
         Begin VB.CommandButton cb 
            ...
            Index           =   0
            Left            =   1650
            Picture         =   "FrmResumenHoras.frx":251E
            Style           =   1  'Graphical
            TabIndex        =   20
            ToolTipText     =   "Seleccione la Categoría de Concepto"
            Top             =   735
         ...
         Begin VSFlex7Ctl.VSFlexGrid Fg1 
            ...
            FormatString    =   $"FrmResumenHoras.frx":2650
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
         ...
         Begin VB.Label Label5 
            Alignment       =   2  'Center
            Caption         =   "Detalle del Resumen de Horas"
            BeginProperty Font 
               Name            =   "Courier"
               Size            =   9.75
               Charset         =   0
   ...
   End
End
Attribute VB_Name = "FrmResumenHoras"
...
Sub Cancelar()
    ActivaTool
    Label5.Caption = "Detalle del Resumen de Horas"
    QueHace = 3
    Bloquea False
        ...
        Case mColInicioEdicion, mColInicioEdicion - 1
            ...
            Else
                If Col = mColInicioEdicion - 1 Then
                    Fg1.TextMatrix(Row, Col + 2) = Fg1.TextMatrix(Row, Col) * 8
                    Fg1_CellChanged Row, Col + 2
                End If
            End If
...
Function Grabar() As Boolean
    ...
    If MsgBox("Seguro desea " + IIf(QueHace = 1, "Grabar", "Modificar") + " el Resumen de Horas", vbQuestion + vbYesNo, xTitulo) = vbNo Then Exit Function
...
'                End If
    ...
    MsgBox "Los datos del Resumen de Horas se " + IIf(QueHace = 1, "grabaron", "modificaron") + " con éxito", vbInformation, xTitulo
...
Sub nuevo()
    ...
    Label5.Caption = "Agregando Resumen de Horas"
    txtfecha(0).SetFocus
End Sub
...
Sub Modificar()
    If RstFrm.RecordCount = 0 Then
        ...
        Exit Sub
    End If
    Label5.Caption = "Modificando del Resumen de Horas"
...
Sub Eliminar()
    ...
    RST_Busq RstBus, "SELECT * FROM pla_boleta WHERE idresmarca = " & RstFrm("id") & "", xCon
    If RstBus.RecordCount <> 0 Then
        MsgBox "No se puede eliminar el registro, pues se ha generado pagos...", vbInformation + vbOKOnly + vbDefaultButton1, xTitulo
        Set RstBus = Nothing
        Exit Sub
    End If
    ...
    If Rpta = vbYes Then
        xCon.Execute "DELETE FROM pla_marcaresumhor WHERE idres=" & RstFrm.Fields("id") & " ;"
        xCon.Execute "DELETE FROM pla_marcaresumemp WHERE idres=" & RstFrm.Fields("id") & " ;"
        xCon.Execute "DELETE FROM pla_marcaresum WHERE id = " & RstFrm("id") & ""
...
Private Sub pRegistroAdd(Optional fSeleccionVarios As Boolean = True)
    ...
    Dim xRs As New ADODB.Recordset
    Dim nSQL As String
    Dim nSQLId As String '--almacenara los codigos del personal ya seleccionados
    Dim nSQLNotInDocumentos As String
    Dim nTitulo As String
    Dim nSQLIdTrabajo As String
    
    xCampos(0, 0) = "TipDoc":               xCampos(0, 1) = "docabrev":   xCampos(0, 2) = "700":    xCampos(0, 3) = "C"
    xCampos(1, 0) = "Numero":               xCampos(1, 1) = "numdoc":     xCampos(1, 2) = "800":   xCampos(1, 3) = "C"
    xCampos(2, 0) = "Apellidos y Nombres":  xCampos(2, 1) = "nombres":    xCampos(2, 2) = "3200":   xCampos(2, 3) = "C"
    xCampos(3, 0) = "Cat.":                xCampos(3, 1) = "categoria":  xCampos(3, 2) = "450":    xCampos(3, 3) = "C"
    xCampos(4, 0) = "Cargo":                xCampos(4, 1) = "cargo":      xCampos(4, 2) = "1400":   xCampos(4, 3) = "C"
    xCampos(5, 0) = "Centro Trabajo":       xCampos(5, 1) = "lugartra":   xCampos(5, 2) = "1000":   xCampos(5, 3) = "C"
    xCampos(6, 0) = "Fch.Ing":              xCampos(6, 1) = "ingreso":    xCampos(6, 2) = "900":    xCampos(6, 3) = "c"
'
    '*************************************************************
    nSQLId = GRID_GENERAR_SQL_ID(Fg1, 1, "pla_empleados.id", " NOT IN ")
   ...
   '--si hay lugar de trabajo
    ...
    '*************************************************************
    nSQL = "SELECT pla_empleados.id, mae_dociden.abrev AS docabrev, pla_empleados.numdoc, [pla_empleados].[apepat] & ' ' & [pla_empleados].[apemat] & ' ' & [pla_empleados].[nom] AS nombres, mae_categoria.nomcor AS categoria, mae_cargo.descripcion AS cargo, mae_empresalugtra.descripcion AS lugartra, format(pla_periodolaboral.fchini,'dd/mm/yy') AS ingreso " _
            + vbCr + " FROM (mae_categoria RIGHT JOIN (((mae_cargo RIGHT JOIN pla_empleados ON mae_cargo.id = pla_empleados.idcargo) LEFT JOIN mae_empresalugtra ON pla_empleados.idlugtra = mae_empresalugtra.id) LEFT JOIN pla_periodolaboral ON pla_empleados.id = pla_periodolaboral.idemp) ON mae_categoria.id = pla_periodolaboral.idcat) LEFT JOIN mae_dociden ON pla_empleados.idtipdoc = mae_dociden.id " _
            + vbCr + " WHERE (((pla_empleados.idbolpag)=" & NulosN(lbl_cod(0).Caption) & ")) " & nSQLIdTrabajo & " AND pla_periodolaboral.fchfin Is Null " & nSQLId
    ...
    Do While Not xRs.EOF
        ...
        Fg1.TextMatrix(Fg1.Rows - 1, 2) = NulosC(xRs("nombres"))
        Fg1.TextMatrix(Fg1.Rows - 1, 3) = NulosC(xRs("cargo"))
        Fg1.TextMatrix(Fg1.Rows - 1, 4) = NulosC(xRs("lugartra"))
        Fg1.TextMatrix(Fg1.Rows - 1, 5) = Format(NulosC(xRs("ingreso")), FORMAT_DATE)
        '-----------
