...
Private Sub pCargarGrid()
    ...
    cSQL = "SELECT etiqueta.*, etiqueta.fchpro & '' as fchpro1, etiqueta.fchven & '' as fchven1, etiqueta.numlot & '' as numlot1, etiqueta.idform & '' as idform1 " _
            + vbCr + "FROM etiqueta " _
            + vbCr + "WHERE desactiva = 0 " _
            + vbCr + "ORDER BY titulo1"
            
    ' cargando datos
    Me.MousePointer = vbHourglass
         
    RST_Busq RstLista, cSQL, xConEtiqueta
