...
Begin VB.Form FrmManFamilia 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Almacén - Familia"
   ClientHeight    =   7170
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   10635
   ...
   Begin SizerOneLibCtl.TabOne TabOne1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.Frame Frame3 
            ...
            Begin VB.CommandButton cb 
               ...
               Index           =   0
               Left            =   2295
               Picture         =   "FrmManFamilia.frx":0000
               Style           =   1  'Graphical
               TabIndex        =   0
               Top             =   1050
               Width           =   225
         ...
         Begin VB.Label Label1 
            Alignment       =   2  'Center
            Caption         =   "Detalle del la Familia"
            BeginProperty Font 
               Name            =   "Courier New"
               Size            =   11.25
               Charset         =   0
      ...
      Begin VB.Frame Frame1 
         ...
         Begin TrueOleDBGrid70.TDBGrid Dg3 
            ...
            Splits(0)._ColumnProps(19)=   "Column(3).Width=5106"
            Splits(0)._ColumnProps(20)=   "Column(3).DividerColor=0"
            Splits(0)._ColumnProps(21)=   "Column(3)._WidthInPix=5027"
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmManFamilia.frx":0132
               Key             =   "IMG1"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmManFamilia.frx":0676
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmManFamilia.frx":0A08
               Key             =   "IMG2"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmManFamilia.frx":0B8C
               Key             =   "IMG3"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmManFamilia.frx":0FE0
               Key             =   "IMG4"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmManFamilia.frx":10F8
               Key             =   "IMG5"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmManFamilia.frx":163C
               Key             =   "IMG6"
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmManFamilia.frx":1B80
               Key             =   "IMG7"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmManFamilia.frx":1C94
               Key             =   "IMG8"
            EndProperty
            BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmManFamilia.frx":1DA8
               Key             =   "IMG9"
            EndProperty
            BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmManFamilia.frx":21FC
               Key             =   "IMG10"
            EndProperty
            BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmManFamilia.frx":2368
               Key             =   "IMG11"
            EndProperty
         EndProperty
      End
   ...
   End
End
Attribute VB_Name = "FrmManFamilia"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'*****************************************************************************************************
'* Nombre Archivo   : FRMMANFAMILIA.FRM
'* Tipo             : FORMULARIO
...
Private Sub Form_Activate()
    ' SEGUNDO EVENTO QUE SE EJECUTARA AL INICIAR EL FORMULARIO, ESTE EVENTO SE EJECUTARA UNA SOLA VEZ
    ' LA VARIABLE SeEjecuto FUNCIONA COMO UN SWITCH
...
'* Nombre           : CARGAR_GRID
'* Tipo             : PROCEDIMIENTO
'* Descripcion      : CARGA EL RECORSET RstFrm CON REGISTROS DE LA TABLA mae_familia
'* Paranetros       :
'* Devuelve         :
'*****************************************************************************************************
Private Sub CARGAR_GRID()
    ...
    xSQL = "SELECT mae_familia.id, mae_familia.descripcion, mae_familia.prefijo, mae_tipoproducto.id AS tipproid, mae_tipoproducto.descripcion AS tipprodesc " _
        & " FROM mae_tipoproducto RIGHT JOIN mae_familia ON mae_tipoproducto.id = mae_familia.idtippro ORDER BY mae_familia.descripcion, mae_tipoproducto.descripcion"
...
Private Sub Form_Load()
    ' PRIMER EVENTO A EJECUTARSE CUANDO CARGA EL FORMULARIO
    CentrarFrm Me
    SeEjecuto = False
    QueHace = 3
...
Sub Eliminar()
    ...
    If Rpta = vbYes Then
        xCon.Execute "DELETe * FROM mae_familia WHERE id = " & RstFrm("id") & ""
...
Sub Cancelar()
    ...
    ActivaTool
    Habilitar_Obj False
    Label1.Caption = "Detalle del la Familia"
    TabOne1.CurrTab = 0
    Dg3.SetFocus
End Sub
...
Private Sub Modificar()
    ...
    Label1.Caption = "Modificando la Familia"
    txt_cb(0).SetFocus
End Sub
...
'* Tipo             : PROCEDIMIENTO
'* Descripcion      : ACTIVA DESACTIVA LOS CONTROLES TextBox  DEL FORMULARIO
...
'* Nombre           : Nuevo
'* Tipo             : PROCEDIMIENTO
'* Descripcion      : PREPARA PARA EL INGRESO DE UN NUEVO REGISTRO
'* Paranetros       :
'* Devuelve         :
'*****************************************************************************************************
Private Sub Nuevo()
    ...
    Blanquea
    Habilitar_Obj True
    Label1.Caption = "Agregar Familia"
    txt_cb(0).SetFocus
End Sub
...
Function Grabar() As Boolean
   If VALIDAR_DATOS() = False Then Exit Function
    ...
    If QueHace = 1 Then
        RST_Busq RstCab, "SELECT TOP 1 * FROM mae_familia ", xCon
        xCod = HallaCodigoTabla("mae_familia", xCon, "id")
        RstCab.AddNew
        RstCab("id") = xCod
        txt(0).Text = xCod
    Else
        RST_Busq RstCab, "SELECT * FROM mae_familia WHERE id =" & RstFrm("id") & "", xCon
        xCod = RstFrm("id")
    End If
    
    RstCab("idtippro") = lbl_cb_cod(0).Caption '--ID TIPO PRODUCTO
    ...
    RstCab.Update
'    '*************************************************************************************
'    '*** SINCRONIZAR BASE DE DATOS - mae_familia ***'
'    '*************************************************************************************
    If xDeDonde = 2 Then SincronizarBD xCon, "mae_familia", xCod, QueHace


    'grabamos el movimiento en la tabla var_edicion
    GrabarOperacion xIdUsuario, IdMenuActivo, QueHace, xHorIni, Time, Date, xCon, xCod

    MsgBox "La Familia se " + IIf(QueHace = 1, "grabó", "modificó") + " con éxito", vbInformation, xTitulo
    xCon.CommitTrans
    Grabar = True
salir:
    Set RstCab = Nothing
...
'* Tipo             : FUNCION
'* Descripcion      : VALIDA LOS DATOS INGRESADOS, DEVUELVE VERDADERO SI EL REGISTRO EXISTE EN LA
'*                    TABLA mae_familia
'* Paranetros       :
'* Devuelve         : BOOLEAN
'*****************************************************************************************************
Private Function VALIDAR_DATOS() As Boolean
    ...
    If QueHace = 1 Then
        RST_Busq RstTmp, "SELECT mae_familia.id From mae_familia WHERE ((ucase(trim(mae_familia.descripcion))='" + UCase(Trim(txt(1).Text)) + "') AND ((mae_familia.idtippro)=" + Trim(lbl_cb_cod(0).Caption) + "));", xCon
    Else
        RST_Busq RstTmp, "SELECT mae_familia.id FROM mae_familia WHERE (((mae_familia.id)<>" + CStr(RstFrm.Fields("id")) + ") AND (ucase(trim(mae_familia.descripcion))='" + UCase(Trim(txt(1).Text)) + "') AND ((mae_familia.idtippro)=" + Trim(lbl_cb_cod(0).Caption) + "));", xCon
    End If
...
Private Sub txt_cb_KeyDown(Index As Integer, KeyCode As Integer, Shift As Integer)
    ...
    Select Case Index
        Case 0 '--TIPO PRODUCTO
            N_SQL = "SELECT mae_tipoproducto.id, mae_tipoproducto.descripcion, mae_tipoproducto.id AS cod " _
                & " From mae_tipoproducto " _
                & " Where (((mae_tipoproducto.id) = " + CStr(Trim(txt_cb(Index).Text)) + ")) " _
...
Sub Buscar()
    ...
    xCampos(1, 0) = "Tipo Producto":   xCampos(1, 1) = "tipprodesc":       xCampos(1, 2) = "2000":      xCampos(1, 3) = "C"
        
    N_SQL = "SELECT mae_familia.id, mae_familia.descripcion, mae_familia.prefijo, mae_tipoproducto.id AS tipproid, mae_tipoproducto.descripcion AS tipprodesc " _
        & " FROM mae_tipoproducto RIGHT JOIN mae_familia ON mae_tipoproducto.id = mae_familia.idtippro " _
        & " ORDER BY mae_familia.descripcion, mae_tipoproducto.descripcion;"
         
    CARGAR_DLL_EPSBUSCAR xCon, xRs, N_SQL, xCampos(), "Buscando Familia", "Descripcion", "Descripcion", Principio
    If xRs.State = 0 Then GoTo salir
...
Private Sub Filtrar()
    ...
    xCampos(1, 0) = "Tipo Producto":   xCampos(1, 1) = "tipprodesc":    xCampos(1, 2) = "C":     xCampos(1, 3) = "2500"
...
'* Nombre           : Imprimir
'* Tipo             : PROCEDIMIENTO
'* Descripcion      : IMPRIME LOS REGISTROS DE LA TABLA mae_familia
'* Paranetros       :
'* Devuelve         :
'*****************************************************************************************************
Private Sub Imprimir(Optional IMP_LISTADO As Boolean = False)
    ...
    If IMP_LISTADO = False Then
        ...
        End If
    Else
        TDB_IMPRIMIR Dg3, "IMPRESIÓN DE FAMILIA", "LISTADO DE FAMILIA"
    End If
