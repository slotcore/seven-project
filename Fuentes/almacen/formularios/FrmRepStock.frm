...
Begin VB.Form FrmRepStock 
   Caption         =   "Almacén - Reporte de Lotes"
   ClientHeight    =   8205
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   13320
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmRepStock.frx":0544
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmRepStock.frx":08D6
               Key             =   "IMG2"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmRepStock.frx":0A5A
               Key             =   "IMG3"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmRepStock.frx":0EAE
               Key             =   "IMG4"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmRepStock.frx":0FC6
               Key             =   "IMG5"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmRepStock.frx":150A
               Key             =   "IMG6"
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmRepStock.frx":1A4E
               Key             =   "IMG7"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmRepStock.frx":1B62
               Key             =   "IMG8"
            EndProperty
            BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmRepStock.frx":1C76
               Key             =   "IMG9"
            EndProperty
            BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmRepStock.frx":20CA
               Key             =   "IMG10"
            EndProperty
            BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmRepStock.frx":2236
               Key             =   "IMG11"
            EndProperty
            BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmRepStock.frx":277E
               Key             =   ""
            EndProperty
            BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmRepStock.frx":2A98
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin VB.Frame Frame6 
      ...
      Begin VSFlex7Ctl.VSFlexGrid fg 
         ...
         FormatString    =   $"FrmRepStock.frx":2E2A
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin VSFlex7Ctl.VSFlexGrid fg 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"FrmRepStock.frx":2E87
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
...
Private Sub generarConsulta()
    ...
    CONSULTA_ = GENERAR_SQL_ID(fg(1), 1, " AND alm_inventariolote.iditem", "IN", True)
    FCHINI_ = TxtFchDesde.Valor
    FCHFIN_ = TxtFchHasta.Valor
    
    With fg(0)
    
        .Rows = 1
        cSQL = "SELECT alm_inventariolotedet.idlote, alm_inventariolote.descripcion AS deslote, alm_inventariolote.fching, alm_inventariolote.iditem, alm_inventario.descripcion AS desitem, alm_inventariolotedet.idalm, alm_almacenes.descripcion AS desalm, alm_inventariolotedet.cantidad AS cantot, First(alm_ingreso.idpro) AS idprov, First(alm_ingreso.nombre) AS desprov " _
            ...
            + vbCr + "WHERE (((alm_ingreso.tipmov)=-1) AND ((alm_inventariolote.fching)>=CDate('" & FCHINI_ & "') And (alm_inventariolote.fching)<=CDate('" & FCHFIN_ & "'))) " & CONSULTA_ _
            + vbCr + "GROUP BY alm_inventariolotedet.idlote, alm_inventariolote.descripcion, alm_inventariolote.fching, alm_inventariolote.iditem, alm_inventario.descripcion, alm_inventariolotedet.idalm, alm_almacenes.descripcion, alm_inventariolotedet.cantidad " _
        ...
        While Not xRs.EOF
            ...
            .TextMatrix(.Rows - 1, 7) = Format(NulosC(xRs("fching")), FORMAT_DATE)
            .TextMatrix(.Rows - 1, 8) = NulosC(xRs("desalm"))
            .TextMatrix(.Rows - 1, 9) = NulosC(xRs("desprov"))
            .TextMatrix(.Rows - 1, 10) = Format(NulosN(xRs("cantot")), FORMAT_CANTIDAD)
