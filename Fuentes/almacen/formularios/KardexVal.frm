...
Begin VB.Form frmKardexVal 
   ...
   Begin VB.Frame Frame6 
      ...
      Begin VSFlex7Ctl.VSFlexGrid Fg4 
         ...
         FormatString    =   $"KardexVal.frx":0132
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin SizerOneLibCtl.TabOne TabOne1 
         ...
         Begin VB.Frame Frame5 
            ...
            Begin VSFlex7Ctl.VSFlexGrid Fg1 
               ...
               ColWidthMax     =   0
               ExtendLastCol   =   0   'False
               FormatString    =   $"KardexVal.frx":0235
               ScrollTrack     =   0   'False
               ScrollBars      =   3
               ScrollTips      =   0   'False
               MergeCells      =   0
         ...
         Begin VB.Frame Frame5 
            ...
            Begin VSFlex7Ctl.VSFlexGrid Fg1 
               ...
               ColWidthMax     =   0
               ExtendLastCol   =   0   'False
               FormatString    =   $"KardexVal.frx":0341
               ScrollTrack     =   0   'False
               ScrollBars      =   3
               ScrollTips      =   0   'False
               MergeCells      =   0
         ...
         Begin VB.Frame Frame1 
            ...
            Begin VSFlex7Ctl.VSFlexGrid Fg1 
               ...
               ColWidthMax     =   0
               ExtendLastCol   =   0   'False
               FormatString    =   $"KardexVal.frx":044D
               ScrollTrack     =   0   'False
               ScrollBars      =   3
               ScrollTips      =   0   'False
               MergeCells      =   0
         ...
         Begin VB.Frame Frame4 
            ...
            Begin VSFlex7Ctl.VSFlexGrid Fg1 
               ...
               ColWidthMax     =   0
               ExtendLastCol   =   0   'False
               FormatString    =   $"KardexVal.frx":0559
               ScrollTrack     =   0   'False
               ScrollBars      =   3
               ScrollTips      =   0   'False
               MergeCells      =   0
   ...
   Begin VB.Frame Frame7 
      ...
      Begin VSFlex7Ctl.VSFlexGrid FgEmp 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"KardexVal.frx":0665
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin VB.Frame Frame9 
      ...
      Begin VSFlex7Ctl.VSFlexGrid VSFlexGrid1 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"KardexVal.frx":06DD
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin VSFlex7Ctl.VSFlexGrid FgRes 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   0   'False
      FormatString    =   $"KardexVal.frx":0757
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin VSFlex7Ctl.VSFlexGrid Fg1 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   0   'False
      FormatString    =   $"KardexVal.frx":0887
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "KardexVal.frx":0A1F
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "KardexVal.frx":0F63
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "KardexVal.frx":10BD
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "KardexVal.frx":144F
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "KardexVal.frx":15D3
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "KardexVal.frx":1A27
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "KardexVal.frx":1B3F
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "KardexVal.frx":2083
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "KardexVal.frx":25C7
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "KardexVal.frx":26DB
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "KardexVal.frx":27EF
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "KardexVal.frx":2C43
            Key             =   ""
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "KardexVal.frx":2DAF
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin VSFlex7Ctl.VSFlexGrid fgFinta 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   0   'False
      FormatString    =   $"KardexVal.frx":32F7
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
...
Private Sub LlenaGrilla(xConeccion As ADODB.Connection, IndiceFG As Integer)
    ...
    Sql = "SELECT [mae_prov]![nombre]AS motivo, mae_documento.abrev, [com_compras]![numser]+'-'+[com_compras]![numdoc] AS numdoc, " _
        ...
        & " AND com_compras.fchdoc <= CDATE('" & txtfecFinal.Valor & "') " _
        & " UNION " _
...
Sub MuestraKardexResumido(xFamilia As String, TIPO As Integer)
    ...
    If RstPro.RecordCount <> 0 Then
        ...
        While RstPro.EOF = False
            ...
            xCosIni = Format(Val(RstPro("stckini")) * Val(RstPro("preuni")), "0.0000")
            If optProm.Value = True Then
            ...
            FgRes.TextMatrix(FgRes.Rows - 1, 10) = RstPro("id")
                ...
                xSql = "SELECT Sum([canpro]) AS total, Sum([vta_ventasdet]![imptot]) AS Costo FROM vta_ventas RIGHT JOIN vta_ventasdet ON vta_ventas.id = vta_ventasdet.idvta " _
                     ...
                     & " And (vta_ventas.fchdoc) <= CDATE('" & txtfecFinal.Valor & "')) " _
                     & " AND ((vta_ventasdet.iditem)=" & RstPro("id") & "))" _
                     & " AND vta_ventas.anulado = 0"
            ...
            FgRes.TextMatrix(FgRes.Rows - 1, 6) = Format((xTotEnt + RstPro("stckini")) - xTotSal, "0.00")
            FgRes.TextMatrix(FgRes.Rows - 1, 8) = Format((xCosEnt + xCosIni - xCosSal), "0.00")
            RstPro.MoveNext
        Wend
    Else
        If Opt1.Value = True Then
    ...
    If optProm.Value = True Then
        ...
        If FgRes.TextMatrix(A, 6) > 0 Then
            FgRes.TextMatrix(A, 7) = Format(Val(FgRes.TextMatrix(A, 8)) / Val(FgRes.TextMatrix(A, 6)), "0.00")
            Else
...
Sub ImprimirTodoKardex()
    ...
    For A = 1 To FgRes.Rows - 1
        ...
        Print #1, "     PRODUCTOS :  " + Mid(Trim(FgRes.TextMatrix(A, 1)), 1, 50); Tab(90); "CODIGO  : " + Trim(FgRes.TextMatrix(A, 8))
        xNumLine = xNumLine + 1
        OtraHoja
        ...
        If Opt3.Value = True Then idTipPro = 2
          ...
          'GUIAS
            'Sql = "SELECT mae_documento.descripcion AS tipdoc, [vta_guia]![numser]+' - '+[vta_guia]![numdoc] AS numdoc, " _
            '    & " vta_guia.fecgiro AS fecdoc, vta_guiadet.canpro, 0 AS ent FROM ((mae_documento " _
            '    & " INNER JOIN vta_guia ON mae_documento.id = vta_guia.id) INNER JOIN vta_guiadet ON vta_guia.id = vta_guiadet.idgui) " _
            '   & " INNER JOIN alm_inventario ON mae_documento.id = alm_inventario.id " _
            '    & " WHERE (((vta_guia.fecgiro) >= CDate('" & txtFecInicio.Valor & "') " _
            '    & " AND (vta_guia.fecgiro) <= CDate('" & txtfecFinal.Valor & "')) " _
            '    & " AND ((vta_guia.Anulado)=0) AND ((vta_guiadet.iditem)= " & Trim(FgRes.TextMatrix(A, 8)) & ") " _
            '    & " AND ((alm_inventario.tippro)= " & idTipPro & ")) ORDER BY vta_guia.fecgiro"
        
            'VENTAS ojo ventas no especifica un campo estado como anulado??
            Sql = "SELECT mae_documento.descripcion AS tipdoc, [vta_ventas]![numser]+' - '+[vta_ventas]![numdoc] AS numdoc, " _
                & " vta_ventas.fchdoc AS fecdoc, vta_ventasdet.canpro, 0 AS ent FROM mae_documento RIGHT JOIN (alm_inventario " _
                & " RIGHT JOIN (vta_ventas RIGHT JOIN vta_ventasdet ON vta_ventas.id = vta_ventasdet.idvta) ON alm_inventario.id = vta_ventasdet.iditem) " _
                & " ON mae_documento.id = vta_ventas.tipdoc " _
                & " WHERE (((vta_ventas.fchdoc) >= CDate('" & txtFecInicio.Valor & "') " _
                & " AND (vta_ventas.fchdoc) <= CDate('" & txtfecFinal.Valor & "')) " _
                & " AND ((vta_ventasdet.iditem)= " & Trim(FgRes.TextMatrix(A, 10)) & ") " _
                & " AND ((alm_inventario.tippro)= " & idTipPro & "))"
                
            'COMPRAS
            Sql = Sql + " UNION " _
                  & "SELECT mae_documento.descripcion AS tipdoc, [com_compras]![numser]+' - '+[com_compras]![numdoc] AS numdoc, " _
                  & " com_compras.fchdoc, 0 AS canpro, com_comprasdet.canpro as ent FROM mae_documento RIGHT JOIN (alm_inventario " _
                  & " RIGHT JOIN (com_compras RIGHT JOIN com_comprasdet ON com_compras.id = com_comprasdet.idcom) " _
                  & " ON alm_inventario.id = com_comprasdet.iditem) ON mae_documento.id = com_compras.tipdoc " _
                  & " WHERE com_compras.fchdoc >=CDate('" & txtFecInicio.Valor & "') " _
                  & " And com_compras.fchdoc <=CDate('" & txtfecFinal.Valor & "') " _
                  & " AND com_comprasdet.iditem = " & Trim(FgRes.TextMatrix(A, 10)) & " " _
                  & " AND alm_inventario.tippro = " & idTipPro & " "
        ...
        If rst.RecordCount <> 0 Then
            rst.MoveFirst
            While rst.EOF = False
                xTotEnt = xTotEnt + rst("ent")
                xTotSal = xTotSal + rst("CanPro")
                
                Print #1, Tab(6); Trim(rst("tipdoc")); _
                    Tab(33); Trim(rst("numdoc")); _
                    Tab(53); Format(rst("Fecdoc"), "dd/mm/yy"); _
                    Tab(62); RellenarBlancos(Format(rst("ent"), "0.00"), 9, 2); _
                    Tab(72); RellenarBlancos(Format(rst("CanPro"), "0.00"), 9, 2)
