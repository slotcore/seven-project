...
Begin VB.Form FrmConsultaMayor3 
      ...
      Begin VB.Frame Frame9 
         ...
         Begin VB.Frame Frame10 
            ...
            Begin VB.CommandButton CmdBusProv 
               ...
               Height          =   225
               Left            =   4180
               Picture         =   "FrmConsultaMayor3.frx":0000
               Style           =   1  'Graphical
               TabIndex        =   37
               Top             =   220
               Width           =   210
      ...
      Begin VB.Frame Frame7 
         ...
         Begin VB.Frame Frame1 
            ...
            Begin VB.CommandButton cmd_periodo 
               ...
               Index           =   0
               Left            =   1410
               Picture         =   "FrmConsultaMayor3.frx":0132
               Style           =   1  'Graphical
               TabIndex        =   25
               Top             =   1320
               Width           =   285
            ...
            Begin VB.CommandButton cmd_periodo 
               ...
               Index           =   1
               Left            =   1410
               Picture         =   "FrmConsultaMayor3.frx":04B4
               Style           =   1  'Graphical
               TabIndex        =   24
               Top             =   1650
               Width           =   285
            ...
            Begin VSFlex7Ctl.VSFlexGrid Fg2 
               ...
               FormatString    =   $"FrmConsultaMayor3.frx":0836
               ScrollTrack     =   0   'False
               ScrollBars      =   3
               ScrollTips      =   0   'False
               MergeCells      =   0
         ...
         Begin VB.Frame Frame8 
            ...
            Begin VB.CommandButton CmdBusMon 
               Height          =   230
               Left            =   345
               Picture         =   "FrmConsultaMayor3.frx":08BB
               Style           =   1  'Graphical
               TabIndex        =   20
               Top             =   270
               Width           =   210
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsultaMayor3.frx":09ED
            Key             =   "IMG1"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsultaMayor3.frx":0F31
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsultaMayor3.frx":12C3
            Key             =   "IMG2"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsultaMayor3.frx":1447
            Key             =   "IMG3"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsultaMayor3.frx":189B
            Key             =   "IMG4"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsultaMayor3.frx":19B3
            Key             =   "IMG5"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsultaMayor3.frx":1EF7
            Key             =   "IMG6"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsultaMayor3.frx":243B
            Key             =   "IMG7"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsultaMayor3.frx":254F
            Key             =   "IMG8"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsultaMayor3.frx":2663
            Key             =   "IMG9"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsultaMayor3.frx":2AB7
            Key             =   "IMG10"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsultaMayor3.frx":2C23
            Key             =   "IMG11"
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsultaMayor3.frx":316B
            Key             =   ""
         EndProperty
         BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsultaMayor3.frx":3485
            Key             =   ""
         EndProperty
         BeginProperty ListImage15 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsultaMayor3.frx":3817
            Key             =   ""
         EndProperty
         BeginProperty ListImage16 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsultaMayor3.frx":3BA9
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin SizerOneLibCtl.TabOne TabOne1 
      ...
      Begin VSFlex7Ctl.VSFlexGrid Fg1 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"FrmConsultaMayor3.frx":3EC3
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin VSFlex7Ctl.VSFlexGrid Fg3 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"FrmConsultaMayor3.frx":3FFC
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "FrmConsultaMayor3"
...
Private Sub pImprimirDet()
    ...
    RST_Busq rst, "SELECT con_formatostipodet.*,con_formatostipo.rpttitulo, con_formatostipo.rpttamdet, con_formatostipo.rpttamcab " _
        ...
        & " WHERE (((con_formatostipo.idformato)=5) AND ((con_formatostipodet.mostrar)=-1) AND ((con_formatostipo.defecto)=-1)) " _
...
'        '--DATOS DE FILA
        ...
        If opt_fecha(0).Value = True Then
            ...
            If IsDate(TxtFchFin.Valor) = True Then UNIR_CELDAS Fg3, 0, 9, 0, 10, "Saldos Finales" + vbCr + " Al " + CStr(CDate(TxtFchFin.Valor)), flexAlignCenterCenter
        Else
...
Private Sub Form_Resize()
    ...
    If Me.Height > 3000 Then
        ...
        TabOne1.Height = Me.Height - 2300
        '--muestra el mensaje cuando se consulta los registros
        fra_msg.Top = Me.Height - 900
    End If
End Sub
...
Private Function MuestraMayor1() As Boolean
    ...
    '**********************************************************************************************
    If NulosN(LblIdLibro.Caption) <> 0 Then nSQLIdLibro = " con_diario.idlib=" & LblIdLibro & " AND "
...
'''    End If
    ...
    '-----------------------------------------------
    nSQLCierre = "  (con_diario.idmes<>13) AND "
    '**********************************************************************************************
   ...
   nSQL = "SELECT con_diario.idcue AS idcuenta,con_planctas.tipsal,Format([con_diario].[idmes],'00') & IIf([mae_libros].[codsun] Is Null,'',[mae_libros].[codsun]) & [con_diario].[numasi] AS registro, Format([con_diario].[idmes],'00') AS mes, mae_libros.codsun AS libsun, CDbl(con_diario.numasi) AS corr, mae_libros.descripcion AS libdesc, con_diario.fchdoc AS fchope, con_diario.rglosaope as glosaope, con_diario.rglosa AS glosaref, con_diario.rregistro AS registroref, iif(con_diario.ridtipper=0,tes_documentos.abrev,mae_documento.abrev) AS tdocdesc, con_diario.rfchope AS fchdoc, con_diario.rnumerodoc AS numdoc, " _
    ...
    If opt_fecha(0).Value = True Then
        nSQL = nSQL + vbCr + " WHERE " & nSQLIdLibro & nSQLAjuste & nSQLCierre & " ( con_diario.fchasi >=CDate('" + TxtFchIni.Valor + "') And con_diario.fchasi<=CDate('" + TxtFchFin.Valor + "') ) " _
            + vbCr + " AND ( con_diario.fchasi >=CDate('01/01/" + AnoTra + "') And con_diario.fchasi <= CDate('31/12/" + AnoTra + "') ) "
    Else
        nSQL = nSQL + vbCr + " WHERE " & nSQLIdLibro & nSQLAjuste & " ( con_diario.idmes >= " & mMesIni & " and con_diario.idmes <= " & mMesFin & " ) and con_diario.año = " & AnoTra & " "
    End If
...
'''    End If
    ...
    '--SI SE NTERRUMPE EL PROCESO => SALIR
     If BAND_INTERRUMPIR = True Then GoTo SALIR:
    '-----------------------------------------------
    nSQL = "SELECT con_diario.idcue as idcuenta, con_planctas.cuenta, con_planctas.descripcion " _
         + vbCr + " FROM con_planctas RIGHT JOIN con_diario ON con_planctas.id = con_diario.idcue "
                  
    If opt_fecha(0).Value = True Then
        nSQL = nSQL + vbCr + " WHERE ( " & nSQLIdLibro & nSQLAjuste & " ( ( con_diario.fchasi >=CDate('" & TxtFchIni.Valor & "') And con_diario.fchasi <=CDate('" & TxtFchFin.Valor & "') ) and ( year(con_diario.fchasi)= " & AnoTra & " ) OR  ( con_diario.fchasi IS NULL OR con_diario.fchasi <CDate('" & TxtFchFin.Valor & "') ) ) ) "
    Else
        nSQL = nSQL + vbCr + " WHERE ( " & nSQLIdLibro & nSQLAjuste & " ( ( con_diario.idmes >= " & mMesIni & " and con_diario.idmes <= " & mMesFin & " ) and con_diario.año = " & AnoTra & " ) OR ( con_diario.fchasi IS NULL )  ) "
    End If
         
    nSQL = nSQL + vbCr + nSQLCuenta _
        + vbCr + " AND con_diario.idcue IS NOT NULL " _
         + vbCr + " GROUP BY con_diario.idcue, con_planctas.cuenta, con_planctas.descripcion ORDER BY con_planctas.cuenta ASC "
...
'''                + vbCr + " IIf(con_planctas.tipsal='D' or con_planctas.tipsal='',[impdebdol]-[imphabdol],[imphabdol]-[impdebdol]) as impsaldol " _
            ...
            nSQL = "SELECT con_diario.idcue as idcuenta, con_planctas.cuenta,con_planctas.tipsal, " _
                ...
                + vbCr + " FROM con_planctas RIGHT JOIN (con_diario LEFT JOIN con_tc ON con_diario.fchdoc = con_tc.fecha) ON con_planctas.id = con_diario.idcue "
            If opt_fecha(0).Value = True Then
                nSQL = nSQL + vbCr + " WHERE ( " & nSQLIdLibro & nSQLAjuste & nSQLCierre & " con_diario.fchasi Is Null and con_diario.año = " & AnoTra & " ) Or ( " & nSQLIdLibro & nSQLAjuste & " con_diario.fchasi < CDate('" & TxtFchIni.Valor & "')) "
            Else
                nSQL = nSQL + vbCr + " WHERE ( " & nSQLIdLibro & nSQLAjuste & nSQLCierre & " con_diario.idmes < " & mMesIni & " AND con_diario.año = " & AnoTra & " )  or ( " & nSQLIdLibro & nSQLAjuste & " con_diario.año < " & AnoTra & " ) "
            End If
            nSQL = nSQL + vbCr + " GROUP BY con_diario.idcue, con_planctas.cuenta, con_planctas.tipsal  " _
                + vbCr + " HAVING con_planctas.cuenta ='" & RstMay("cuenta") & "' "
            ...
            If RstSal.RecordCount <> 0 Then
                If UCase(RstSal.Fields("tipsal") & "") = "D" Or NulosC(RstSal.Fields("tipsal")) = "" Then
                    xSaldo = (NulosN(RstSal(CAMPO_DEBE)) - NulosN(RstSal(CAMPO_HABER)))
'                    Fg1.TextMatrix(Fg1.Rows - 1, mColDebe) = Format(xSaldo, FORMAT_MONTO)
'                    xTotal1 = Abs(xSaldo)
                Else
                    xSaldo = (NulosN(RstSal(CAMPO_HABER)) - NulosN(RstSal(CAMPO_DEBE)))
'                    Fg1.TextMatrix(Fg1.Rows - 1, mColHaber) = Format(xSaldo, FORMAT_MONTO)
'                    xTotal2 = Abs(xSaldo)
                End If
...
'''                                xSaldo = xSaldo + NulosN(Fg1.TextMatrix(Fg1.Rows - 1, mCol))
    ...
    Else
        ...
        If opt_fecha(0).Value = True Then
            nSQL = nSQL + vbCr + " WHERE (  ( " & nSQLIdLibro & nSQLAjuste & " con_diario.fchasi Is Null and con_diario.año = " & AnoTra & " ) Or ( " & nSQLAjuste & " con_diario.fchasi < CDate('" & TxtFchIni.Valor & "')) ) "
        Else
            nSQL = nSQL + vbCr + " WHERE (  ( " & nSQLIdLibro & nSQLAjuste & " con_diario.idmes < " & mMesIni & " AND con_diario.año = " & AnoTra & " )  or ( " & nSQLAjuste & " con_diario.año < " & AnoTra & " )  ) "
        End If
...
'''    End If
    ...
    For A = 0 To UBound(xAcumulado())
        ...
        If Fg3.ColWidth(3 + A) < 850 Then Fg3.ColWidth(3 + A) = 880
...
SALIR:
    ...
    '--Actualizar el total Detalle
    Fg1.TextMatrix(Fg1.Rows - 1, mColDebe) = Format(Fg3.TextMatrix(Fg3.Rows - 1, 7), FORMAT_MONTO)
    Fg1.TextMatrix(Fg1.Rows - 1, mColHaber) = Format(Fg3.TextMatrix(Fg3.Rows - 1, 8), FORMAT_MONTO)
