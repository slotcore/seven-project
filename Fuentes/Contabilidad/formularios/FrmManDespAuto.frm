...
Begin VB.Form FrmManDespAuto 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Almacén - Despacho Automático"
   ClientHeight    =   5460
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   8820
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManDespAuto.frx":0000
            Key             =   "IMG1"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManDespAuto.frx":0544
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManDespAuto.frx":08D6
            Key             =   "IMG2"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManDespAuto.frx":0A5A
            Key             =   "IMG3"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManDespAuto.frx":0EAE
            Key             =   "IMG4"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManDespAuto.frx":0FC6
            Key             =   "IMG5"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManDespAuto.frx":150A
            Key             =   "IMG6"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManDespAuto.frx":1A4E
            Key             =   "IMG7"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManDespAuto.frx":1B62
            Key             =   "IMG8"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManDespAuto.frx":1C76
            Key             =   "IMG9"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManDespAuto.frx":20CA
            Key             =   "IMG10"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManDespAuto.frx":2236
            Key             =   "IMG11"
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManDespAuto.frx":277E
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin SizerOneLibCtl.TabOne TabOne1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.Frame FrmReceta 
            ...
            Begin VB.CommandButton cmd 
               ...
               Index           =   1
               Left            =   2048
               Picture         =   "FrmManDespAuto.frx":2B10
               Style           =   1  'Graphical
               TabIndex        =   12
               Top             =   1995
               Width           =   240
            ...
            Begin VB.CommandButton cmd 
               ...
               Index           =   0
               Left            =   2648
               Picture         =   "FrmManDespAuto.frx":2C42
               Style           =   1  'Graphical
               TabIndex        =   11
               Top             =   1680
               Width           =   240
         ...
         Begin VB.Label TituloLabel 
            Alignment       =   2  'Center
            Caption         =   "Detalle de Despacho Automático"
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   9.75
               Charset         =   0
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.Label TituloLabel 
            Alignment       =   2  'Center
            Caption         =   "Consulta de Despacho Automático"
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   9.75
               Charset         =   0
   ...
   End
End
Attribute VB_Name = "FrmManDespAuto"
...
Private Sub pCargarGrid()
    cSQL = "SELECT alm_despachoauto.iddespachoauto AS id, alm_despachoauto.idalm, alm_almacenes.descripcion AS almacen, alm_despachoauto.iditem, alm_inventario.codpro, alm_inventario.descripcion AS item, alm_despachoauto.glosa " _
...
Sub Nuevo()
    ...
    TituloLabel(1).Caption = "Agregando Despacho Automático"
...
Function Grabar() As Boolean
    Dim Rpta As Integer
    Dim DespAuto As New AlmacenEntidad.EDespAuto
...
On Error GoTo LaCague
    ...
    On Error GoTo LaCague
    If QueHace = 1 Then DespAuto.Iddespachoautomatico = 0 Else DespAuto.Iddespachoautomatico = NulosN(RstDesp("id"))
        
    DespAuto.IdAlmacen = NulosN(IdAlmacenText.Text)
    DespAuto.IdItem = NulosN(IdItemLabel.Caption)
    DespAuto.Glosa = NulosC(GlosaText.Text)
    
    Set DespAuto.Conexion = xCon
    If Not DespAuto.Save(0, "") Then Err.Raise &HFFFFFF01, , "Error al intentar grabar el registro"
    
    mIdRegistro = DespAuto.Iddespachoautomatico
    MsgBox "El item se grabo con éxito", vbInformation + vbOKOnly + vbDefaultButton1, xTitulo
    Grabar = True
    Set DespAuto = Nothing
    Exit Function
...
Sub Modificar()
    ...
    TabOne1.TabEnabled(0) = False
    TituloLabel(1).Caption = "Modificando Despacho Automático"
    CodItemText.SetFocus
End Sub
...
Sub Eliminar()
    ...
    If Rpta = vbYes Then
        DespAuto.Iddespachoautomatico = NulosN(RstDesp("id"))
        Set DespAuto.Conexion = xCon
        DespAuto.Delete CLng(xIdUsuario), F.MachineName
...
Sub MuestraSegundoTab()
    Blanquea
    IdItemLabel.Caption = NulosN(RstDesp("iditem"))
    CodItemText.Text = NulosC(RstDesp("codpro"))
    ItemLabel.Caption = NulosC(RstDesp("item"))
    IdAlmacenText.Text = NulosN(RstDesp("idalm"))
    AlmacenLabel.Caption = NulosC(RstDesp("almacen"))
    GlosaText.Text = NulosC(RstDesp("glosa"))
End Sub
