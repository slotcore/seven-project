...
Begin VB.Form FrmManLibroCosto4 
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManLibroCosto4.frx":0000
            Key             =   "IMG1"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManLibroCosto4.frx":0544
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManLibroCosto4.frx":08D6
            Key             =   "IMG2"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManLibroCosto4.frx":0A5A
            Key             =   "IMG3"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManLibroCosto4.frx":0EAE
            Key             =   "IMG4"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManLibroCosto4.frx":0FC6
            Key             =   "IMG5"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManLibroCosto4.frx":150A
            Key             =   "IMG6"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManLibroCosto4.frx":1A4E
            Key             =   "IMG7"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManLibroCosto4.frx":1B62
            Key             =   "IMG8"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManLibroCosto4.frx":1C76
            Key             =   "IMG9"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManLibroCosto4.frx":20CA
            Key             =   "IMG10"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManLibroCosto4.frx":2236
            Key             =   "IMG11"
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManLibroCosto4.frx":277E
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin SizerOneLibCtl.TabOne TabOne1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton cmd 
            ...
            Index           =   4
            Left            =   1830
            Picture         =   "FrmManLibroCosto4.frx":2B10
            Style           =   1  'Graphical
            TabIndex        =   34
            Top             =   980
            Width           =   240
         ...
         Begin VB.Frame Frame3 
            ...
            Begin VB.CommandButton cmd 
               ...
               Index           =   0
               Left            =   750
               Picture         =   "FrmManLibroCosto4.frx":2C42
               Style           =   1  'Graphical
               TabIndex        =   25
               Top             =   630
               Width           =   240
         ...
         Begin VB.Frame Frame4 
            ...
            Begin VB.Frame Frame7 
               ...
               Begin VSFlex7Ctl.VSFlexGrid fg 
                  ...
                  FormatString    =   $"FrmManLibroCosto4.frx":2D74
                  ScrollTrack     =   0   'False
                  ScrollBars      =   3
                  ScrollTips      =   0   'False
                  MergeCells      =   0
            ...
            Begin VSFlex7Ctl.VSFlexGrid fg 
               ...
               ColWidthMax     =   0
               ExtendLastCol   =   0   'False
               FormatString    =   $"FrmManLibroCosto4.frx":2EB8
               ScrollTrack     =   0   'False
               ScrollBars      =   3
               ScrollTips      =   0   'False
               MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "FrmManLibroCosto4"
...
Private mLErrorCosto As ContabilidadEntidad.LEErrorCosto
Private mSaltaError As Boolean

Private Sub pProcesarMODCIF(ConfiguracionValorizacion As ContabilidadEntidad.EConfigVal, _
                                    FechaInicioProceso As Date, _
                                    FechaFinProceso As Date)
                                    
    Dim FProd As New ProduccionLogica.Funciones
    Dim mDataBase As New SistemaData.EDataBase
    Dim mRecord As New ADODB.Recordset
    Dim mIndiceTotal As Double
    Dim mCostoMODMovimientoDetalle As Double
    Dim mCostoCIFMovimientoDetalle As Double
    Dim mFechaInicioInventario As Date
    Dim FCont As New ContabilidadLogica.Funciones
...
On Error GoTo ERROR_
    ...
    mIndiceTotal = F.NuloNumeric(Format(GRID_SUMAR_COL(fg(0), fg(0).ColIndex("FACTOR")), FORMAT_CANTIDAD))
    ...
    ' MOD
    If ConfiguracionValorizacion.ProcesaMOD Then
    ...
    End If
    ' CIF
    If ConfiguracionValorizacion.ProcesaCIF Then
        ...
        With fg(0)
            For A = .FixedRows To .Rows - 1
                ...
                Else
                    mIdMovimientoDetalle = F.NuloNumeric(.TextMatrix(A, .ColIndex("IDMOVDET")))
                End If
                
                If Not FCont.GrabaGastoIndirecto(F.NuloNumeric(lblidalm.Caption), _
                                                mIdMovimientoDetalle, _
                                                F.NuloNumeric(.TextMatrix(A, .ColIndex("COSTOMOD"))), _
                                                F.NuloNumeric(.TextMatrix(A, .ColIndex("COSTOCIF"))), xCon) Then
                                        
                    Err.Raise &HFFFFFF01, , "No se pudo grabar el gasto indirecto"
                End If
    ...
    '**********************************
    ' Reproceso de Gastos Indirectos
    '**********************************
    If ConfiguracionValorizacion.ProcesaMP Then
        ' Se procesa Materiales
        If Not FCont.EjecutaReCosteoIndirectos(mLErrorCosto, mSaltaError, _
                                            F.NuloNumeric(lblidalm.Caption), _
                                            FechaInicioProceso, FechaFinProceso, xCon) Then
            Err.Raise &HFFFFFF01, , "Error al re-procesar gastos indirectos"
        End If
    End If
...
Private Sub pProcesarMP(ConfiguracionValorizacion As ContabilidadEntidad.EConfigVal, _
                                    FechaInicioProceso As Date, FechaFinProceso As Date)
    Dim Rpta As Integer
    Dim F As New SistemaLogica.Funciones
    Dim FProd As New ProduccionLogica.Funciones
    Dim FCont As New ContabilidadLogica.Funciones
...
On Error GoTo BloqueError
    ...
    If F.MesCerradoOpcion(F.RetornarMesFecha(FechaInicioProceso), CLng(F.KeyValue("IdOpcionSistemaMovimientoAlmacen", xCon)), xCon) Then
    ...
    If F.NuloNumeric(lblidmetval.Caption) = 0 Then
        ...
        Exit Sub
    End If
    ' Se valida que no hayan movimientos de meses anteriores sin valorizar
    Dim mRstMovSinCosto As New ADODB.Recordset
    'Dim mFechaInicioInventario As Date
    mFechaInicioInventario = F.FechaInicioMovimientos(F.NuloNumeric(lblidalm.Caption), xCon)
    Set mRstMovSinCosto = FCont.MovimientosSinValorizar(mFechaInicioInventario, FechaInicioProceso - 1, xCon)
    If mRstMovSinCosto.State <> 0 Then
        If mRstMovSinCosto.RecordCount > 0 Then
            F.ExportarExcelRecordSet mRstMovSinCosto
            Rpta = MsgBox("Existen movimientos sin costear de un periodo anterior, esto podria crear alteraciones en el costeo actual ¿ Esta seguro desea continuar ?", vbQuestion + vbYesNo + vbDefaultButton1, "Cierre de Mes")
            If Rpta = vbNo Then
                Exit Sub
            End If
        End If
    ...
    Set mLErrorCosto = New ContabilidadEntidad.LEErrorCosto
    mSaltaError = True
    ' Se reprocesa todo
    If ReprocesarCheck.Value = 1 Then
        If Not FCont.LimpiaTablaCostos(F.NuloNumeric(lblidalm.Caption), _
                                            FechaInicioProceso, FechaFinProceso, xCon) Then
            Err.Raise &HFFFFFF01, , "Error al limpiar costos procesados"
        End If
    End If
    ...
    If ConfiguracionValorizacion.ProcesaMP Then
        ...
        ' Se procesa Materiales
        If Not FCont.EjecutaCosteoMateriales(mLErrorCosto, mSaltaError, _
                                            F.NuloNumeric(lblidalm.Caption), _
                                            FechaInicioProceso, FechaFinProceso, xCon) Then
            Err.Raise &HFFFFFF01, , "Error al ejecutar el proceso para materiales"
        End If
        If mLErrorCosto.Count > 0 Then
            Err.Raise &HFFFFFF01, , "Se han encontrado: " & mLErrorCosto.Count & " errores de procesamiento", "Errores de Proceso"
        End If
        ' Se procesa Productos Intermedios
        If Not FCont.EjecutaCosteoProductosIntermedios(mLErrorCosto, mSaltaError, _
                                            F.NuloNumeric(lblidalm.Caption), _
                                            FechaInicioProceso, FechaFinProceso, xCon) Then
            Err.Raise &HFFFFFF01, , "Error al ejecutar el proceso para productos intermedios"
        End If
        If mLErrorCosto.Count > 0 Then
            Err.Raise &HFFFFFF01, , "Se han encontrado: " & mLErrorCosto.Count & " errores de procesamiento", "Errores de Proceso"
        End If
        ' Se procesa Productos Terminados
        If Not FCont.EjecutaCosteoProductosTerminados(mLErrorCosto, mSaltaError, _
                                            F.NuloNumeric(lblidalm.Caption), _
                                            FechaInicioProceso, FechaFinProceso, xCon) Then
            Err.Raise &HFFFFFF01, , "Error al ejecutar el proceso para productos terminados"
        End If
        If mLErrorCosto.Count > 0 Then
            Err.Raise &HFFFFFF01, , "Se han encontrado: " & mLErrorCosto.Count & " errores de procesamiento", "Errores de Proceso"
        End If
    End If
    ' Se llenan los datos
    Set mLParteProdDet.Conexion = xCon
    mLParteProdDet.LoadChild = False
    mLParteProdDet.Fetch , F.NuloNumeric(lblidalm.Caption), FechaInicioProceso, FechaFinProceso, mFechaInicioInventario
    If mLParteProdDet.Count = 0 Then
    End If
    
    A = 0
    PgBar.Min = 0
    PgBar.Max = mLParteProdDet.Count
    CentrarFrm FraProgreso
    FraProgreso.Visible = True
    ' Se recorre la lista para calcular su importe unitario
    With fg(0)
        Dim mParteProdDet As New ProduccionEntidad.EParteProdDet
        For Each mParteProdDet In mLParteProdDet
            ...
            A = A + 1
            .TopRow = .Rows - 1
            lbl(0).Caption = "Parte: " & F.NuloString(mParteProdDet.OrdenProduccion)
            LblProg.Caption = "Codigo Item: " & F.NuloString(mParteProdDet.CodigoItem)
            PgBar.Value = A
            ' *****
            mImporteMP = F.NuloNumeric(F.BuscaCodigoTabla(mParteProdDet.IdMovimientoDetalle, "idmovdet", "costoprimo", "con_librocostotemp", "N", xCon))
            mTipo = F.NuloNumeric(F.BuscaCodigoTabla(mParteProdDet.IdItem, "id", "tippro", "alm_inventario", "N", xCon))
            .TextMatrix(.Rows - 1, .ColIndex("FECHA")) = F.NuloString(mParteProdDet.Fecha)
            .TextMatrix(.Rows - 1, .ColIndex("NUMPARTE")) = F.NuloString(mParteProdDet.OrdenProduccion)
            If mTipo = 3 Then
                .TextMatrix(.Rows - 1, .ColIndex("TIPO")) = "PT"
            Else
                .TextMatrix(.Rows - 1, .ColIndex("TIPO")) = "PI"
            End If
            .TextMatrix(.Rows - 1, .ColIndex("ITEM")) = F.NuloString(mParteProdDet.Item)
            .TextMatrix(.Rows - 1, .ColIndex("RECETA")) = F.NuloString(mParteProdDet.Receta)
            .TextMatrix(.Rows - 1, .ColIndex("UM")) = F.NuloString(mParteProdDet.UnidadMedida)
            .TextMatrix(.Rows - 1, .ColIndex("CANTIDAD")) = F.NuloString(mParteProdDet.CantidadProducida)
            .TextMatrix(.Rows - 1, .ColIndex("HORINI")) = Format(F.NuloString(mParteProdDet.HoraInicio), FORMAT_HORA_SIN_SEGUNDO)
            .TextMatrix(.Rows - 1, .ColIndex("HORFIN")) = Format(F.NuloString(mParteProdDet.HoraFin), FORMAT_HORA_SIN_SEGUNDO)
            .TextMatrix(.Rows - 1, .ColIndex("THORAS")) = Format(CDate(mParteProdDet.HoraFin) - CDate(mParteProdDet.HoraInicio), "HH:mm")
            .TextMatrix(.Rows - 1, .ColIndex("COSTOMP")) = Format(mImporteMP, FORMAT_IMPORTEKARDEX)
            .TextMatrix(.Rows - 1, .ColIndex("IDITEM")) = mParteProdDet.IdItem
            .TextMatrix(.Rows - 1, .ColIndex("IDPARTEPRODDET")) = mParteProdDet.IdParteProduccionDet
            .TextMatrix(.Rows - 1, .ColIndex("IDMOVDET")) = mParteProdDet.IdMovimientoDetalle
        Next
        '*************************************
        ' Factor de Distribucion
        '*************************************
        Select Case ConfiguracionValorizacion.CodigoTipoItemDistribucion
            Case "PT"
                ...
                For A = fg(0).FixedRows To fg(0).Rows - 1
                    If F.NuloString(fg(0).TextMatrix(A, fg(0).ColIndex("TIPO"))) = "PT" Then
                        mIndiceTotal = mIndiceTotal + F.NuloNumeric(fg(0).TextMatrix(A, fg(0).ColIndex(ConfiguracionValorizacion.ColumnaFactorDistribucion)))
                    End If
                Next
                
            Case "TD"
                mIndiceTotal = F.NuloNumeric(GRID_SUMAR_COL(fg(0), fg(0).ColIndex(ConfiguracionValorizacion.ColumnaFactorDistribucion)))
        ...
        For A = .FixedRows To .Rows - 1
            Select Case ConfiguracionValorizacion.CodigoTipoItemDistribucion
                Case "PT"
                    mIndice = F.NuloNumeric(.TextMatrix(A, .ColIndex(ConfiguracionValorizacion.ColumnaFactorDistribucion)))
                ...
                Case Else
                    .TextMatrix(A, .ColIndex("COSTOMOD")) = Format(0, FORMAT_CANTIDAD)
            End Select
        Next A
    End With
    Me.MousePointer = vbDefault
...
BloqueError:
    ...
    If mLErrorCosto.Count > 0 Then
        F.ExportarExcelRecordSet CrearRST()
    End If
End Sub

Private Function CrearRST() As ADODB.Recordset
    Dim xFun As New eps_librerias.FuncionesData
    Dim xRs As New ADODB.Recordset
    Dim xCampos(3, 3) As String

    xCampos(0, 0) = "CodigoError":      xCampos(0, 1) = "C":      xCampos(0, 2) = "100"
    xCampos(1, 0) = "DetalleError":     xCampos(1, 1) = "C":      xCampos(1, 2) = "1000000"
    xCampos(2, 0) = "OrigenError":      xCampos(2, 1) = "C":      xCampos(2, 2) = "100"
    Set xRs = xFun.CrearRstTMP(xCampos)
    xRs.Open
    
    Dim mErrorCosto As New ContabilidadEntidad.EErrorCosto
    For Each mErrorCosto In mLErrorCosto
        xRs.AddNew
        xRs("CodigoError") = mErrorCosto.CodigoError
        xRs("DetalleError") = mErrorCosto.DetalleError
        xRs("OrigenError") = mErrorCosto.origen
        xRs.Update
    Next
    Set CrearRST = xRs
End Function
...
Private Sub cmd_Click(Index As Integer)
    ...
    Dim mConfigVal As New ContabilidadEntidad.EConfigVal
        
    If QueHace = 3 Then Exit Sub
    ' Se carga la configuracion de la valorizacion
    Set mConfigVal.Conexion = xCon
    mConfigVal.Fetch NulosN(lblidmetval)
    ...
    Select Case Index
        Case 0 ' METODO DE VALORIZACION
            ...
            Set mRecord = Nothing
            CARGAR_DLL_EPSBUSCAR xCon, mRecord, cSQL, xCampos(), nTitulo, "descripcion", "descripcion", Principio
            
            If mRecord.State = 0 Then Exit Sub
            If mRecord.RecordCount = 0 Then Exit Sub
            
            lblidmetval.Caption = F.NuloNumeric(mRecord("id"))
            txtmetval.Text = F.NuloString(mRecord("abrev"))
            lblmetval.Caption = F.NuloString(mRecord("descripcion"))
            cmd(2).SetFocus
            
        Case 2 ' CONSULTAR
            pProcesarMP mConfigVal, mPrimerDiaMes, mUltimoDiaMes
            
        Case 3 ' PROCESAR
            pProcesarMODCIF mConfigVal, mPrimerDiaMes, mUltimoDiaMes
        ...
        Case 4 ' Almacen
            ...
            lblidalm.Caption = F.NuloNumeric(mRecord("id"))
            txtalm.Text = F.NuloString(mRecord("codigo"))
            lblalm.Caption = F.NuloString(mRecord("descripcion"))
            ' Metodo de valorizacion por defecto
            lblidmetval.Caption = F.NuloNumeric(mRecord("idmetval"))
            lblmetval.Caption = F.NuloString(F.BuscaCodigoTabla(F.NuloNumeric(mRecord("idmetval")), "id", "descripcion", "mae_configval", "N", xCon))
            txtmetval.Text = F.NuloString(F.BuscaCodigoTabla(F.NuloNumeric(mRecord("idmetval")), "id", "abrev", "mae_configval", "N", xCon))
        ...
        Case 0
            Select Case Col
                Case fg(0).ColIndex("FACTOR")
                    lblsumafactor.Visible = True
                    lblsumafactor.Caption = "Suma Factor: " & Format(F.NuloNumeric(GRID_SUMAR_COL(fg(0), fg(0).ColIndex("FACTOR"))), FORMAT_CANTIDAD)
            End Select
    End Select
End Sub
