         ...
         Begin SizerOneLibCtl.TabOne TabOne2 
            ...
            Begin VB.Frame Frame4 
               ...
               Begin VSFlex7Ctl.VSFlexGrid Fg2 
                  ...
                  FormatString    =   $"FrmLetras1.frx":072C
                  ScrollTrack     =   0   'False
                  ScrollBars      =   3
                  ScrollTips      =   0   'False
                  MergeCells      =   0
            ...
            Begin VB.Frame Frame5 
               ...
               Begin VSFlex7Ctl.VSFlexGrid Fg1 
                  ...
                  ColWidthMax     =   0
                  ExtendLastCol   =   0   'False
                  FormatString    =   $"FrmLetras1.frx":08B5
                  ScrollTrack     =   0   'False
                  ScrollBars      =   3
                  ScrollTips      =   0   'False
                  MergeCells      =   0
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmLetras1.frx":0A28
               Key             =   "IMG1"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmLetras1.frx":0F6C
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmLetras1.frx":12FE
               Key             =   "IMG2"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmLetras1.frx":1482
               Key             =   "IMG3"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmLetras1.frx":18D6
               Key             =   "IMG4"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmLetras1.frx":19EE
               Key             =   "IMG5"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmLetras1.frx":1F32
               Key             =   "IMG6"
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmLetras1.frx":2476
               Key             =   "IMG7"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmLetras1.frx":258A
               Key             =   "IMG8"
            EndProperty
            BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmLetras1.frx":269E
               Key             =   "IMG9"
            EndProperty
            BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmLetras1.frx":2AF2
               Key             =   "IMG10"
            EndProperty
            BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmLetras1.frx":2C5E
               Key             =   "IMG11"
            EndProperty
         EndProperty
      End
...
'        TxtImpFinan.Text = TxtTotal3Pro.Text
'    Else
'        TxtImpFinan.Text = TxtTotal2Pro.Text
'    End If
...
Private Sub CmdBusProv_Click()
    ...
    xform.SQLCad = "SELECT mae_cliente.nombre, mae_cliente.numruc, mae_cliente.id, mae_cliente.idven, mae_cliente.ageret, mae_cliente.letnomgir, " _
        & " mae_cliente.letgirdir, mae_cliente.letnumdoc, mae_cliente.lettel FROM mae_cliente;"
    ...
    If xRs.State = 1 Then
        If xRs.RecordCount <> 0 Then
            If xRs.RecordCount <> 0 Then
                ...
                TxtGirado.Text = NulosC(xRs("letnomgir"))
                TxtNumDoc.Text = NulosC(xRs("letnumdoc"))
                TxtDirlet.Text = NulosC(xRs("letgirdir"))
                LblNumTele.Caption = NulosC(xRs("lettel"))
                
                TxtIdDocIden.Text = "1"
                TxtIdDocIden_Validate False
                TxtGirado.SetFocus
            End If
        End If
    End If
...
Private Sub CmdGenLet_Click()
    If NulosN(TxtDiasPlazo.Text) = 0 Then
        MsgBox "No ha especificado los dias de plazo para las letras", vbInformation + vbOKOnly + vbDefaultButton1, xTitulo
        TxtDiasPlazo.SetFocus
        Exit Sub
    End If
    
    If NulosN(TxtIntervalos.Text) = 0 Then
        MsgBox "No ha especificado el intervalo de dias para la emision de las letras", vbInformation + vbOKOnly + vbDefaultButton1, xTitulo
        TxtIntervalos.SetFocus
        Exit Sub
    End If
    
    If NulosN(TxtNumLet.Text) = 0 Then
        MsgBox "No ha especificado el numero de letras a emitir", vbInformation + vbOKOnly + vbDefaultButton1, xTitulo
        TxtNumLet.SetFocus
        Exit Sub
    End If
        
    Dim xNumeroLetra As Integer
    '--SOLICITAR AL USUARIO QUE INGRESE EL NUMERO DE LETRA INICIAL
    '--A PARTIR DE ALLI EMPEZARA EL CORRELATIVO DE LETRAS SEGUN LA CANTIDAD DE LETRAS A GENERAR
    
    xNumeroLetra = NulosN(InputBox("Numero de Letra Inicial ==> ", xTitulo))
    If xNumeroLetra = 0 Then
        MsgBox "Ingrese el numero inicial de letras, para que empieze a generar el correlaativo", vbExclamation, xTitulo
        Exit Sub
    End If
    '-----------
...
Private Sub CmdSelDoc_Click()
    If NulosN(LblTipoCambio.Caption) = 0 Then
        MsgBox "No ha especificado el tipo de cambio para esta operacion", vbDefaultButton1 + vbInformation + vbOKOnly, xTitulo
        TxtRucPro.SetFocus
        Exit Sub
    End If
    pRegistroAdd True
...
Private Sub Fg2_CellButtonClick(ByVal Row As Long, ByVal Col As Long)
    If Col = 11 Then
        ...
        xCampos(0, 0) = "Banco":        xCampos(0, 1) = "nomban":    xCampos(0, 2) = "5000":    xCampos(0, 3) = "C"
        xCampos(1, 0) = "Nº Cuenta":    xCampos(1, 1) = "numcue":    xCampos(1, 2) = "1000":    xCampos(1, 3) = "C"
        
        xform.SQLCad = "SELECT mae_banconumcta.id, mae_bancos.descripcion AS nomban, mae_banconumcta.numcue FROM mae_banconumcta LEFT JOIN mae_bancos ON mae_banconumcta.idban = mae_bancos.id " _
            & " WHERE ((mae_banconumcta.idmon=" & NulosN(TxtIdMon.Text) & "))"
        
        xform.Titulo = "Buscando Cuentas de Banco"
        xform.FormaBusca = Principio
        xform.Criterio = ""
        xform.Ordenado = "nomban"
        xform.CampoBusca = "nomban"
        Set xform.Coneccion = xCon
        Set xRs = xform.BuscarReg(xCampos)
        If xRs.State = 1 Then
            If xRs.RecordCount <> 0 Then
                Fg2.TextMatrix(Fg2.Row, 11) = NulosC(xRs("nomban"))
                Fg2.TextMatrix(Fg2.Row, 12) = NulosC(xRs("numcue"))
                Fg2.TextMatrix(Fg2.Row, 13) = NulosN(xRs("id"))
            End If
        End If
        Set xform = Nothing
        Set xRs = Nothing
...
Private Sub Fg2_EnterCell()
    ...
    End If
     ...
     If Fg2.Col = 3 Or Fg2.Col = 9 Or Fg2.Col = 11 Then
...
Sub MuestraSegundoTab()
    ...
    TxtRucPro.Text = NulosC(RstLet("numruc"))
    LblProveedor.Caption = NulosC(RstLet("nombre"))
    ...
    TxtDirlet.Text = NulosC(RstLet("dir"))
    ...
    LblNumTele.Caption = NulosC(RstLet("numtel"))
...
'    RST_Busq RstDet, "SELECT let_letradet.* From let_letradet Where (((let_letradet.idlet) = " & RstLet("id") & ")) ORDER BY let_letradet.fchven", xCon
    ...
    RST_Busq RstDet, "SELECT let_letradet.*, mae_bancos.descripcion AS nomban, mae_banconumcta.numcue " _
        & " FROM let_letradet LEFT JOIN (mae_banconumcta LEFT JOIN mae_bancos ON mae_banconumcta.id = mae_bancos.id) ON let_letradet.idbcocta = mae_banconumcta.id " _
        & " Where (let_letradet.idlet = " & RstLet("id") & ") ORDER BY let_letradet.fchven", xCon
    ...
    If RstDet.RecordCount <> 0 Then
        ...
        For A = 1 To RstDet.RecordCount
            ...
            Fg2.TextMatrix(Fg2.Rows - 1, 4) = Format(NulosN(RstDet("impcapital")), "0.000000")
            Fg2.TextMatrix(Fg2.Rows - 1, 5) = Format(NulosN(RstDet("impinteres")), "0.000000")
            Fg2.TextMatrix(Fg2.Rows - 1, 6) = Format(NulosN(RstDet("impporte")), FORMAT_MONTO)
            Fg2.TextMatrix(Fg2.Rows - 1, 7) = Format(NulosN(RstDet("impigv")), "0.000000")
            Fg2.TextMatrix(Fg2.Rows - 1, 8) = Format(NulosN(RstDet("implet")), "0.00")
            Fg2.TextMatrix(Fg2.Rows - 1, 9) = Format(NulosC(RstDet("fchven")), "dd/mm/yy")
            
            Fg2.TextMatrix(Fg2.Rows - 1, 11) = NulosC(RstDet("nomban"))
            Fg2.TextMatrix(Fg2.Rows - 1, 12) = NulosC(RstDet("numcue"))
            Fg2.TextMatrix(Fg2.Rows - 1, 13) = NulosC(RstDet("idbcocta"))
...
Sub Eliminar()
    ...
    If Rpta = vbYes Then
        ...
        If BuscarMovimientosLetra(RstLet("id"), 1) = False Then
            ...
            xCon.Execute "DELETE * FROM var_edicion WHERE idmov = " & RstLet("id") & " AND idform = " & IdMenuActivo
...
Private Sub Toolbar1_ButtonClick(ByVal Button As MSComctlLib.Button)
    ...
    If Button.Index = 13 Then
        FrmRepLetras.xIdLetra = RstLet("id")
        FrmRepLetras.Show
    End If
...
Private Sub TxtDiasPlazo_Validate(Cancel As Boolean)
    If QueHace = 3 Then Exit Sub
    If NulosN(TxtDiasPlazo.Text) = 0 Then Exit Sub
    '--volver a calcular los datos
    Recalcular
End Sub
...
Private Sub TxtRucPro_Validate(Cancel As Boolean)
    ...
    If xRs1.RecordCount <> 0 Then
        ...
        TxtGirado.Text = NulosC(xRs1("letnomgir"))
        TxtNumDoc.Text = NulosC(xRs1("letnumdoc"))
        TxtIdDocIden_Validate False
        TxtIdDocIden.Text = "1"
        TxtDirlet.Text = NulosC(xRs1("letgirdir"))
    Else
        TxtRucPro.Text = ""
        LblProveedor.Caption = ""
        LblIdCliente.Caption = ""
...
Sub GenerarLetras(TipInteres As Integer, Tasa As Double, NunDias As Integer, NumLetras As Integer, Capital As Double, NumeroLetraInicial As Integer, Portes As Double, FchInicio As String, Intervalos As Integer)
    ...
    ValorRedondea = Format((Capital - (ImporteLetra * NumLetras)), "0.000000")
...
'            Fg2.TextMatrix(Fg2.Rows - 1, 1) = Format(A, "00")'--este codigo se generara al momento de grabar
            '--numero de letra
            ...
            End If
            '--capital
            Fg2.TextMatrix(Fg2.Rows - 1, 4) = Format(ImporteLetra, "0.000000")
            '--interes
            Fg2.TextMatrix(Fg2.Rows - 1, 5) = Format(ImporteLetra * Factor, "0.000000")
            '--porte
            Fg2.TextMatrix(Fg2.Rows - 1, 6) = Format(Portes, FORMAT_MONTO)
            '--igv
            Fg2.TextMatrix(Fg2.Rows - 1, 7) = ((NulosN(Fg2.TextMatrix(Fg2.Rows - 1, 5)) + NulosN(Fg2.TextMatrix(Fg2.Rows - 1, 6))) * xIGV)
            Fg2.TextMatrix(Fg2.Rows - 1, 7) = Format(Fg2.TextMatrix(Fg2.Rows - 1, 7), "0.000000")
            
            '--importe total
            If ChkRetencion.value = 1 Then
                'capital+interes+porte+igv
                '--cuando es agente retenedor se le tendra que aplicar menos el % al (interes+porte+igv)
                Fg2.TextMatrix(Fg2.Rows - 1, 8) = NulosN(Fg2.TextMatrix(Fg2.Rows - 1, 4)) + (NulosN(Fg2.TextMatrix(Fg2.Rows - 1, 5)) + NulosN(Fg2.TextMatrix(Fg2.Rows - 1, 6)) + NulosN(Fg2.TextMatrix(Fg2.Rows - 1, 7))) * (1 - xRetencion)
            Else
            ...
            Fg2.TextMatrix(Fg2.Rows - 1, 8) = Format(Fg2.TextMatrix(Fg2.Rows - 1, 8), "0.00")
            '--fecha vencimiento
            ...
            End If
            '--incrementar el numero de letra
...
Function HallarFactor(Tasa As Double, NumDias As Integer, TipInteres As Integer) As Double
    ...
    Else
        'MsgBox "No procede mensual", vbExclamation, xTitulo
        HallarFactor = (((Tasa / 100) + 1) ^ ((NumDias / 30)) - 1)
        
        'Interes = (((Tasa / 100) + 1) ^ (plazos/ DiasTasa)) - 1) * Capital
...
On Error GoTo LaCague
    ...
    Else
        ...
        xCon.Execute "delete from let_letradoc where idlet = " & xId
        xCon.Execute "delete from let_letradet where idlet = " & xId
    ...
    xCampos(22, 0) = "dir":         xCampos(22, 1) = TxtDirlet.Text:            xCampos(22, 2) = "N":   xCampos(22, 3) = "C":    xCampos(22, 4) = "No ha especificado la direccion de la persona aquien se le gira la letra"
...
''''    xCampos(30, 0) = "idregimen":   xCampos(30, 1) = Mid(TxtNumDocRef2.Text, 4, 2):  xCampos(30, 2) = "N":    xCampos(30, 3) = "N":    xCampos(30, 4) = "No ha especificado el regimen de la orden de despacho"
    ...
    xCampos(27, 0) = "numerodocref": xCampos(27, 1) = TxtNumDocRef2.Text:    xCampos(27, 2) = "N":   xCampos(27, 3) = "C":    xCampos(27, 4) = "No ha especificado la orden de despacho"
    xCampos(28, 0) = "numtel":      xCampos(28, 1) = NulosC(LblNumTele.Caption):     xCampos(28, 2) = "N":   xCampos(28, 3) = "C":    xCampos(28, 4) = ""
    ...
    For A = 1 To Fg2.Rows - 1
        xCorr = NulosN(Fg2.TextMatrix(A, 1))
        If xCorr = 0 Then xCorr = HallaCodigoTabla("let_letradet", xCon, "corr")
        
        xCampos2(0, 0) = "idlet":       xCampos2(0, 1) = Str(xId):           xCampos2(0, 2) = "S":    xCampos2(0, 3) = "N":    xCampos2(0, 4) = "":
        xCampos2(1, 0) = "corr":        xCampos2(1, 1) = xCorr:                   xCampos2(1, 2) = "S":    xCampos2(1, 3) = "N":    xCampos2(1, 4) = ""
        ...
        xCampos2(12, 0) = "impsal":     xCampos2(12, 1) = Fg2.TextMatrix(A, 8):    xCampos2(12, 2) = "S":   xCampos2(12, 3) = "N":   xCampos2(12, 4) = ""
        xCampos2(13, 0) = "imptext":    xCampos2(13, 1) = NumeroLetra(NulosN(xCampos2(10, 1)), NulosN(TxtIdMon.Text)):    xCampos2(13, 2) = "S":   xCampos2(13, 3) = "C":   xCampos2(13, 4) = ""
        xCampos2(14, 0) = "idbcocta":   xCampos2(14, 1) = Fg2.TextMatrix(A, 13):   xCampos2(14, 2) = "N":   xCampos2(14, 3) = "N":   xCampos2(14, 4) = "No ha especificado la cuenta de banco para la letra Nº " & NulosC(Fg2.TextMatrix(A, 2))
...
Private Sub Recalcular()
    ...
    '===================================================================================================
      ...
      '--util cuando se modifica datos de la cabecera ejm. porte, interes,plazo,capital
    ...
    Dim mFila As Integer '--almacenara la posicion de la fila

    If Fg2.Rows = Fg2.FixedRows Then Exit Sub

    If NulosN(TxtImpTasa.Text) = 0 Then
        MsgBox "Falta ingresar la Tasa", vbInformation, xTitulo
        TxtImpTasa.SetFocus
        Exit Sub
    End If
    If NulosN(TxtDiasPlazo.Text) = 0 Then
    ...
    End If
    If NulosN(TxtNumLet.Text) = 0 Then
        MsgBox "Falta ingresar el numero de letras", vbInformation, xTitulo
        TxtNumLet.SetFocus
        Exit Sub
    End If
    If NulosN(TxtImpFinan.Text) = 0 Then
        MsgBox "Falta ingresar el Imp. Financiar", vbInformation, xTitulo
        Exit Sub
    End If
    If NulosN(TxtPortes.Text) = 0 Then
        MsgBox "Falta ingresar el Porte", vbInformation, xTitulo
        TxtPortes.SetFocus
        Exit Sub
    End If
    
        
    ImporteLetra = (NulosN(TxtImpFinan.Text) / NulosN(TxtNumLet.Text))
    ImporteLetra = Int(ImporteLetra * 100) / 100
    ValorRedondea = Format((NulosN(TxtImpFinan.Text) - (ImporteLetra * NulosN(TxtNumLet.Text))), "0.00")
    
    
    
    Agregando = True
    For mFila = Fg2.FixedRows To Fg2.Rows - 1
    
        Factor = HallarFactor(NulosN(TxtImpTasa.Text), NulosN(Fg2.TextMatrix(mFila, 3)), NulosN(TxtTipInt.Text))
        
        If A = 10 Then
            ImporteLetra = ImporteLetra + ValorRedondea
        End If
        '--capital
        Fg2.TextMatrix(mFila, 4) = Format(ImporteLetra, FORMAT_MONTO)
        '--interes
        Fg2.TextMatrix(mFila, 5) = Format(Fg2.TextMatrix(mFila, 4) * Factor, FORMAT_MONTO)
        '--porte
        Fg2.TextMatrix(mFila, 6) = Format(NulosN(TxtPortes.Text), FORMAT_MONTO)
        '--igv
        Fg2.TextMatrix(mFila, 7) = ((NulosN(Fg2.TextMatrix(mFila, 5)) + NulosN(Fg2.TextMatrix(mFila, 6))) * xIGV)
        Fg2.TextMatrix(mFila, 7) = Format(Fg2.TextMatrix(mFila, 7), FORMAT_MONTO)
        '--importe total
        If ChkRetencion.value = 1 Then
            'capital+interes+porte+igv
            '--cuando es agente retenedor se le tendra que aplicar menos el % al (interes+porte+igv)
            Fg2.TextMatrix(mFila, 8) = NulosN(Fg2.TextMatrix(mFila, 4)) + (NulosN(Fg2.TextMatrix(mFila, 5)) + NulosN(Fg2.TextMatrix(mFila, 6)) + NulosN(Fg2.TextMatrix(mFila, 7))) * (1 - xRetencion)
        Else
            Fg2.TextMatrix(mFila, 8) = NulosN(Fg2.TextMatrix(mFila, 4)) + NulosN(Fg2.TextMatrix(mFila, 5)) + NulosN(Fg2.TextMatrix(mFila, 6)) + NulosN(Fg2.TextMatrix(mFila, 7))
        End If
        Fg2.TextMatrix(mFila, 8) = Format(Fg2.TextMatrix(mFila, 8), FORMAT_MONTO)
               
        If NulosC(TxtFchIni.Valor) <> "" Then
            Fg2.TextMatrix(mFila, 9) = CDate(TxtFchIni.Valor) + NulosN(Fg2.TextMatrix(mFila, 3))
            Fg2.TextMatrix(mFila, 9) = Format(Fg2.TextMatrix(mFila, 9), "dd/mm/yy")
        End If
...
Private Sub pRegistroAdd(Optional EsSeleccion As Boolean = False)
    ...
    If EsSeleccion = False Then
        nSQL = "SELECT 0 AS xsel, Mid([vta_ventas]![numreg],1,2) & [mae_libros]![codsun] & Mid([vta_ventas]![numreg],3,4) AS numreg, [vta_ventas]![numser] & '-' & [vta_ventas]![numdoc] AS numdoc, " _
            ...
            & " vta_ventas.impsal AS saldo, vta_ventas.idmon, 2 AS idmod, vta_ventas.id AS iddoc " _
            & " FROM (((vta_ventas LEFT JOIN mae_libros ON vta_ventas.idlib = mae_libros.id) LEFT JOIN mae_documento ON vta_ventas.tipdoc = mae_documento.id) LEFT JOIN mae_moneda " _
            & " ON vta_ventas.idmon = mae_moneda.id) LEFT JOIN mae_cliente ON vta_ventas.idcli = mae_cliente.id " _
            & " Where (((vta_ventas.impsal) > 0) And ((vta_ventas.anulado) = 0) And ((vta_ventas.tipdoc) = 1 Or (vta_ventas.tipdoc) = 3 Or (vta_ventas.tipdoc) = 8) " _
            & " And ((vta_ventas.idcli) = " & NulosN(LblIdCliente.Caption) & ")) " _
            & " Union " _
            & " SELECT 0 as xsel, '' AS numreg, vta_proforma.numdoc AS numdoc, mae_documento.abrev, vta_proforma.fchdoc as fchemi, mae_moneda.simbolo, mae_cliente.nombre AS clipro, " _
            & " mae_cliente.numruc,  vta_proforma.imptot AS importe, vta_proforma.imptot AS saldo, vta_proforma.idmon, 12 AS idmod, vta_proforma.id AS iddoc FROM ((vta_proforma " _
            & " LEFT JOIN mae_documento  ON vta_proforma.tipdoc = mae_documento.id) LEFT JOIN mae_moneda ON vta_proforma.idmon = mae_moneda.id) LEFT JOIN mae_cliente ON vta_proforma.idcli = mae_cliente.id  " _
...
'            & " WHERE vta_ventas.anulado=0 " _
'            & " Union " _
'            & " SELECT 0 as xsel, '' AS numreg, vta_proforma.numdoc AS numdoc, mae_documento.abrev, vta_proforma.fchdoc as fchemi, mae_moneda.simbolo, mae_cliente.nombre AS clipro, mae_cliente.numruc, " _
...
'            & " WHERE (((vta_proforma.idcli)=" & NulosN(LblIdCliente.Caption) & "))"
        ...
        nSQL = "SELECT 0 AS xsel, Mid([vta_ventas]![numreg],1,2) & [mae_libros]![codsun] & Mid([vta_ventas]![numreg],3,4) AS numreg, [vta_ventas]![numser] & '-' & [vta_ventas]![numdoc] AS numdoc, " _
            & " mae_documento.abrev, vta_ventas.fchdoc AS fchemi, mae_moneda.simbolo AS moneda, mae_cliente.nombre AS clipro, mae_cliente.numruc, vta_ventas.imptotdoc AS importe, " _
            & " vta_ventas.impsal AS saldo, vta_ventas.idmon, 2 AS idmod, vta_ventas.id AS iddoc " _
            & " FROM (((vta_ventas LEFT JOIN mae_libros ON vta_ventas.idlib = mae_libros.id) LEFT JOIN mae_documento ON vta_ventas.tipdoc = mae_documento.id) LEFT JOIN mae_moneda ON vta_ventas.idmon = mae_moneda.id) " _
            & " LEFT JOIN mae_cliente ON vta_ventas.idcli = mae_cliente.id Where (((vta_ventas.impsal) <> 0) And ((vta_ventas.anulado) = 0))" _
            & " Union " _
            & " SELECT 0 as xsel, '' AS numreg, vta_proforma.numdoc AS numdoc, mae_documento.abrev, vta_proforma.fchdoc as fchemi, mae_moneda.simbolo, mae_cliente.nombre AS clipro, " _
            & " mae_cliente.numruc,  vta_proforma.imptot AS importe, vta_proforma.imptot AS saldo, vta_proforma.idmon, 12 AS idmod, vta_proforma.id AS  iddoc FROM ((vta_proforma " _
            & " LEFT JOIN mae_documento  ON vta_proforma.tipdoc = mae_documento.id) LEFT JOIN mae_moneda ON vta_proforma.idmon = mae_moneda.id) LEFT JOIN mae_cliente ON vta_proforma.idcli = mae_cliente.id  " _
            & " WHERE (((vta_proforma.idcli)=30))"
    End If
    ...
    If EsSeleccion = False Then
        CARGAR_DLL_EPSBUSCAR xCon, xRs, nSQL, xCampos(), "Buscando Documentos del Cliente", "numdoc", "numdoc", Principio
    Else
        CARGAR_DLL_EPSBUSCAR_SEL xCon, xRs, nSQL, xCampos(), "Buscando Documentos del Cliente"
    End If
    
    If xRs.State = 1 Then
        If xRs.RecordCount <> 0 Then
            If EsSeleccion = True Then xRs.MoveFirst
        End If
        Do While Not xRs.EOF
            ...
            Fg1.TextMatrix(Fg1.Rows - 1, 5) = NulosC(xRs("moneda"))
            Fg1.TextMatrix(Fg1.Rows - 1, 6) = NulosC(xRs("clipro"))
            Fg1.TextMatrix(Fg1.Rows - 1, 7) = Format(xRs("importe"), FORMAT_MONTO)
            If xRs("idmon") = 1 Then
                Fg1.TextMatrix(Fg1.Rows - 1, 9) = Format(NulosN(xRs("saldo")), FORMAT_MONTO)
                Fg1.TextMatrix(Fg1.Rows - 1, 8) = Format(NulosN(xRs("saldo")) / NulosN(LblTipoCambio.Caption), FORMAT_MONTO)
            Else
            ...
            End If
            Fg1.TextMatrix(Fg1.Rows - 1, 10) = NulosN(xRs("idmod"))
            Fg1.TextMatrix(Fg1.Rows - 1, 11) = NulosN(xRs("iddoc"))
            Fg1.TextMatrix(Fg1.Rows - 1, 12) = NulosN(xRs("idmon"))
                
            '--si no es seleccionable salir del bucle
            If EsSeleccion = False Then Exit Do
            '--avansar a la siguiente posicion
            xRs.MoveNext
        Loop
    End If
...
Private Sub Command1_Click()
    '--grabar operacion en cta cte savar
'    Dim RstDetLet As New ADODB.Recordset
'    Dim xSql As String
'    Dim xCodSunLib  As String
'    Dim xTc As Double
    Dim A, B As Integer
    
'    xCodSunLib = Busca_Codigo(37, "id", "codsun", "mae_libros", "N", xCon)
    
    RstLet.MoveFirst
        
    For A = 1 To RstLet.RecordCount
'        If NulosN(RstLet("tc")) = 0 Then
'            xTc = HallaTipoCambio(RstLet("fchemi"), 2, Venta, xCon)
'        Else
'            xTc = RstLet("tc")
'        End If
'
'        xSql = "SELECT let_letradet.* From let_letradet Where (((let_letradet.idlet) = " & RstLet("id") & ")) ORDER BY let_letradet.fchven"
'        RST_Busq RstDetLet, xSql, xCon
'        If RstDetLet.RecordCount <> 0 Then
'            RstDetLet.MoveFirst
'            For B = 1 To RstDetLet.RecordCount
'                If NulosN(RstLet("idmon")) = 1 Then
'                    GrabarOperacionCtaCteDocRef 37, RstLet("id"), NulosC(RstLet("numerodocref")), RstLet("idclipro"), RstLet("tipdoc"), RstDetLet("numdoc"), _
'                        RstLet("fchemi"), RstLet("idmon"), xTc, RstDetLet("implet"), 0, 0, 0, Format(xCodSunLib, "00") & RstLet("numreg"), xCon, RstDetLet("corr")
'                Else
'                    GrabarOperacionCtaCteDocRef 37, RstLet("id"), NulosC(RstLet("numerodocref")), RstLet("idclipro"), RstLet("tipdoc"), RstDetLet("numdoc"), _
'                        RstLet("fchemi"), RstLet("idmon"), xTc, 0, 0, RstDetLet("implet"), 0, Format(xCodSunLib, "00") & RstLet("numreg"), xCon, RstDetLet("corr")
'                End If
'
'                RstDetLet.MoveNext
'                If RstDetLet.EOF = True Then Exit For
'            Next B
'        End If
        
        GrabarOperacionCtaCte 37, RstLet("id"), xCon
        
        RstLet.MoveNext
        If RstLet.EOF = True Then Exit For
    Next A
    MsgBox "El proceso termino con exuto"
End Sub
