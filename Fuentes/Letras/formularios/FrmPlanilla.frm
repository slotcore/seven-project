   ...
   Begin SizerOneLibCtl.TabOne TabOne1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VSFlex7Ctl.VSFlexGrid Fg1 
            ...
            FormatString    =   $"FrmPlanilla.frx":0396
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
      ...
      Begin VB.Frame Frame1 
         ...
         Begin TrueOleDBGrid70.TDBGrid Dg1 
            ...
            Splits(0)._ColumnProps(20)=   "Column(3).Width=1693"
            Splits(0)._ColumnProps(21)=   "Column(3).DividerColor=0"
            Splits(0)._ColumnProps(22)=   "Column(3)._WidthInPix=1614"
            ...
            Splits(0)._ColumnProps(32)=   "Column(5).Width=2381"
            Splits(0)._ColumnProps(33)=   "Column(5).DividerColor=0"
            Splits(0)._ColumnProps(34)=   "Column(5)._WidthInPix=2302"
            Splits(0)._ColumnProps(35)=   "Column(5)._EditAlways=0"
            Splits(0)._ColumnProps(36)=   "Column(5)._ColStyle=512"
            Splits(0)._ColumnProps(37)=   "Column(5).Order=6"
            Splits(0)._ColumnProps(38)=   "Column(6).Width=4524"
            Splits(0)._ColumnProps(39)=   "Column(6).DividerColor=0"
            Splits(0)._ColumnProps(40)=   "Column(6)._WidthInPix=4445"
            ...
            Splits(0)._ColumnProps(56)=   "Column(9).Width=2064"
            Splits(0)._ColumnProps(57)=   "Column(9).DividerColor=0"
            Splits(0)._ColumnProps(58)=   "Column(9)._WidthInPix=1984"
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmPlanilla.frx":0495
               Key             =   "IMG1"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmPlanilla.frx":09D9
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmPlanilla.frx":0D6B
               Key             =   "IMG2"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmPlanilla.frx":0EEF
               Key             =   "IMG3"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmPlanilla.frx":1343
               Key             =   "IMG4"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmPlanilla.frx":145B
               Key             =   "IMG5"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmPlanilla.frx":199F
               Key             =   "IMG6"
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmPlanilla.frx":1EE3
               Key             =   "IMG7"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmPlanilla.frx":1FF7
               Key             =   "IMG8"
            EndProperty
            BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmPlanilla.frx":210B
               Key             =   "IMG9"
            EndProperty
            BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmPlanilla.frx":255F
               Key             =   "IMG10"
            EndProperty
            BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmPlanilla.frx":26CB
               Key             =   "IMG11"
            EndProperty
         EndProperty
      End
...
Private Sub Dg1_KeyUp(KeyCode As Integer, Shift As Integer)
    If KeyCode = 123 And TabOne1.CurrTab = 0 Then
        VerMovimientos1 20, NulosN(RstLet("id")), xCon
    End If
End Sub
...
Private Sub Form_Activate()
    If SeEjecuto = False Then
        ...
        Else
            Rpta = MsgBox("No se ha registrado ninguna planilla ¿Desea agregar una ahora?", vbQuestion + vbYesNo + vbDefaultButton1, xTitulo)
            If Rpta = vbYes Then
                Nuevo
...
''        & " WHERE (((let_planilla.fchreg)>=CDate('" & xFchIni & "') And (let_planilla.fchreg)<=CDate('" & xFchFin & "')))", xCon
    ...
    nSQL = "SELECT let_planilla.*, mae_bancos.descripcion AS descban, let_modalidad.descripcion AS descmod, " _
        ...
        & " let_planilla.numlet & '' as numlet1 ,let_planilla.imptot & '' as imptot1, let_planilla.fchemi & '' as fchemi1,Mid([let_planilla]![numreg],1,2) & [mae_libros]![codsun] & Mid([let_planilla]![numreg],3,4) AS numreg2 " _
        ...
        & " WHERE month(let_planilla.fchreg) = " & mMesActivo
...
Sub MuestraSegundoTab()
    ...
    TxtIdBcoCta.Text = RstLet("idban")
    LblDescBan.Caption = Busca_Codigo(NulosN(RstLet("idban")), "id", "descripcion", "mae_bancos", "N", xCon)
    ...
    nSQL = "SELECT let_planilladet.idpla, mae_cliente.nombre, let_letradet.numser, let_letradet.fchemi, let_letradet.fchven, let_letradet.numdoc, let_planilladet.implet, mae_moneda.simbolo AS moneda, [let_letra].[ano] & ' ' & [let_letradet].[numdoc] & ' ' & [let_letradet].[numser] AS numletra, let_letradet.idlet, let_letradet.corr " _
        ...
        + vbCr + " WHERE (((let_planilladet.idpla)=" & NulosN(RstLet("id")) & " ));"
...
Private Sub OpcionesPeriodo()
    ...
    CierrePeriodo Toolbar1, 20, mMesActivo, fCierrePeriodo, xCon
    '------------------------------------------------------------------------------------------
...
Private Sub CmdBusBan_Click()
    ...
    xCampos(1, 0) = "N° Cta Cte":   xCampos(1, 1) = "numcue":       xCampos(1, 2) = "2000":         xCampos(1, 3) = "C"
    xCampos(2, 0) = "Id":           xCampos(2, 1) = "idbcocta":     xCampos(2, 2) = "500":          xCampos(2, 3) = "N"
    
    
    xform.SQLCad = "SELECT mae_banconumcta.id AS idbcocta, mae_bancos.descripcion AS banco, mae_banconumcta.numcue, mae_bancos.numruc " _
        & " FROM mae_banconumcta LEFT JOIN mae_bancos ON mae_banconumcta.idban = mae_bancos.id " _
...
'    On Error GoTo LaCague
    ...
    GrabarOperacion xIdUsuario, 20, QueHace, xHorIni, Time, Date, xCon, CDbl(xId)
...
Sub Eliminar()
    ...
    ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    '--falta validar que no elimine registros relacionados con el abono en banco
    ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
