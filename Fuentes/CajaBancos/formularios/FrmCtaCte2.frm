      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmCtaCte2.frx":0000
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmCtaCte2.frx":0544
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmCtaCte2.frx":08D6
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmCtaCte2.frx":0A30
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmCtaCte2.frx":0DC2
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmCtaCte2.frx":0F46
               Key             =   ""
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmCtaCte2.frx":139A
               Key             =   ""
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmCtaCte2.frx":14B2
               Key             =   ""
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmCtaCte2.frx":19F6
               Key             =   ""
            EndProperty
            BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmCtaCte2.frx":1F3A
               Key             =   ""
            EndProperty
            BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmCtaCte2.frx":204E
               Key             =   ""
            EndProperty
            BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmCtaCte2.frx":2162
               Key             =   ""
            EndProperty
            BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmCtaCte2.frx":25B6
               Key             =   ""
            EndProperty
            BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmCtaCte2.frx":2722
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin SizerOneLibCtl.TabOne TabOne1 
      ...
      Begin VB.Frame Frame7 
         ...
         Begin VSFlex7Ctl.VSFlexGrid Fg1 
            ...
            FormatString    =   $"FrmCtaCte2.frx":2ECE
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
      ...
      Begin VB.Frame Frame4 
         ...
         Begin VSFlex7Ctl.VSFlexGrid Fg2 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   0   'False
            FormatString    =   $"FrmCtaCte2.frx":3055
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
...
Sub pExportar()
    ...
    If TabOne1.CurrTab = 0 Then '--detalle
        ...
        GRID_EXPORTAR_MSEXCELTMP Fg1, xCon, flexFileCustomText, True, "Cuenta Corriente - " + IIf(OptCliente.Value = True, "Cliente", "Proveedor"), "Expresado en " & LblMoneda.Caption, "Cuenta Corriente Análisis"
...
Sub CargarCli2(IdCliPro)
    ...
    If OptCliente.Value = True Then '--ventas
        ...
        nSQL = "SELECT vta_ventas.id,IIf([vta_ventas]![anulado]=-1,' ',[mae_cliente]![numruc]) AS numruc, IIf([vta_ventas]![anulado]=-1,'Anulado',[mae_cliente]![nombre]) AS nombre, IIf([vta_ventas].[numreg] Is Null Or [vta_ventas].[numreg]='',[mae_libros].[codsun],Left([vta_ventas].[numreg],2) & [mae_libros].[codsun] & Right([vta_ventas].[numreg],4)) AS registro, 'Ventas' AS libro, mae_documento.codsun,mae_documento.abrev, [vta_ventas]![numser]+'-'+[vta_ventas]![numdoc] AS numdoc2, vta_ventas.fchdoc, vta_ventas.fchven, mae_moneda.simbolo, " _
            ...
            + vbCr + " FROM ((((vta_ventas LEFT JOIN mae_cliente ON vta_ventas.idcli = mae_cliente.id) LEFT JOIN mae_documento ON vta_ventas.tipdoc = mae_documento.id) LEFT JOIN con_tc ON vta_ventas.fchdoc = con_tc.fecha) LEFT JOIN mae_libros ON vta_ventas.idlib = mae_libros.id) LEFT JOIN mae_moneda ON vta_ventas.idmon = mae_moneda.id " _
            + vbCr + " WHERE vta_ventas.tipdoc <>7 and  vta_ventas.anulado =0 and vta_ventas.fchdoc <= CDate('" & TxtFecha.Valor & "') " & nSQLWhere _
            + vbCr + " ORDER BY IIf([vta_ventas]![anulado]=-1,'Anulado',[mae_cliente]![nombre]), [vta_ventas]![numser]+'-'+[vta_ventas]![numdoc];"
    ...
    If rst.RecordCount <> 0 Then
        ...
        If OptCliente.Value = True Then
            ...
            nSQL = "SELECT con_diario.rregistro, Format([con_diario].[idmes],'00') & [mae_libros].[codsun] & Format([con_diario].[numasi],'0000') AS registro, mae_libros.descripcion AS libro, '' AS codsun, tes_documentos.abrev, con_diario.rnumerodoc2 AS numdoc, con_diario.rfchope2 AS fchemi, mae_moneda.simbolo, con_tc.impven AS tipcam, IIf(con_diario.idmon=1,(con_diario.impdebsol+con_diario.imphabsol),(con_diario.impdebdol+con_diario.imphabdol)) AS imptotal, IIf(con_diario.idmon=1,imptotal,imptotal*[con_tc]![impven]) AS imptotsol, IIf(con_diario.idmon=2 And [con_tc]![impven] Is Not Null,imptotal,imptotal/[con_tc]![impven]) AS imptotdol, con_diario.ridper,con_diario.rnumerodoc AS numdoc2,con_diario.rglosaope,  IIf([con_diario].[idlib]=6,[tes_cajadestinodet].[iddoc],[con_diario].[iddocpro]) AS iddoc " _
                + vbCr + " FROM ((((con_diario LEFT JOIN mae_moneda ON con_diario.idmon = mae_moneda.id) LEFT JOIN con_tc ON con_diario.fchdoc = con_tc.fecha) LEFT JOIN tes_documentos ON con_diario.rtipdoc2 = tes_documentos.id) LEFT JOIN mae_libros ON con_diario.idlib = mae_libros.id) LEFT JOIN tes_cajadestinodet ON (con_diario.idmov = tes_cajadestinodet.idtes) AND (con_diario.iddocpro = tes_cajadestinodet.corr) " _
                + vbCr + " WHERE (((con_diario.idlib) In (5,6,8)) AND ((con_diario.ridlib)=2)) " & nSQLWhere
                
            '--unido a referencias de nota de credito
            If IdCliPro <> 0 Then nSQLWhere = " and vta_ventas.idcli = " & IdCliPro & " "
            
            nSQL = nSQL + vbCr + " Union All " _
                + vbCr + "SELECT Left([vta_ventas_1].[numreg],2) & [mae_libros_1].[codsun] & Right([vta_ventas_1].[numreg],4) AS rregistro, Mid([vta_ventas]![numreg],1,2) & [mae_libros]![codsun] & Mid([vta_ventas]![numreg],3,4) AS registro, mae_libros.descripcion AS libro, mae_libros.codsun, mae_documento.abrev, [vta_ventas]![numser] & '-' & [vta_ventas]![numdoc] AS numdoc, vta_ventas.fchdoc AS fchemi, mae_moneda.simbolo, con_tc.impven AS timpcam, vta_ventas.imptotdoc AS imptotdocal, IIf([vta_ventas]![idmon]=1,[vta_ventas]![imptotdoc],[vta_ventas]![imptotdoc]*[con_tc]![impven]) AS imptotdocsol, IIf([vta_ventas]![idmon]=2,[vta_ventas]![imptotdoc],[vta_ventas]![imptotdoc]/[con_tc]![impven]) AS imptotdocdol, vta_ventas.idcli AS ridper,  [vta_ventas_1].[numser] & '-' & [vta_ventas_1].[numdoc] AS numdoc2, vta_ventas.glosa AS glosaope, vta_ventas_1.id AS iddoc " _
                 ...
                 + vbCr + " WHERE (((vta_ventas.iddocref) Is Not Null And (vta_ventas.iddocref) <> 0)) " & nSQLWhere
        ...
        ElseIf OptProvee.Value = True Then
            ...
            nSQL = "SELECT con_diario.rregistro, Format([con_diario].[idmes],'00') & [mae_libros].[codsun] & Format([con_diario].[numasi],'0000') AS registro, mae_libros.descripcion AS libro, '' AS codsun, tes_documentos.abrev, con_diario.rnumerodoc2 AS numdoc, con_diario.rfchope2 AS fchemi, mae_moneda.simbolo, con_tc.impven AS tipcam, IIf(con_diario.idmon=1,(con_diario.impdebsol+con_diario.imphabsol),(con_diario.impdebdol+con_diario.imphabdol)) AS imptotal, IIf(con_diario.idmon=1,imptotal,imptotal*[con_tc]![impven]) AS imptotsol, IIf(con_diario.idmon=2 And [con_tc]![impven] Is Not Null,imptotal,imptotal/[con_tc]![impven]) AS imptotdol, con_diario.ridper,con_diario.rnumerodoc AS numdoc2,con_diario.rglosaope,IIf([con_diario].[idlib]=6,[tes_cajadestinodet].[iddoc],[con_diario].[iddocpro]) AS iddoc " _
                ...
                + vbCr + " WHERE (((con_diario.idlib) In (6,8,39)) AND ((con_diario.ridlib) IN (1,4))) " & nSQLWhere
        ...
        ElseIf opt4ta.Value = True Then
            ...
            nSQL = "SELECT con_diario.rregistro, Format([con_diario].[idmes],'00') & [mae_libros].[codsun] & Format([con_diario].[numasi],'0000') AS registro, mae_libros.descripcion AS libro, '' AS codsun, tes_documentos.abrev, con_diario.rnumerodoc2 AS numdoc, con_diario.rfchope2 AS fchemi, mae_moneda.simbolo, con_tc.impven AS tipcam, IIf(con_diario.idmon=1,(con_diario.impdebsol+con_diario.imphabsol),(con_diario.impdebdol+con_diario.imphabdol)) AS imptotal, IIf(con_diario.idmon=1,imptotal,imptotal*[con_tc]![impven]) AS imptotsol, IIf(con_diario.idmon=2 And [con_tc]![impven] Is Not Null,imptotal,imptotal/[con_tc]![impven]) AS imptotdol, con_diario.ridper,con_diario.rnumerodoc AS numdoc2,con_diario.rglosaope,IIf([con_diario].[idlib]=6,[tes_cajadestinodet].[iddoc],[con_diario].[iddocpro]) AS iddoc " _
                + vbCr + " FROM ((((con_diario LEFT JOIN mae_moneda ON con_diario.idmon = mae_moneda.id) LEFT JOIN con_tc ON con_diario.fchdoc = con_tc.fecha) LEFT JOIN tes_documentos ON con_diario.rtipdoc2 = tes_documentos.id) LEFT JOIN mae_libros ON con_diario.idlib = mae_libros.id) LEFT JOIN tes_cajadestinodet ON (con_diario.iddocpro = tes_cajadestinodet.corr) AND (con_diario.idmov = tes_cajadestinodet.idtes) " _
                + vbCr + " WHERE (((con_diario.idlib) In (6,8,39)) AND ((con_diario.ridlib)=40)) " & nSQLWhere
            ...
            If xSaldoDoc <> NulosN(Fg1.TextMatrix(xFila, 12)) And NulosN(rst("idmon")) = NulosN(TxtIdMon.Text) Then
                ...
                ElseIf OptProvee.Value = True Then                                '--COMPRAS
                    If LCase(NulosC(rst("libro"))) = "percepciones" Then
                        xCon.Execute "UPDATE con_percepcion SET con_percepcion.impsal = " & NulosN(Fg1.TextMatrix(xFila, 12)) & " WHERE (((con_percepcion.id)=" & rst("id") & "))"
                    Else
                        xCon.Execute "UPDATE com_compras SET com_compras.impsal = " & NulosN(Fg1.TextMatrix(xFila, 12)) & " WHERE (((com_compras.id)=" & rst("id") & "))"
                    End If
                ...
                Else
                    xCon.Execute "UPDATE com_honorarios SET com_honorarios.impsal = " & NulosN(Fg1.TextMatrix(xFila, 12)) & " WHERE (((com_honorarios.id)=" & rst("id") & "))"
                End If
            End If
