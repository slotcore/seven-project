...
Private Sub pCargarGrid()
    ...
    nSQL = "SELECT pla_boleta.*, pla_empleados.apepat & ' ' & pla_empleados.apemat & ' ' & pla_empleados.nom AS nombres, mae_categoria.nomcor AS categoria, pla_boleta.numser & ' ' & pla_boleta.numdoc AS numerodoc, mae_documento.abrev, mae_moneda.simbolo, " _
        ...
        + vbCr + " pla_boleta.fchdoc & '' as fchdoc1,pla_boleta.fchpago & ''as fchpago1, pla_boleta.imptot & '' as imptot1,pla_boleta.impsal as impsal1 " _
...
Private Function GrabarDet(xCod&, RstCab As ADODB.Recordset, _
    ...
    If QueHaceTmp = 1 Then
        ...
        Else
            ...
            '********************************************************************************
'''            xNumAsiento = DevuelveNumAsiento(9, NulosN(xCod), mMesActivo, xCon)
'''            If xNumAsiento = "" Then xNumAsiento = NuevoNumAsiento(9, mMesActivo, xCon)
'''            '--eliminado el diario
'''            xCon.Execute "DELETE * FROM con_diario WHERE idlib = 9 AND idmes = " & mMesActivo & " and idmov = " & xCod & " ;"
            '********************************************************************************
...
'''    Set RstTmp = Nothing
    ...
    xNumAsiento = GenerarAsiento(xCon, 9, CDbl(xCod), AnoTra, mMesActivo, 0, 0)
    If xNumAsiento = "" Then GoTo salir
    
    'grabamos el movimiento en la tabla var_edicion
    GrabarOperacion xIdUsuario, 24, QueHace, xHorIni, Time, Date, xCon, CDbl(xCod)
...
Private Sub cb_Click(Index As Integer)
    ...
    Select Case Index
        ...
        Case 1 '--personal
            pCargarPersonal Me, Index, False
            txt(1).SetFocus
            Exit Sub
...
Sub OpcionesPeriodo()
    ...
    CierrePeriodo Toolbar1, 24, mMesActivo, fCierrePeriodo, xCon
    '------------------------------------------------------------------------------------------
