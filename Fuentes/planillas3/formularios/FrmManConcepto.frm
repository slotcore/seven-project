   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManConcepto.frx":2CF0
            Key             =   ""
         EndProperty
         BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManConcepto.frx":3142
            Key             =   ""
         EndProperty
         BeginProperty ListImage15 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManConcepto.frx":3594
            Key             =   ""
         EndProperty
         BeginProperty ListImage16 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManConcepto.frx":38AE
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.Toolbar Toolbar1 
      ...
      BeginProperty Buttons {66833FE8-8583-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Button12 {66833FEA-8583-11D1-B16A-00C0F0283628} 
            Object.ToolTipText     =   "Otros Conceptos"
            ImageIndex      =   15
         EndProperty
         ...
         Begin SizerOneLibCtl.TabOne TabOne2 
            ...
            Begin VB.Frame Frame7 
               ...
               Begin VSFlex7Ctl.VSFlexGrid fg 
                  ...
                  ColWidthMax     =   0
                  ExtendLastCol   =   0   'False
                  FormatString    =   $"FrmManConcepto.frx":3C40
                  ScrollTrack     =   0   'False
                  ScrollBars      =   3
                  ScrollTips      =   0   'False
                  MergeCells      =   0
            ...
            Begin VB.Frame Frame5 
               ...
               Begin VSFlex7Ctl.VSFlexGrid fg 
                  ...
                  ColWidthMax     =   0
                  ExtendLastCol   =   0   'False
                  FormatString    =   $"FrmManConcepto.frx":3C7C
                  ScrollTrack     =   0   'False
                  ScrollBars      =   3
                  ScrollTips      =   0   'False
                  MergeCells      =   0
            ...
            Begin VB.Frame Frame4 
               ...
               Begin VB.Frame Frame8 
                  ...
                  Begin VB.CommandButton cb 
                     ...
                     Index           =   2
                     Left            =   3045
                     Picture         =   "FrmManConcepto.frx":3CB8
                     Style           =   1  'Graphical
                     TabIndex        =   55
                  ...
                  Begin VB.CommandButton cb 
                     ...
                     Index           =   3
                     Left            =   3045
                     Picture         =   "FrmManConcepto.frx":3DEA
                     Style           =   1  'Graphical
                     TabIndex        =   54
            ...
            Begin VB.Frame Frame3 
               ...
               Begin VB.CommandButton cb 
                  ...
                  Index           =   1
                  Left            =   1950
                  Picture         =   "FrmManConcepto.frx":3F1C
                  Style           =   1  'Graphical
                  TabIndex        =   27
                  ToolTipText     =   "Seleccione el Tipo de Concepto (Primero seleccione la categoría)"
                  Top             =   750
               ...
               Begin VB.CommandButton cb 
                  ...
                  Index           =   0
                  Left            =   1950
                  Picture         =   "FrmManConcepto.frx":404E
                  Style           =   1  'Graphical
                  TabIndex        =   26
                  ToolTipText     =   "Seleccione la Categoría de Concepto"
                  Top             =   420
               ...
               Begin VB.Frame Frame6 
                  ...
                  Begin VB.CommandButton cmd_formula 
                     ...
                     Height          =   645
                     Left            =   90
                     Picture         =   "FrmManConcepto.frx":4189
                     Style           =   1  'Graphical
                     TabIndex        =   8
                     Top             =   735
                     Width           =   1275
...
Function Grabar() As Boolean
    ...
    Else
        ...
        If NulosN(lbl_cod(0).Caption) <> 2 Then '--si categoria no es aportaciones
    ...
    If NulosN(lbl_cod(0).Caption) <> 2 Then
        ...
        For A = Fg(0).FixedRows To Fg(0).Rows - 1
            ...
            RstDet("activo") = NulosN(Fg(0).TextMatrix(A, 4))
...
Sub Eliminar()
    ...
    '---------------------------------------------------------------------------------
    '--validar que no este en boletas de pago
    nSQL = "select idcpto from pla_boletadet where idcpto = " & xId & " ; "
    RST_Busq RstBus, nSQL, xCon
    If RstBus.RecordCount <> 0 Then
        MsgBox "No se puede eliminar el Concepto, figura en Boletas de Pago", vbInformation + vbOKOnly + vbDefaultButton1, xTitulo
        Set RstBus = Nothing
        Exit Sub
    End If
    Set RstBus = Nothing
...
Private Sub Toolbar1_ButtonClick(ByVal Button As MSComctlLib.Button)
    ...
    If Button.Index = 12 Then FrmManConceptoVarios.Show 1
    
    If Button.Index = 13 Then pActivarConcepto
    
    If Button.Index = 15 Then pExportar
    'If Button.Index = 16 Then pImprimir
...
Private Sub pConfigurarGrilla()
    Agregando = True
    '--lista de conceptos (impuestos) que estan afectos
    With Fg(0)
        .Rows = 2
        .Cols = 5
        .FixedRows = 2
    ...
    End With
    '--lista de conceptos cuando este sea impuesto
    With Fg(1) '--
        .Rows = 1
        .Cols = 7
        .FixedRows = 1
...
Private Sub pExportar()
    ...
    nSQL = "SELECT pla_conceptocat.descripcion AS categoria, pla_conceptotipo.descripcion AS tipo, pla_concepto.codsun, pla_concepto.descripcion, pla_concepto.nomcorto, pla_concepto.variable, pla_concepto.formula, con_planctas.cuenta AS ctanumdeb, con_planctas.descripcion AS ctadeb, con_planctas_1.cuenta AS ctanumhab, con_planctas_1.descripcion AS ctahab " _
        + vbCr + " FROM pla_conceptocat RIGHT JOIN (pla_conceptotipo RIGHT JOIN ((pla_concepto LEFT JOIN con_planctas ON pla_concepto.idctadeb = con_planctas.id) LEFT JOIN con_planctas AS con_planctas_1 ON pla_concepto.idctahab = con_planctas_1.id) ON pla_conceptotipo.id = pla_concepto.idtipo) ON pla_conceptocat.id = pla_conceptotipo.idcat; "
    ...
    xCampos(0, 0) = "Categoría":     xCampos(0, 1) = "categoria":   xCampos(0, 2) = 0:  xCampos(0, 3) = "900"
    xCampos(1, 0) = "Tipo":          xCampos(1, 1) = "tipo":        xCampos(1, 2) = 0:  xCampos(1, 3) = "3200"
    xCampos(2, 0) = "Cod. Sunat":    xCampos(2, 1) = "codsun":      xCampos(2, 2) = 0:  xCampos(2, 3) = "800"
    xCampos(3, 0) = "Descripción":   xCampos(3, 1) = "descripcion": xCampos(3, 2) = 0:  xCampos(3, 3) = "3500"
    xCampos(4, 0) = "Nombre Corto":  xCampos(4, 1) = "nomcorto":    xCampos(4, 2) = 0:  xCampos(4, 3) = "600"
    xCampos(5, 0) = "Num Cta Debe":  xCampos(5, 1) = "ctanumdeb":   xCampos(5, 2) = 0:  xCampos(5, 3) = "1100"
    xCampos(6, 0) = "Cta Debe":      xCampos(6, 1) = "ctadeb":      xCampos(6, 2) = 0:  xCampos(6, 3) = "3000"
    xCampos(7, 0) = "Num Cta Haber": xCampos(7, 1) = "ctanumhab":   xCampos(7, 2) = 0:  xCampos(7, 3) = "1100"
    xCampos(8, 0) = "Cta Haber":     xCampos(8, 1) = "ctahab":      xCampos(8, 2) = 0:  xCampos(8, 3) = "3000"
    
    oExport.VSFlexGrid_Exportar_MSExcel xCon, , "Lista de Conceptos de Planilla", "", "", "Conceptos de Planilla", Rst, xCampos
    Set oExport = Nothing
    Set Rst = Nothing
