...
Private Sub CmdAcepta_Click()
    ...
    xRutaData = RstEmp("rutdat")
    xNumRuc = RstEmp("ruc")
    xNomEmp = RstEmp("nom")
    xcad = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source='" & Trim(xRutaData) & "'; " _
    & " Persist Security Info=False;Jet OLEDB:Database Password=LUZDURADERA"
    
    If xCon.State = 1 Then
        xCon.Close
        xCon.ConnectionString = xcad
    End If
    xCon.Open
    Unload Me
    MDImENU.Show
...
Private Sub Form_Load()
    ...
    RST_Busq RstEmp, "SELECT * FROM empresa ORDER BY nom", xCon
