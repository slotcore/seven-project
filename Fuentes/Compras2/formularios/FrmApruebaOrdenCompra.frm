...
Begin VB.Form FrmApruebaOrdenCompra 
   Caption         =   "Compras - Aprobar Orden de Compra"
   ClientHeight    =   6060
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   9780
   ...
   Begin XtremeSuiteControls.PushButton PushButton5 
      ...
      Picture         =   "FrmApruebaOrdenCompra.frx":0000
   End
   ...
   Begin XtremeSuiteControls.PushButton PushButton1 
      ...
      UseVisualStyle  =   -1  'True
      Picture         =   "FrmApruebaOrdenCompra.frx":031A
   End
   ...
   Begin XtremeSuiteControls.PushButton PushButton2 
      ...
      UseVisualStyle  =   -1  'True
      Picture         =   "FrmApruebaOrdenCompra.frx":0634
   End
   Begin XtremeSuiteControls.PushButton PushButton3 
      ...
      Caption         =   "Salir"
      UseVisualStyle  =   -1  'True
      Picture         =   "FrmApruebaOrdenCompra.frx":094E
   End
   Begin XtremeSuiteControls.PushButton PushButton4 
      ...
      UseVisualStyle  =   -1  'True
      Picture         =   "FrmApruebaOrdenCompra.frx":0C68
   End
End
Attribute VB_Name = "FrmApruebaOrdenCompra"
...
Private Sub Form_Activate()
    RST_Busq Rst, "SELECT com_ordencompra.id, com_ordencompra!numser & '-' & com_ordencompra!numdoc AS numdoc, com_ordencompra.fchemi, pla_empleados.nombre, " _
        & " com_ordencompra.idest, mae_estados.descripcion AS descest, com_ordencompra.idsit FROM ((com_ordencompra LEFT JOIN mae_estados " _
        & " ON com_ordencompra.idest = mae_estados.id) LEFT JOIN com_usuario ON com_ordencompra.idsol = com_usuario.id) LEFT JOIN pla_empleados " _
        & " ON com_usuario.idper = pla_empleados.id WHERE (((com_ordencompra.idsit)=0))", xCon

    Dg1.DataSource = Rst
End Sub

Private Sub PushButton1_Click()
    xCon.Execute "UPDATE com_ordencompra SET com_ordencompra.idest = 2 WHERE (((com_ordencompra.id)=" & Rst("id") & "))"
    Rst.Requery
    Dg1.Refresh
End Sub

Private Sub PushButton2_Click()
    xCon.Execute "UPDATE com_ordencompra SET com_ordencompra.idest = 4 WHERE (((com_ordencompra.id)=" & Rst("id") & "))"
    Rst.Requery
    Dg1.Refresh
End Sub
...
Private Sub PushButton4_Click()
    xCon.Execute "UPDATE com_ordencompra SET com_ordencompra.idest = 1 WHERE (((com_ordencompra.id)=" & Rst("id") & "))"
    Rst.Requery
    Dg1.Refresh
End Sub
