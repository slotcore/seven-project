...
Begin VB.Form FrmAnalisisCtaCteContable 
   Caption         =   "Form2"
   ClientHeight    =   6675
   ClientLeft      =   60
   ClientTop       =   345
   ...
   Begin SizerOneLibCtl.ElasticOne EO 
      ...
      FloodStyle      =   1
      _GridInfo       =   $"FrmAnalisisCtaCteContable.frx":0000
      Begin SizerOneLibCtl.TabOne TabOne1 
         ...
         Begin VB.Frame FrameDetalle 
            ...
            Begin VSFlex7Ctl.VSFlexGrid Fg1 
               ...
               FormatString    =   $"FrmAnalisisCtaCteContable.frx":0042
               ScrollTrack     =   0   'False
               ScrollBars      =   3
               ScrollTips      =   0   'False
               MergeCells      =   0
         ...
         Begin VB.Frame FramResumen 
            ...
            Begin VSFlex7Ctl.VSFlexGrid Fg3 
               ...
               ColWidthMax     =   0
               ExtendLastCol   =   0   'False
               FormatString    =   $"FrmAnalisisCtaCteContable.frx":0117
               ScrollTrack     =   0   'False
               ScrollBars      =   3
               ScrollTips      =   0   'False
               MergeCells      =   0
      ...
      Begin SizerOneLibCtl.ElasticOne ElasticOne1 
         ...
         FrameShadow     =   -2147483632
         FloodStyle      =   1
         _GridInfo       =   $"FrmAnalisisCtaCteContable.frx":01ED
         Begin VB.Frame Frame1 
            ...
            Begin VB.CommandButton CmdBusMon 
               ...
               Height          =   240
               Left            =   1230
               Picture         =   "FrmAnalisisCtaCteContable.frx":024B
               Style           =   1  'Graphical
               TabIndex        =   27
               Top             =   720
               Width           =   240
         ...
         Begin VB.Frame Frame5 
            ...
            Begin VSFlex7Ctl.VSFlexGrid Fg2 
               ...
               ColWidthMax     =   0
               ExtendLastCol   =   0   'False
               FormatString    =   $"FrmAnalisisCtaCteContable.frx":037D
               ScrollTrack     =   0   'False
               ScrollBars      =   3
               ScrollTips      =   0   'False
               MergeCells      =   0
   ...
   Begin XtremeCommandBars.ImageManager ImageManager1 
      ...
      _ExtentY        =   635
      _StockProps     =   0
      Icons           =   "FrmAnalisisCtaCteContable.frx":03CD
   End
End
Attribute VB_Name = "FrmAnalisisCtaCteContable"
...
Sub MostrarDetalle()
    ...
    For A = 1 To RstDet.RecordCount
        ...
        Fg1.TextMatrix(Fg1.Rows - 1, 9) = NulosC(RstDet("nombre"))
        RstDet.MoveNext
...
Sub ImprimirDetalleFG2()
    ...
    'Dim xForeColor As Long
    Dim TotalDebeDol, TotalHaberDol, TotalDol As Double
    Dim TotalDebeSol, TotalHaberSol, TotalSol As Double
...
'On Error GoTo LaCagada2
    ...
    If RstDet.RecordCount <> 0 Then
        ...
        For B = 1 To RstDet.RecordCount
            ...
            'Fg3.TextMatrix(Fg3.Rows - 1, 10) = Format(NulosN(RstDet("debedol")), "0.00")
            ...
            TotalDebeDol = 0:            TotalHaberDol = 0:         TotalDol = 0
            TotalDebeSol = 0:            TotalHaberSol = 0:         TotalSol = 0
            
            TotalDebeDol = RstDet("debedol") + (RstDet("debesol") / RstDet("imptc"))
            TotalHaberDol = RstDet("haberdol") + (RstDet("habersol") / RstDet("imptc"))
            TotalDol = (NulosN(Fg3.TextMatrix(Fg3.Rows - 2, 15)) + TotalDebeDol) - TotalHaberDol
            
            Fg3.TextMatrix(Fg3.Rows - 1, 15) = Format(NulosN(TotalDebeDol), "0.00")
            Fg3.TextMatrix(Fg3.Rows - 1, 16) = Format(NulosN(TotalHaberDol), "0.00")
            Fg3.TextMatrix(Fg3.Rows - 1, 17) = Format(NulosN(TotalDol), "0.00")

            TotalDebeSol = RstDet("debesol") + (RstDet("debedol") * RstDet("imptc"))
            TotalHaberSol = RstDet("habersol") + (RstDet("haberdol") * RstDet("imptc"))
            TotalSol = (NulosN(Fg3.TextMatrix(Fg3.Rows - 2, 18)) + TotalDebeSol) - TotalHaberSol
            
            Fg3.TextMatrix(Fg3.Rows - 1, 18) = Format(NulosN(TotalDebeSol), "0.00")
            Fg3.TextMatrix(Fg3.Rows - 1, 19) = Format(NulosN(TotalHaberSol), "0.00")
            Fg3.TextMatrix(Fg3.Rows - 1, 20) = Format(NulosN(TotalSol), "0.00")
