...
Begin VB.Form FrmManProduccion 
   ...
   Begin VB.Frame frm 
      ...
      Begin VB.PictureBox PbCerrar 
         ...
         Index           =   2
         Left            =   4680
         Picture         =   "FrmManProduccion.frx":0000
         ScaleHeight     =   210
         ScaleWidth      =   195
         TabIndex        =   50
         ToolTipText     =   "Cerrar"
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManProduccion.frx":02EC
            Key             =   "IMG1"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManProduccion.frx":0830
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManProduccion.frx":0BC2
            Key             =   "IMG2"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManProduccion.frx":0D46
            Key             =   "IMG3"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManProduccion.frx":119A
            Key             =   "IMG4"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManProduccion.frx":12B2
            Key             =   "IMG5"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManProduccion.frx":17F6
            Key             =   "IMG6"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManProduccion.frx":1D3A
            Key             =   "IMG7"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManProduccion.frx":1E4E
            Key             =   "IMG8"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManProduccion.frx":1F62
            Key             =   "IMG9"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManProduccion.frx":23B6
            Key             =   "IMG10"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManProduccion.frx":2522
            Key             =   "IMG11"
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManProduccion.frx":2A6A
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin SizerOneLibCtl.TabOne TabOne1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin TrueOleDBGrid70.TDBGrid Dg1 
            ...
            Splits(0)._ColumnProps(20)=   "Column(3).Width=4524"
            Splits(0)._ColumnProps(21)=   "Column(3).DividerColor=0"
            Splits(0)._ColumnProps(22)=   "Column(3)._WidthInPix=4445"
            ...
            Splits(0)._ColumnProps(32)=   "Column(5).Width=3493"
            Splits(0)._ColumnProps(33)=   "Column(5).DividerColor=0"
            Splits(0)._ColumnProps(34)=   "Column(5)._WidthInPix=3413"
            Splits(0)._ColumnProps(35)=   "Column(5)._EditAlways=0"
            Splits(0)._ColumnProps(36)=   "Column(5)._ColStyle=516"
            Splits(0)._ColumnProps(37)=   "Column(5).Order=6"
            Splits(0)._ColumnProps(38)=   "Column(6).Width=1164"
            Splits(0)._ColumnProps(39)=   "Column(6).DividerColor=0"
            Splits(0)._ColumnProps(40)=   "Column(6)._WidthInPix=1085"
            ...
            Splits(0)._ColumnProps(50)=   "Column(8).Width=1455"
            Splits(0)._ColumnProps(51)=   "Column(8).DividerColor=0"
            Splits(0)._ColumnProps(52)=   "Column(8)._WidthInPix=1376"
            ...
            Splits(0)._ColumnProps(56)=   "Column(9).Width=2355"
            Splits(0)._ColumnProps(57)=   "Column(9).DividerColor=0"
            Splits(0)._ColumnProps(58)=   "Column(9)._WidthInPix=2275"
            ...
            _StyleDefs(72)  =   "Splits(0).Columns(9).Style:id=58,.parent=13"
            ...
            _StyleDefs(79)  =   ":id=34,.parent=33,.alignment=3,.valignment=2,.bgcolor=&H8000000F&"
            _StyleDefs(80)  =   ":id=34,.fgcolor=&H80000012&,.wraptext=-1"
            _StyleDefs(81)  =   "Named:id=35:Footing"
            _StyleDefs(82)  =   ":id=35,.parent=33,.alignment=3,.valignment=2,.bgcolor=&H8000000F&"
            _StyleDefs(83)  =   ":id=35,.fgcolor=&H80000012&"
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton Cmd 
            ...
            Index           =   0
            Left            =   1830
            Picture         =   "FrmManProduccion.frx":2DFC
            Style           =   1  'Graphical
            TabIndex        =   31
            Top             =   1380
            Width           =   240
         ...
         Begin VB.Frame Frame4 
            ...
            Begin SizerOneLibCtl.TabOne TabOne2 
               ...
               Begin VB.Frame Frame7 
                  ...
                  Begin VSFlex7Ctl.VSFlexGrid fg 
                     ...
                     FormatString    =   $"FrmManProduccion.frx":2F2E
                     ScrollTrack     =   0   'False
                     ScrollBars      =   3
                     ScrollTips      =   0   'False
                     MergeCells      =   0
               ...
               Begin VB.Frame Frame6 
                  ...
                  Begin VSFlex7Ctl.VSFlexGrid fg 
                     ...
                     ColWidthMax     =   0
                     ExtendLastCol   =   0   'False
                     FormatString    =   $"FrmManProduccion.frx":2FFB
                     ScrollTrack     =   0   'False
                     ScrollBars      =   3
                     ScrollTips      =   0   'False
                     MergeCells      =   0
               ...
               Begin VB.Frame Frame8 
                  ...
                  Begin VSFlex7Ctl.VSFlexGrid fg 
                     ...
                     ColWidthMax     =   0
                     ExtendLastCol   =   0   'False
                     FormatString    =   $"FrmManProduccion.frx":30B7
                     ScrollTrack     =   0   'False
                     ScrollBars      =   3
                     ScrollTips      =   0   'False
                     MergeCells      =   0
               ...
               Begin VB.Frame Frame5 
                  ...
                  Begin VSFlex7Ctl.VSFlexGrid fg 
                     ...
                     ColWidthMax     =   0
                     ExtendLastCol   =   0   'False
                     FormatString    =   $"FrmManProduccion.frx":31B9
                     ScrollTrack     =   0   'False
                     ScrollBars      =   3
                     ScrollTips      =   0   'False
                     MergeCells      =   0
            ...
            Begin VSFlex7Ctl.VSFlexGrid fg 
               ...
               ColWidthMax     =   0
               ExtendLastCol   =   0   'False
               FormatString    =   $"FrmManProduccion.frx":32D6
               ScrollTrack     =   0   'False
               ScrollBars      =   3
               ScrollTips      =   0   'False
               MergeCells      =   0
         ...
         Begin VB.CommandButton Cmd 
            ...
            Index           =   3
            Left            =   7770
            Picture         =   "FrmManProduccion.frx":342E
            Style           =   1  'Graphical
            TabIndex        =   24
            Top             =   1080
            Width           =   240
         ...
         Begin VB.CommandButton Cmd 
            ...
            Index           =   2
            Left            =   11490
            Picture         =   "FrmManProduccion.frx":3560
            Style           =   1  'Graphical
            TabIndex        =   18
            Top             =   780
            Width           =   240
         ...
         Begin VB.CommandButton Cmd 
            ...
            Index           =   1
            Left            =   7740
            Picture         =   "FrmManProduccion.frx":3692
            Style           =   1  'Graphical
            TabIndex        =   17
            Top             =   435
            Width           =   240
   ...
   End
End
Attribute VB_Name = "FrmManProduccion"
...
Private Sub pCargarGrid()
    ...
    cSQL = "SELECT pro_ordenprod.id, Format([pro_ordenprod].[fchpro],'dd/mm/yy') AS fchpro, [pro_ordenprod].[numser] & '-' & [pro_ordenprod].[numdoc] AS numdoc, alm_inventario.descripcion AS desitem, pro_receta.codrec, pro_ordenprod.cantidad, Format([pro_ordenprod].[horini],'Short Time') AS horini, Format([pro_ordenprod].[horfin],'Short Time') AS horfin, pro_ordenprod.estado, UCase([mae_estados].[descripcion]) AS desestado, pla_empleados.nombre AS desresp " _
        + vbCr + "FROM (((pro_ordenprod LEFT JOIN pro_receta ON pro_ordenprod.idrec = pro_receta.id) LEFT JOIN alm_inventario ON pro_receta.iditem = alm_inventario.id) LEFT JOIN mae_estados ON pro_ordenprod.estado = mae_estados.id) LEFT JOIN pla_empleados ON pro_ordenprod.idresp = pla_empleados.id " _
