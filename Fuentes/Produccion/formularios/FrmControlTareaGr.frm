...
Begin VB.Form FrmControlTareaGr 
   ...
   Begin VB.Frame FraEditor 
      ...
      Begin VB.PictureBox pic 
         ...
         Height          =   210
         Left            =   4935
         Picture         =   "FrmControlTareaGr.frx":0000
         ScaleHeight     =   210
         ScaleWidth      =   195
         TabIndex        =   6
         ToolTipText     =   "Cerrar"
      ...
      Begin VSFlex7Ctl.VSFlexGrid fg 
         ...
         FormatString    =   $"FrmControlTareaGr.frx":02EC
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin VSFlex7Ctl.VSFlexGrid fg 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   0   'False
      FormatString    =   $"FrmControlTareaGr.frx":03D6
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "FrmControlTareaGr"
...
Public Sub pRecibeLink(hWndFrmPadre As Long, mRowFila, fCalculoCantidad As Boolean, fCalculoHora As Boolean)
    ...
    sCantidad = NulosN(FrmControlTarea.Fg1.TextMatrix(FrmControlTarea.Fg1.Row, 8))
    
    ' unidad de medida
    mIdUniMed = NulosN(FrmControlTarea.Fg1.TextMatrix(FrmControlTarea.Fg1.Row, 15))
    mCodigoPrincipal = mRowFila
    
    ' poner el titulo del formulario
    Me.Caption = FrmControlTarea.Fg1.TextMatrix(FrmControlTarea.Fg1.Row, 3) & "    Cant: " & Format(sCantidad, FORMAT_MONTO) & " " & FrmControlTarea.Fg1.TextMatrix(FrmControlTarea.Fg1.Row, 9)
    If NulosC(Me.Caption) = "" Then Me.Caption = "Grupo"
    
    ' traspasar el recorsed a uno temporal para efectos del calculo
    Set RstGrDetalle = FrmControlTarea.RstGrDet
    Set RstGrDetalleTara = FrmControlTarea.RstGrDetTara
    ...
    If FrmControlTarea.cmd(0).Enabled = False Then
        If FrmControlTarea.FraEditor.Visible = False Then
            QueHace = 3
            habilitar cmd, False
        ...
        If RstGrDetalle.RecordCount > 0 Then
            ...
            Do While Not RstGrDetalle.EOF
                If NulosN(RstGrDetalle("activo")) <> 0 Then
                    If IsDate(FrmControlTarea.Fg1.TextMatrix(FrmControlTarea.Fg1.Row, 6)) = True Then '--hora inicio
                        RstGrDetalle("horini") = CDate(FrmControlTarea.Fg1.TextMatrix(FrmControlTarea.Fg1.Row, 6))
                    Else
                        RstGrDetalle("horini") = Null
                    End If
                    If IsDate(FrmControlTarea.Fg1.TextMatrix(FrmControlTarea.Fg1.Row, 7)) = True Then '--hora final
                        RstGrDetalle("horfin") = CDate(FrmControlTarea.Fg1.TextMatrix(FrmControlTarea.Fg1.Row, 7))
                    Else
    ...
    If FrmControlTarea.Fg1.Row <= 9 Then
        Me.Top = 3700 - FrmControlTarea.Top  '1550
        Me.Left = 5250 '2500 '
    Else
        Me.Top = -100 - FrmControlTarea.Top '-2150
        Me.Left = 5250 '
    End If
...
Private Sub fg_CellChanged(Index As Integer, ByVal Row As Long, ByVal Col As Long)
    ...
    If Index = 0 Then
        ...
        End If
        FrmControlTarea.Fg1.TextMatrix(FrmControlTarea.Fg1.Row, 8) = GRID_SUMAR_COL(fg(0), 5)
    ElseIf Index = 1 Then
        ' aplicando filtro
...
Private Sub iniciarCampos()
    ...
    QueHace = FrmControlTarea.QueHace
...
Private Sub Form_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    ElseIf KeyCode = vbKeyF6 Then
        If BuscarFrm("FrmControlTarea", True, False) = True Then
            If FrmControlTarea.FraEditor.Visible = False Then
                FrmControlTarea.Fg1.SetFocus
                Exit Sub
            Else
                If FrmControlTarea.fg(1).Rows > 1 Then
                    FrmControlTarea.fg(1).Row = 1
                    FrmControlTarea.fg(1).Col = 1
                    FrmControlTarea.fg(1).SetFocus
                Else
                    FrmControlTarea.CmdEditor(0).SetFocus
                End If
                Exit Sub
            End If
        End If
...
Private Sub pRegistroAdd(Index As Integer)
    ...
    If fInsertar = True Then
        ...
        Else
            ...
            Else
                RstGrDetalleTara("idpeso") = NulosN(FrmControlTarea.lbl_cod(2).Caption)
                RstGrDetalleTara("pesouni") = NulosN(FrmControlTarea.lblPesoTara(0).Caption)
                RstGrDetalleTara("abrev") = NulosC(FrmControlTarea.lblPesoTara(1).Caption)
