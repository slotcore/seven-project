...
Begin VB.Form FrmManReceta 
   ...
   Begin SizerOneLibCtl.TabOne TabOne1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin SizerOneLibCtl.TabOne TabOne2 
            ...
            Caption         =   " Insumos - Materia Prima - Producto |      Tareas      "
            Align           =   0
            CurrTab         =   0
            FirstTab        =   0
            Style           =   0
            ...
            Begin VB.Frame Frame6 
               ...
               Begin VSFlex7Ctl.VSFlexGrid Fg3 
                  ...
                  FormatString    =   $"FrmManReceta.frx":0000
                  ScrollTrack     =   0   'False
                  ScrollBars      =   3
                  ScrollTips      =   0   'False
                  MergeCells      =   0
            ...
            Begin VB.Frame Frame5 
               ...
               Begin VSFlex7Ctl.VSFlexGrid Fg1 
                  ...
                  ColWidthMax     =   0
                  ExtendLastCol   =   0   'False
                  FormatString    =   $"FrmManReceta.frx":017B
                  ScrollTrack     =   0   'False
                  ScrollBars      =   3
                  ScrollTips      =   0   'False
                  MergeCells      =   0
         ...
         Begin VSFlex7Ctl.VSFlexGrid Fg2 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   0   'False
            FormatString    =   $"FrmManReceta.frx":03E7
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManReceta.frx":0523
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManReceta.frx":0A67
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManReceta.frx":0BEB
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManReceta.frx":103F
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManReceta.frx":1157
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManReceta.frx":169B
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManReceta.frx":1BDF
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManReceta.frx":1CF3
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManReceta.frx":1E07
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManReceta.frx":225B
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManReceta.frx":23C7
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "FrmManReceta"
...
Private Sub CmdAddReceta_Click()
    ...
    RST_Busq Rst, "SELECT alm_inventario.id, mae_familia.descripcion AS desfam, alm_inventario.tippro " _
        ...
        & " AND ((alm_inventario.tippro)=3))", xCon
    ...
    If Col = 2 Then
        ...
        nSQL = "SELECT alm_inventario.id, alm_inventario.codpro, alm_inventario.descripcion, mae_unidades.abrev, " _
           & " alm_inventario.tippro, mae_tipoproducto.descripcion AS destippro, alm_inventario.idunimed " _
            ...
            & vbCr & " WHERE alm_inventario.activo =-1 and (((alm_inventario.tippro) = " & NulosN(Fg1.TextMatrix(Fg1.Rows - 1, 1)) & " )) " & nSQLNotId _
...
Sub Muestradatos()
    ...
    RST_Busq RstRecetas, "SELECT pro_receta.id, pro_receta.codrec, pro_receta.descripcion, pro_receta.archpro, mae_unidades.abrev, pro_receta.cantidad, pro_receta.prirec, " _
        & " pro_receta.iditem, pro_receta.observaciones FROM pro_receta LEFT JOIN mae_unidades ON pro_receta.idunimed = mae_unidades.id " _
        & " Where (((pro_receta.iditem) = " & NulosN(RstPro("id")) & ")) ORDER BY pro_receta.prirec", xCon
...
Private Sub pConfigurarGrilla()
    ...
    With Fg3 '--de las tareas
        ...
        .TextMatrix(0, 7) = "Arranca":          .ColWidth(7) = 650:       .ColAlignment(7) = flexAlignRightCenter:  .Row = 0: .Col = 7: .CellAlignment = flexAlignRightCenter
        .TextMatrix(0, 8) = "Factor ":          .ColWidth(8) = 900:     .ColAlignment(8) = flexAlignRightCenter:  .Row = 0: .Col = 8: .CellAlignment = flexAlignRightCenter
        .TextMatrix(0, 9) = "Nº Oper.":         .ColWidth(9) = 900:     .ColAlignment(9) = flexAlignRightCenter:  .Row = 0: .Col = 9: .CellAlignment = flexAlignRightCenter
        .TextMatrix(0, 10) = "Costo/Kg":        .ColWidth(10) = 900:    .ColAlignment(10) = flexAlignRightCenter: .Row = 0: .Col = 10: .CellAlignment = flexAlignRightCenter
        .TextMatrix(0, 11) = "Rendto":          .ColWidth(11) = 650:      .ColAlignment(11) = flexAlignRightCenter: .Row = 0: .Col = 11: .CellAlignment = flexAlignRightCenter
    ...
    Dim tFormat$
    RST_Busq RstTmp, "SELECT mae_tipoproducto.id, mae_tipoproducto.descripcion FROM mae_tipoproducto WHERE (((mae_tipoproducto.id) In (1,3,4))) ORDER BY mae_tipoproducto.descripcion; ", xCon
...
Private Sub pDefinirRstTmp(eTipo As e_PROGRAMA, Rst As ADODB.Recordset, Optional IdReceta = -1)
    ...
    ElseIf eTipo = e_TAREA Then
        nSQL = "SELECT pro_recetatar.idrec, pro_recetatar.idtar, pro_recetatar.idunimed, pro_tareas.codigo, pro_tareas.descripcion, mae_unidades.abrev, pro_recetatar.cantidad, pro_recetatar.orden,pro_recetatar.factor,  pro_recetatar.jornalkg, pro_recetatar.costokg, pro_recetatar.costohr, pro_recetatar.numper, pro_recetatar.horarr, pro_recetatar.aplpor " _
            + vbCr + " FROM (pro_recetatar LEFT JOIN pro_tareas ON pro_recetatar.idtar = pro_tareas.id) LEFT JOIN mae_unidades ON pro_recetatar.idunimed = mae_unidades.id " _
