...
Begin VB.Form FrmImpProveedor 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Herramientas - Importar Proveedores"
   ClientHeight    =   7440
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   11985
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton CmdBusFile 
         ...
         Height          =   240
         Left            =   7140
         Picture         =   "FrmImpProveedor.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   315
         Width           =   240
   ...
   Begin VSFlex7Ctl.VSFlexGrid Fg1 
      ...
      FormatString    =   $"FrmImpProveedor.frx":0132
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpProveedor.frx":03D6
            Key             =   "IMG1"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpProveedor.frx":091A
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpProveedor.frx":0CAC
            Key             =   "IMG2"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpProveedor.frx":0E30
            Key             =   "IMG3"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpProveedor.frx":1284
            Key             =   "IMG4"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpProveedor.frx":139C
            Key             =   "IMG5"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpProveedor.frx":18E0
            Key             =   "IMG6"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpProveedor.frx":1E24
            Key             =   "IMG7"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpProveedor.frx":1F38
            Key             =   "IMG8"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpProveedor.frx":204C
            Key             =   "IMG9"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpProveedor.frx":24A0
            Key             =   "IMG10"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpProveedor.frx":260C
            Key             =   "IMG11"
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpProveedor.frx":2B54
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "FrmImpProveedor"
...
''    RST_Busq Rst, "SELECT var_importados.iddoc, var_importados.idtabla From var_importados WHERE (((var_importados.idtabla)=4))", xCon
    ...
    With objExcel.ActiveSheet
        ...
        Do While NulosC(.Cells(A, 1)) <> ""
            ...
            Fg1.Rows = Fg1.Rows + 1
                ...
                Fg1.TextMatrix(Fg1.Rows - 1, 16) = Busca_Codigo(NulosC(.Cells(A, 3)), "numruc", "id", "mae_prov", "C", xCon)    'Trim(.Cells(A, B))
...
Private Sub Fg1_CellButtonClick(ByVal Row As Long, ByVal Col As Long)
    ...
    Select Case Col
        ...
        Case 3 '--tipo doc
            ...
            nSQL = "SELECT mae_dociden.id, mae_dociden.descripcion, mae_dociden.codsun FROM mae_dociden; "
    ...
    Select Case Col
        ...
        Case 3 '--tipo doc
            Fg1.TextMatrix(Fg1.Row, 3) = NulosC(xRs.Fields("descripcion"))
            Fg1.TextMatrix(Fg1.Row, 18) = NulosC(xRs.Fields("id"))
...
Private Sub Fg1_EnterCell()
    If QueHace = 3 Then
        ...
        Exit Sub
    End If
    If Fg1.Col = 1 Or Fg1.Col = 4 Or NulosN(Fg1.TextMatrix(Fg1.Row, 1)) = 0 Or Fg1.Col = Fg1.Cols - 1 Then
        Fg1.Editable = flexEDNone
    Else
...
Sub Eliminar()
    ...
    Rpta = MsgBox("¿Esta seguro de eliminar la Importación de los Proveedores Seleccionados?", vbQuestion + vbYesNo + vbDefaultButton2, xTitulo)
    If Rpta = vbYes Then
        ...
        For A = 1 To Fg1.Rows - 1
            ...
            If NulosN(Fg1.TextMatrix(A, 1)) = -1 Then
                xCon.Execute "DELETE * FROM mae_prov WHERE id = " & NulosN(Fg1.TextMatrix(A, 16)) & ""
                           
                xCon.Execute "DELETE * FROM var_importados WHERE idtabla = 4 and iddoc = " & NulosN(Fg1.TextMatrix(A, 16))
...
Function Grabar() As Boolean
    If Fg1.Rows = 1 Then
        ...
        Exit Function
    End If
    If MsgBox("Seguro desea grabar los proveedores", vbQuestion + vbYesNo + vbDefaultButton2, xTitulo) = vbNo Then Exit Function
    ...
    RST_Busq rst, "SELECT TOP 1 * FROM mae_prov", xCon
    ...
    For A = 1 To Fg1.Rows - 1
        ...
        If NulosN(Fg1.TextMatrix(A, 1)) = -1 Then
            ...
            rst("numruc") = NulosC(Fg1.TextMatrix(A, 4))
            
            rst("nombre") = Left(NulosC(Fg1.TextMatrix(A, 5)), rst("nombre").DefinedSize)
            rst("nompro1") = Left(NulosC(Fg1.TextMatrix(A, 6)), rst("nompro1").DefinedSize)
            rst("nompro2") = Left(NulosC(Fg1.TextMatrix(A, 7)), rst("nompro2").DefinedSize)
            rst("apepro1") = Left(NulosC(Fg1.TextMatrix(A, 8)), rst("apepro1").DefinedSize)
            rst("apepro2") = Left(NulosC(Fg1.TextMatrix(A, 9)), rst("apepro2").DefinedSize)
    ...
    If mTotalGrabados = 0 Then
        MsgBox "Ningún Proveedor a sido importado", vbInformation + vbOKOnly + vbDefaultButton1, xTitulo
    Else
...
LaCague:
    ...
    Set rst = Nothing
    Set RstImp = Nothing
    MsgBox "No se pudo Importar por el siguiente motivo :" + Trim(Err.Description), vbCritical, xTitulo
...
Sub MuestraDatos()
    ...
    nSQL = "SELECT pro.*, reg.registros FROM " _
        + vbCr + " (SELECT mae_prov.*, mae_tipoempresa.descripcion AS desctipper, mae_distritos.descripcion AS descdis, mae_departamentos.descripcion AS descdep, mae_dociden.descripcion AS desctipdoc  FROM mae_dociden RIGHT JOIN ((((var_importados LEFT JOIN mae_prov ON var_importados.iddoc = mae_prov.id) LEFT JOIN mae_tipoempresa ON mae_prov.tipper = mae_tipoempresa.id) LEFT JOIN mae_distritos ON mae_prov.iddis = mae_distritos.id) LEFT JOIN mae_departamentos ON mae_prov.iddep = mae_departamentos.id) ON mae_dociden.id = mae_prov.idtipdoc WHERE (((var_importados.idtabla)=4))) as pro " _
        + vbCr + " Left Join " _
        + vbCr + " (SELECT com_compras.idpro, Count(com_compras.id) AS registros FROM com_compras GROUP BY com_compras.idpro ) as reg " _
        + vbCr + " ON pro.id = reg.idpro"
    ...
    If rst.RecordCount <> 0 Then
        ...
        For A = 1 To rst.RecordCount
            ...
            Fg1.TextMatrix(A, 6) = NulosC(rst("nompro1"))
            Fg1.TextMatrix(A, 7) = NulosC(rst("nompro2"))
            Fg1.TextMatrix(A, 8) = NulosC(rst("apepro1"))
            Fg1.TextMatrix(A, 9) = NulosC(rst("apepro2"))
...
Private Sub pCrearFormato()
    ...
    With objExcel.ActiveSheet
        .Cells(1, 1) = "Importar Proveedores"
