...
Begin VB.Form FrmManControlPers 
   ...
   Caption         =   "Control de Personal - Producción"
   ClientHeight    =   6540
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9405
   ...
   Begin SizerOneLibCtl.TabOne TabOne1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.Label Label4 
            Alignment       =   2  'Center
            Caption         =   "Consulta de Control de Personal - Producción"
            BeginProperty Font 
               Name            =   "Courier New"
               Size            =   11.25
               Charset         =   0
...
Sub Modificar()
    ...
    Label5.Caption = "Modificando Control de Personal - Producción"
    QueHace = 2
    Habilitar_Obj True
    Blanquea
    MuestraSegundoTab
...
Sub Nuevo()
    ...
    ActivaTool
    TabOne1.TabEnabled(0) = False
    Label5.Caption = "Agregando Control de Personal - Producción"
    Habilitar_Obj True
    Blanquea
    txt_cb(0).SetFocus
End Sub
