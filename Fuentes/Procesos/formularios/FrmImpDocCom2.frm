...
Begin VB.Form FrmImpDocCom2 
   Caption         =   "Herramientas - Importar Documentos de Compra"
   ClientHeight    =   7350
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   12030
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpDocCom2.frx":0000
            Key             =   "IMG1"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpDocCom2.frx":0544
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpDocCom2.frx":08D6
            Key             =   "IMG2"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpDocCom2.frx":0A5A
            Key             =   "IMG3"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpDocCom2.frx":0EAE
            Key             =   "IMG4"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpDocCom2.frx":0FC6
            Key             =   "IMG5"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpDocCom2.frx":150A
            Key             =   "IMG6"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpDocCom2.frx":1A4E
            Key             =   "IMG7"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpDocCom2.frx":1B62
            Key             =   "IMG8"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpDocCom2.frx":1C76
            Key             =   "IMG9"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpDocCom2.frx":20CA
            Key             =   "IMG10"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpDocCom2.frx":2236
            Key             =   "IMG11"
         EndProperty
      EndProperty
   End
   ...
   Begin VSFlex7Ctl.VSFlexGrid Fg2 
      ...
      FormatString    =   $"FrmImpDocCom2.frx":277E
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin VSFlex7Ctl.VSFlexGrid Fg1 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   0   'False
      FormatString    =   $"FrmImpDocCom2.frx":284F
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton CmdBusMes 
         Height          =   240
         Left            =   10230
         Picture         =   "FrmImpDocCom2.frx":2A76
         Style           =   1  'Graphical
         TabIndex        =   19
         Top             =   540
         Width           =   240
      ...
      Begin VB.CommandButton CmdBusArch2 
         ...
         Height          =   240
         Left            =   7050
         Picture         =   "FrmImpDocCom2.frx":2BA8
         Style           =   1  'Graphical
         TabIndex        =   18
         Top             =   540
         Width           =   240
      ...
      Begin VB.CommandButton CmdBusArch 
         ...
         Height          =   240
         Left            =   7050
         Picture         =   "FrmImpDocCom2.frx":2CDA
         Style           =   1  'Graphical
         TabIndex        =   16
         Top             =   225
         Width           =   240
      ...
      Begin VB.CommandButton CmdBusImpTot 
         ...
         Height          =   240
         Left            =   8475
         Picture         =   "FrmImpDocCom2.frx":2E0C
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   1230
         Width           =   240
      ...
      Begin VB.CommandButton CmdBusISC 
         ...
         Height          =   240
         Left            =   2595
         Picture         =   "FrmImpDocCom2.frx":2F3E
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   915
         Width           =   240
      ...
      Begin VB.CommandButton CmdBusIGV 
         ...
         Height          =   240
         Left            =   2595
         Picture         =   "FrmImpDocCom2.frx":3070
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   1230
         Width           =   240
      ...
      Begin VB.CommandButton CmdBusBruto 
         ...
         Height          =   240
         Left            =   8460
         Picture         =   "FrmImpDocCom2.frx":31A2
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   915
         Visible         =   0   'False
   ...
   End
End
Attribute VB_Name = "FrmImpDocCom2"
...
'                    MsgBox "La celda de la fila " + Trim(Str(A)) + " en la columna " + Trim(Str(B)) + " no contiene datos en el archivo " & Chr(13) _
...
'    End If
    ...
    Dim RstCtaIna As New ADODB.Recordset
On Error GoTo LaCague
    ...
    For A = 1 To Fg1.Rows - 1
        ...
        RstCab("numdoc") = Mid(Fg1.TextMatrix(A, 4), 6, 10)                                         'ok
        ...
        Dim xTC As Double
        Set RstCta = Nothing
        Set RstCtaIna = Nothing
        
        RST_Busq RstCta, "SELECT con_planctas.cuenta, con_planctas.id, con_planctas.ctadesdeb, con_planctas.ctadeshab" _
            & " From con_planctas WHERE (((con_planctas.cuenta)='" & NulosC(Fg1.TextMatrix(A, 15)) & "'))", xCon
        
        RST_Busq RstCtaIna, "SELECT con_planctas.cuenta, con_planctas.id, con_planctas.ctadesdeb, con_planctas.ctadeshab" _
            & " From con_planctas WHERE (((con_planctas.cuenta)='" & NulosC(Fg1.TextMatrix(A, 16)) & "'))", xCon
        ...
        'If RstCta.RecordCount <> 0 Then
            ...
            If NulosC(Fg1.TextMatrix(A, 15)) <> "" And NulosN(Fg1.TextMatrix(A, 9)) <> 0 Then
            
                'grabamos el importer bruto afecto
                RstDia.AddNew
                RstDia("año") = AnoTra
                RstDia("idmes") = xMes
                RstDia("idlib") = 1
            ...
            If NulosC(Fg1.TextMatrix(A, 16)) <> "" And NulosN(Fg1.TextMatrix(A, 10)) <> 0 Then
            
                'grabamos el importer bruto inafecto
                RstDia.AddNew
                RstDia("año") = AnoTra
                RstDia("idmes") = xMes
                RstDia("idlib") = 1
                RstDia("idmov") = xId
                RstDia("numasi") = xNumAsiento
                RstDia("idcue") = NulosN(Busca_Codigo(Fg1.TextMatrix(A, 16), "cuenta", "id", "con_planctas", "C", xCon))   'Val(LblIdCtaBru.Caption)
                RstDia("fchasi") = CDate("01/" + Format(xMes, "00") + "/" + Trim(Str(Val(AnoTra))))
    
                If xCodMon = 1 Then
                    RstDia("impdebsol") = NulosN(Fg1.TextMatrix(A, 10)):           RstDia("imphabsol") = 0
                    RstDia("impdebdol") = 0:                                       RstDia("imphabdol") = 0
                Else
                    RstDia("impdebsol") = (NulosN(Fg1.TextMatrix(A, 10)) * xTC):   RstDia("imphabsol") = 0
                    RstDia("impdebdol") = NulosN(Fg1.TextMatrix(A, 10)):           RstDia("imphabdol") = 0
                End If
                RstDia.Update
            End If
            ...
            'grabamos el destino DEBE AFECTO
            If RstCta.RecordCount <> 0 Then
                If NulosN(RstCta("ctadesdeb")) <> 0 And NulosN(Fg1.TextMatrix(A, 9)) <> 0 Then
                    RstDia.AddNew
                    RstDia("año") = AnoTra
                    RstDia("idmes") = xMes
                    RstDia("idlib") = 1
            ...
            If NulosC(Fg1.TextMatrix(A, 16)) <> "" Then
                'grabamos el destino DEBE INAFECTO
                If RstCtaIna.RecordCount <> 0 Then
                    If NulosN(RstCtaIna("ctadesdeb")) <> 0 And NulosN(Fg1.TextMatrix(A, 10)) <> 0 Then
                        RstDia.AddNew
                        RstDia("año") = AnoTra
                        RstDia("idmes") = xMes
                        RstDia("idlib") = 1
                        RstDia("idmov") = xId
                        RstDia("numasi") = xNumAsiento
                        RstDia("idcue") = NulosN(RstCtaIna("ctadesdeb"))
                        RstDia("fchasi") = CDate("01/" + Format(xMes, "00") + "/" + Trim(Str(Val(AnoTra))))
            ...
            'grabamos el destino HABER del afecto
            If RstCta.RecordCount <> 0 Then
                If NulosN(RstCta("ctadeshab")) <> 0 And NulosN(Fg1.TextMatrix(A, 9)) <> 0 Then
                    RstDia.AddNew
                    RstDia("año") = AnoTra
                    RstDia("idmes") = xMes
                    RstDia("idlib") = 1
            ...
            If RstCtaIna.RecordCount <> 0 Then
                If NulosC(Fg1.TextMatrix(A, 16)) <> "" And NulosN(Fg1.TextMatrix(A, 10)) <> 0 Then
                    'grabamos el destino HABER del inaafecto
                    RstDia.AddNew
                    RstDia("año") = AnoTra
                    RstDia("idmes") = xMes
                    RstDia("idlib") = 1
                    RstDia("idmov") = xId
                    RstDia("numasi") = xNumAsiento
                    RstDia("idcue") = NulosN(RstCtaIna("ctadeshab"))
                    RstDia("fchasi") = CDate("01/" + Format(xMes, "00") + "/" + Trim(Str(Val(AnoTra))))
    
                    If xCodMon = 1 Then
                        RstDia("impdebsol") = 0:                                       RstDia("imphabsol") = NulosN(Fg1.TextMatrix(A, 10))
                        RstDia("impdebdol") = 0:                                       RstDia("imphabdol") = 0
                    Else
                        RstDia("impdebsol") = 0:                                       RstDia("imphabsol") = (NulosN(Fg1.TextMatrix(A, 10)) * xTC)
                        RstDia("impdebdol") = 0:                                       RstDia("imphabdol") = NulosN(Fg1.TextMatrix(A, 10))
                    End If
                    RstDia.Update
                End If
            End If
