...
Begin VB.Form FrmControlPersTes 
   Caption         =   "Control de Personal - Tesoreria"
   ClientHeight    =   6540
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   8670
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmControlPersTes.frx":0000
            Key             =   "IMG1"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmControlPersTes.frx":0544
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmControlPersTes.frx":08D6
            Key             =   "IMG2"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmControlPersTes.frx":0A5A
            Key             =   "IMG3"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmControlPersTes.frx":0EAE
            Key             =   "IMG4"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmControlPersTes.frx":0FC6
            Key             =   "IMG5"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmControlPersTes.frx":150A
            Key             =   "IMG6"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmControlPersTes.frx":1A4E
            Key             =   "IMG7"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmControlPersTes.frx":1B62
            Key             =   "IMG8"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmControlPersTes.frx":1C76
            Key             =   "IMG9"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmControlPersTes.frx":20CA
            Key             =   "IMG10"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmControlPersTes.frx":2236
            Key             =   "IMG11"
         EndProperty
      EndProperty
   End
   ...
   Begin SizerOneLibCtl.TabOne TabOne1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.Frame Frame3 
            ...
            Begin VB.CommandButton CmdBusEmp 
               Height          =   240
               Left            =   6765
               Picture         =   "FrmControlPersTes.frx":277E
               Style           =   1  'Graphical
               TabIndex        =   1
               Top             =   390
               Width           =   240
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.Label Label4 
            Alignment       =   2  'Center
            Caption         =   "Consulta de Control de Personal - Tesoreria"
            BeginProperty Font 
               Name            =   "Courier New"
               Size            =   11.25
               Charset         =   0
   ...
   End
End
Attribute VB_Name = "FrmControlPersTes"
...
Sub Buscar()
    ...
    xform.SQLCad = "SELECT tes_usuarios.id, pla_empleados.ape & ' ' & pla_empleados.nom as nomemp" _
        & " FROM pla_empleados RIGHT JOIN tes_usuarios ON pla_empleados.id = tes_usuarios.idper"
...
Private Function fVerifSiEmpYaEstaReg(pIdEmp As Long) As Boolean
    ...
    vStrSql = "SELECT tes_usuarios.idper" _
        & " FROM tes_usuarios" _
        & " WHERE tes_usuarios.idper = " & pIdEmp & ""
...
Function Grabar() As Boolean
    ...
    If QueHace = 1 Then 'NUEVO
        If fVerifSiEmpYaEstaReg(Val(LblIdEmp.Caption)) = True Then
            MsgBox "El empleado ya está registrado.", vbInformation, xTitulo
            CmdBusEmp.SetFocus
            Exit Function
        End If
        
        xId = HallaCodigoTabla("tes_usuarios", xCon, "id")
        RST_Busq RstCab, "SELECT * FROM tes_usuarios", xCon
        
        RstCab.AddNew
        RstCab("id") = xId
    Else 'MODIFICAR
        xId = RstFunEmp("id")
        RST_Busq RstCab, "SELECT * FROM tes_usuarios WHERE id = " & xId & "", xCon
    End If
...
Sub Eliminar()
    ...
    If Rpta = vbYes Then
        xCon.Execute "DELETE * FROM tes_usuarios WHERE id = " & Val(RstFunEmp("id")) & ""
        RstFunEmp.Requery
        Dg1.Refresh
        MsgBox "Registro eliminado con éxito", vbInformation + vbOKOnly + vbDefaultButton1, xTitulo
    End If
    TabOne1.CurrTab = 0
End Sub
...
Sub Modificar()
    ...
    Label5.Caption = "Modificando Control de Personal - Tesoreria"
    QueHace = 2
    Bloquea True
    Blanquea
    MuestraSegundoTab
...
Sub Nuevo()
    ...
    ActivaTool
    TabOne1.TabEnabled(0) = False
    Label5.Caption = "Agregando Control de Personal - Tesoreria"
    Bloquea True
    Blanquea
    TxtEmpleado.SetFocus
End Sub
...
Private Sub Form_Activate()
    If SeEjecuto = False Then
        ...
        vStrSql = "SELECT tes_usuarios.id, tes_usuarios.idper, UCase([pla_empleados].[apepat]) & ' ' & UCase([pla_empleados].[apemat]) & ', ' & [pla_empleados].[nom] AS nomemp, " _
            & " tes_usuarios.aut, tes_usuarios.prog FROM pla_empleados RIGHT JOIN tes_usuarios ON pla_empleados.id = tes_usuarios.idper ORDER BY " _
