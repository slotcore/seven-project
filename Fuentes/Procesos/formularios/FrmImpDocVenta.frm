...
Begin VB.Form FrmImpDocVenta 
   Caption         =   "Herramientas - Importar Documentos de Venta"
   ClientHeight    =   7440
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   12030
   ...
   Begin VB.CheckBox Chk_Asiento 
      Caption         =   "Escribir Asiento Contable"
      Enabled         =   0   'False
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpDocVenta.frx":0000
            Key             =   "IMG1"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpDocVenta.frx":0544
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpDocVenta.frx":08D6
            Key             =   "IMG2"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpDocVenta.frx":0A5A
            Key             =   "IMG3"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpDocVenta.frx":0EAE
            Key             =   "IMG4"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpDocVenta.frx":0FC6
            Key             =   "IMG5"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpDocVenta.frx":150A
            Key             =   "IMG6"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpDocVenta.frx":1A4E
            Key             =   "IMG7"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpDocVenta.frx":1B62
            Key             =   "IMG8"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpDocVenta.frx":1C76
            Key             =   "IMG9"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpDocVenta.frx":20CA
            Key             =   "IMG10"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmImpDocVenta.frx":2236
            Key             =   "IMG11"
         EndProperty
      EndProperty
   End
   ...
   Begin VSFlex7Ctl.VSFlexGrid Fg1 
      ...
      FormatString    =   $"FrmImpDocVenta.frx":277E
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin VSFlex7Ctl.VSFlexGrid Fg2 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   0   'False
      FormatString    =   $"FrmImpDocVenta.frx":2A31
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton CmdBusMes 
         Height          =   240
         Left            =   10230
         Picture         =   "FrmImpDocVenta.frx":2B5E
         Style           =   1  'Graphical
         TabIndex        =   34
         Top             =   540
         Width           =   240
      ...
      Begin VB.CommandButton CmdBusArch2 
         ...
         Height          =   240
         Left            =   7050
         Picture         =   "FrmImpDocVenta.frx":2C90
         Style           =   1  'Graphical
         TabIndex        =   31
         Top             =   540
         Width           =   240
      ...
      Begin VB.CommandButton CmdBusImpTot 
         ...
         Height          =   240
         Left            =   8475
         Picture         =   "FrmImpDocVenta.frx":2DC2
         Style           =   1  'Graphical
         TabIndex        =   23
         Top             =   1185
         Width           =   240
      ...
      Begin VB.CommandButton CmdBusISC 
         ...
         Height          =   240
         Left            =   8475
         Picture         =   "FrmImpDocVenta.frx":2EF4
         Style           =   1  'Graphical
         TabIndex        =   22
         Top             =   870
         Width           =   240
      ...
      Begin VB.CommandButton CmdBusIGV 
         ...
         Height          =   240
         Left            =   2595
         Picture         =   "FrmImpDocVenta.frx":3026
         Style           =   1  'Graphical
         TabIndex        =   21
         Top             =   870
         Width           =   240
      ...
      Begin VB.CommandButton CmdBusBruto 
         ...
         Height          =   240
         Left            =   2595
         Picture         =   "FrmImpDocVenta.frx":3158
         Style           =   1  'Graphical
         TabIndex        =   20
         Top             =   1185
         Width           =   240
      End
      Begin VB.TextBox TxtCtaTotME 
         Height          =   300
         Left            =   7185
         Locked          =   -1  'True
         TabIndex        =   6
      ...
      Begin VB.CommandButton CmdBusArch 
         ...
         Height          =   240
         Left            =   7050
         Picture         =   "FrmImpDocVenta.frx":328A
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   225
         Width           =   240
   ...
   End
End
Attribute VB_Name = "FrmImpDocVenta"
...
Sub Bloquea()
    ...
    Chk_Asiento.Enabled = Not Chk_Asiento.Enabled
...
Sub CargaDocumentos()
    ...
    Dim RstTmpItem  As New ADODB.Recordset '--
    
    '-------
    
    Dim RstTmpTDoc As New ADODB.Recordset
    Dim RstTmpCli As New ADODB.Recordset
    Dim RstTmpMon As New ADODB.Recordset
    Dim RstTmpCondVta As New ADODB.Recordset
    Dim RstTmpTVenta As New ADODB.Recordset
    Dim RstTmpTProd As New ADODB.Recordset
    Dim RstTmpTVent As New ADODB.Recordset
    Dim RstTmpUnid As New ADODB.Recordset
    
    Dim nSQL As String
    
    On Error GoTo error:
    
    '--cargamos los rst's temporales
    RST_Busq RstTmpCli, "select * from mae_cliente", xCon
    RST_Busq RstTmpMon, "select * from mae_moneda", xCon
    RST_Busq RstTmpTDoc, "select * from mae_documento", xCon
    RST_Busq RstTmpCondVta, "select * from mae_condpago", xCon
    RST_Busq RstTmpTProd, "select * from mae_tipoproducto", xCon
    
    RST_Busq RstTmpTVenta, "select * from mae_tipoventa", xCon
    
    RST_Busq RstTmpUnid, "select * from mae_unidades", xCon
    
    RST_Busq RstTmpTVent, "select * from mae_tipoventa", xCon
...
''''
''''                If (B = 14) Then Fg1.TextMatrix(A - 1, B) = Busca_Codigo(Val(Fg1.TextMatrix(A - 1, B)), "id", "descripcion", "mae_moneda", "N", xCon)
''''                If (B = 15) Then Fg1.TextMatrix(A - 1, B) = Busca_Codigo(Val(Fg1.TextMatrix(A - 1, B)), "id", "descripcion", "mae_condpago", "N", xCon)
''''                If (B = 16) Then Fg1.TextMatrix(A - 1, B) = Busca_Codigo(Val(Fg1.TextMatrix(A - 1, B)), "id", "descripcion", "mae_tipoventa", "N", xCon)
''''                If (B = 17) Then Fg1.TextMatrix(A - 1, B) = Busca_Codigo(Val(Fg1.TextMatrix(A - 1, B)), "id", "descripcion", "mae_tipoproducto", "N", xCon)
''''
''''
''''            Next B
            ...
            RstTmpCli.Filter = "numruc='" & NulosC(.Cells(A, 1)) & "'"
            If RstTmpCli.RecordCount <> 0 Then
                Fg1.TextMatrix(A - 1, 1) = Trim(.Cells(A, 1))
                Fg1.TextMatrix(A - 1, 17) = RstTmpCli("id")
            End If
            '--tipo documento
            If NulosN(.Cells(A, 3)) <> 0 Then
                RstTmpTDoc.Filter = "id=" & NulosN(.Cells(A, 3))
                If RstTmpTDoc.RecordCount <> 0 Then
                    Fg1.TextMatrix(A - 1, 2) = NulosC(RstTmpTDoc("abrev"))
                    Fg1.TextMatrix(A - 1, 19) = NulosN(.Cells(A, 3))
                End If
            End If
            
                       
            If IsDate(CDate(.Cells(A, 4))) = True Then Fg1.TextMatrix(A - 1, 3) = CDate(.Cells(A, 4)) '--fchdoc
            If IsDate(CDate(.Cells(A, 5))) = True Then Fg1.TextMatrix(A - 1, 4) = CDate(.Cells(A, 5)) '--fchvenc

            Fg1.TextMatrix(A - 1, 5) = NulosC(.Cells(A, 6)) '--numero doc
            
            Fg1.TextMatrix(A - 1, 6) = Format(NulosN(.Cells(A, 7)), FORMAT_MONTO) '--imp bruto
            Fg1.TextMatrix(A - 1, 7) = Format(NulosN(.Cells(A, 8)), FORMAT_MONTO) '--imp bruto2
            Fg1.TextMatrix(A - 1, 8) = Format(NulosN(.Cells(A, 9)), FORMAT_MONTO) '--impbruto3
            Fg1.TextMatrix(A - 1, 9) = Format(NulosN(.Cells(A, 10)), FORMAT_MONTO) '--inafecto
            
            Fg1.TextMatrix(A - 1, 10) = Format(NulosN(.Cells(A, 11)), FORMAT_MONTO) '--igv
            Fg1.TextMatrix(A - 1, 11) = Format(NulosN(.Cells(A, 12)), FORMAT_MONTO) '--isc
            
            Fg1.TextMatrix(A - 1, 12) = Format(NulosN(.Cells(A, 13)), FORMAT_MONTO) '--imp total
            Fg1.TextMatrix(A - 1, 13) = Format(NulosN(.Cells(A, 13)), FORMAT_MONTO) '--saldo
            
            '--moneda 14
            If NulosN(.Cells(A, 14)) <> 0 Then
                RstTmpMon.Filter = "id=" & NulosN(.Cells(A, 14))
                If RstTmpMon.RecordCount <> 0 Then
                    Fg1.TextMatrix(A - 1, 14) = NulosC(RstTmpMon("simbolo"))
                    Fg1.TextMatrix(A - 1, 20) = NulosN(.Cells(A, 14))
                End If
            End If
            '--cond venta 15
            If NulosN(.Cells(A, 15)) <> 0 Then
                RstTmpCondVta.Filter = "id=" & NulosN(.Cells(A, 15))
                If RstTmpCondVta.RecordCount <> 0 Then
                    Fg1.TextMatrix(A - 1, 15) = NulosC(RstTmpCondVta("abrev"))
                    Fg1.TextMatrix(A - 1, 21) = NulosN(.Cells(A, 15))
                End If
            End If
            '--tipo item 16
            If NulosN(.Cells(A, 16)) <> 0 Then
                RstTmpTProd.Filter = "id=" & NulosN(.Cells(A, 16))
                If RstTmpTProd.RecordCount <> 0 Then
                    Fg1.TextMatrix(A - 1, 16) = NulosC(RstTmpTProd("descripcion"))
                    Fg1.TextMatrix(A - 1, 18) = NulosN(.Cells(A, 16))
                End If
            End If
            '--tc
            Fg1.TextMatrix(A - 1, 22) = NulosN(.Cells(A, 17)) '--saldo
            '--glosa
            Fg1.TextMatrix(A - 1, 23) = NulosC(.Cells(A, 18)) '--glosa
    ...
    Set RstTmpTDoc = Nothing
    Set RstTmpCli = Nothing
    Set RstTmpMon = Nothing
    Set RstTmpCondVta = Nothing
    Set RstTmpTVenta = Nothing
    Set RstTmpTProd = Nothing
    ...
    With objExcel.ActiveSheet
        ...
        For A = 2 To xNumFilas
            ...
            For B = 1 To 9
                ...
                If B = 1 Then RstTmp("numruc") = Trim(.Cells(A, B))
                If B = 2 Then RstTmp("tipdoc") = Trim(.Cells(A, B))
                If B = 3 Then RstTmp("numdoc") = Trim(.Cells(A, B))
                If B = 4 Then
                    Set RstTmpItem = Nothing
                    'MsgBox NulosC(.Cells(A, B))
                    Set RstTmpItem = BuscaConCriterio("SELECT * FROM alm_inventario WHERE codpro = '" & NulosC(.Cells(A, B)) & "'", xCon)
                    
                    
                    If RstTmpItem.RecordCount = 0 Then
                        MsgBox "El item " + Trim(.Cells(A, B + 1)) + " no esta registrado como item en el sistema", vbInformation + vbOKOnly + vbDefaultButton1, xTitulo
                        Fg1.Rows = 1
                        Fg2.Rows = 1
                        Frame2.Visible = False
                        Set RstTmp = Nothing
                        Exit Sub
                    ElseIf NulosN(RstTmpItem("idcuentaven")) = 0 Then
                        MsgBox "El item " + Trim(.Cells(A, B + 1)) + " no tiene cuenta contable de ventas" & vbCr & "Agrege la cuenta contable de venta", vbInformation + vbOKOnly + vbDefaultButton1, xTitulo
                        Fg1.Rows = 1
                        Fg2.Rows = 1
                        Frame2.Visible = False
                        Set RstTmp = Nothing
                    ...
                    RstTmp("ctavta") = RstTmpItem("idcuentaven")
                    RstTmp("iditem") = RstTmpItem("id")
                    
                End If
                If B = 5 Then RstTmp("descri") = Trim(.Cells(A, B))
                If B = 6 Then
                    If NulosN(.Cells(A, B)) <> 0 Then
                        RstTmpUnid.Filter = "id=" & NulosN(.Cells(A, B))
                        If RstTmpUnid.RecordCount <> 0 Then
                             Fg2.TextMatrix(A - 1, B) = NulosC(RstTmpUnid("abrev"))
                             RstTmp("idunimed") = NulosN(.Cells(A, B))
                        End If
                    End If
                End If
                ...
                If B = 7 Then
                    If NulosN(.Cells(A, B)) <> 0 Then
                        RstTmpTVent.Filter = "id=" & NulosN(.Cells(A, B))
                        If RstTmpTVent.RecordCount <> 0 Then
                             Fg2.TextMatrix(A - 1, B) = NulosC(RstTmpTVent("abrev"))
                             RstTmp("IdTipVen") = NulosN(.Cells(A, B))
                        End If
                    End If
                End If
                
                If B = 8 Then RstTmp("cantid") = NulosN(.Cells(A, B))
                
                If B = 9 Then RstTmp("precio") = Format(NulosN(.Cells(A, B)), FORMAT_MONTO)
...
'            TxtCtaTotMN.Text = Trim(Rst("cuenta"))
...
'    If Rst.State = 1 Then
'        If Rst.RecordCount <> 0 Then
'            TxtCtaTotME.Text = Trim(Rst("cuenta"))
...
'    Set xfrm = Nothing
    ...
    If xRs.State = 1 Then
        TxtCtaTotME.Text = Trim(xRs("cuenta"))
...
Sub MostrarDocumentos()
    ...
    Else
        ...
        For A = 1 To rst.RecordCount
            ...
            Fg1.TextMatrix(A, 12) = rst("descconpag")
            Fg1.TextMatrix(A, 13) = NulosN(rst("tipven"))
            Fg1.TextMatrix(A, 14) = rst("tippro")
            rst.MoveNext
...
'    Fg1.ColFormat(5) = FORMAT_MONTO
'    Fg1.ColFormat(6) = FORMAT_MONTO
'    Fg1.ColFormat(7) = FORMAT_MONTO
...
'    Fg2.ColFormat(8) = "0.0000"
'    Fg2.ColFormat(9) = FORMAT_MONTO
    
    'Fg2.ColWidth(1) = 0
    Fg2.ColWidth(2) = 0
    
    OCULTAR_COL Fg1, 17, 21

    
'    Fg2.ColFormat(7) = "0.0000"
...
Sub BorrarDatos(MesBorrar As Integer)
    ...
    If rst.RecordCount <> 0 Then
        ...
        For A = 1 To rst.RecordCount
            ...
            xCon.Execute "DELETE * FROM vta_ventasdet WHERE idvta = " & rst("iddoc") & ""
...
Function Grabar() As Boolean
    ...
    If NulosN(LblIdMes.Caption) = 0 Then
        MsgBox "Falta Seleccionar el Periodo", vbExclamation, xTitulo
'        TxtMes.SetFocus
        Exit Function
    End If
    
    If Chk_Asiento.Value = 0 Then
        If MsgBox("Los registros se importarán sin Asiento Contable" & vbCr & "Desea Continuar?", vbYesNo + vbQuestion) = vbNo Then
            Exit Function
        End If
    Else
        ...
        If TxtCtaTotMN.Text = "" Then
            MsgBox "No ha especificado la cuenta contable para el total del documento en MN", vbInformation + vbOKOnly + vbDefaultButton1, xTitulo
            TxtCtaTotMN.SetFocus
            Exit Function
        End If
        
        If TxtCtaTotME.Text = "" Then
            MsgBox "No ha especificado la cuenta contable para el total del documento en ME", vbInformation + vbOKOnly + vbDefaultButton1, xTitulo
            TxtCtaTotME.SetFocus
            Exit Function
        End If
    End If
    ...
    Dim sTC As Double '--tipo de cambio
    Dim nSQL As String
    
    Dim xNumRegistro As String
    ...
    mMesActivo = NulosN(LblIdMes.Caption)
...
'''''        RstCab("idtipo") = Busca_Codigo(NulosC(Fg1.TextMatrix(A, 17)), "descripcion", "id", "mae_tipoproducto", "C", xCon)
        RstCab("idtipo") = NulosN(Fg1.TextMatrix(A, 18))
...
'''''        RstCab("tipdoc") = xTipDoc
        ...
        RstCab("tipdoc") = NulosN(Fg1.TextMatrix(A, 19))
        
        RstCab("numser") = NulosC(Mid(Fg1.TextMatrix(A, 5), 1, 4))
        RstCab("numdoc") = NulosC(Mid(Fg1.TextMatrix(A, 5), 6, 10))
'''''        RstCab("numser") = Format(Mid(Fg1.TextMatrix(A, 5), 1, 4), "0000")
'''''        RstCab("numdoc") = Format(Mid(Fg1.TextMatrix(A, 5), 6), "0000000000")
...
'''''        RstCab("idmon") = xCodMon
        ...
        Else
            If NulosN(Fg1.TextMatrix(A, 10)) <> 0 Then
                RstCab("tasaigv") = Round((RstCab("impigv") / RstCab("impbru") + RstCab("impbru2") + RstCab("impbru3")), 2) * 100
            Else
                RstCab("tasaigv") = 0
            End If
        End If
        
        RstCab("impsal") = NulosN(Fg1.TextMatrix(A, 12))
...
'''''        RstCab("idtipven") = Busca_Codigo(NulosC(Fg1.TextMatrix(A, 16)), "descripcion", "id", "mae_tipoventa", "C", xCon)
        ...
        'agregado 080409
        RstCab("tc") = NulosN(Fg1.TextMatrix(A, 22))
        
        RstCab("glosa") = NulosC(Fg1.TextMatrix(A, 23))
        
        RstCab("idalm") = 1
        '**************************************************
        
        xTotalxxx = 0
        xTotalxxx = NulosN((Fg1.TextMatrix(A, 6))) + NulosN(Fg1.TextMatrix(A, 7)) + NulosN(Fg1.TextMatrix(A, 8)) + NulosN(Fg1.TextMatrix(A, 9))
        ...
        xTipDoc = NulosN(Fg1.TextMatrix(A, 19))
        xCodMon = NulosN(Fg1.TextMatrix(A, 20))
        ...
        If xTotalxxx <> 0 Then
            ...
            RstTmp.Filter = "numdoc = '" & Fg1.TextMatrix(A, 5) & "' and numruc ='" & NulosC(Fg1.TextMatrix(A, 1)) & "' and tipdoc=" & NulosN(Fg1.TextMatrix(A, 19))
...
'''''                    Rstdet("iditem") = xIdItem
                    Rstdet("iditem") = NulosN(RstTmp("IdItem"))
'''''                    Rstdet("idunimed") = Busca_Codigo(NulosN(RstTmp("unimed")), "id", "descripcion", "mae_unidades", "N", xCon)
                    Rstdet("idunimed") = NulosN(RstTmp("IdUniMed")) 'Busca_Codigo(NulosN(RstTmp("unimed")), "id", "descripcion", "mae_unidades", "N", xCon)
                    ...
                    Rstdet("preunibru") = NulosN(RstTmp("precio")) * NulosN(RstTmp("cantid"))
        ...
        If Chk_Asiento.Value = 1 Then
        
            xNumRegistro = GenerarAsiento(xCon, 2, xId, AnoTra, mMesActivo, 0, 0)
        
            If xNumRegistro = "" Then GoTo LaCague
            Label4.Caption = "Importando registros " & xNumRegistro
        Else
            Label4.Caption = "Importando registros " & A & " de " & Fg1.Rows - 1
...
'''''''''            xCon.Execute "UPDATE vta_ventas SET vta_ventas.numreg = '" & Format(mMesActivo, "00") + xNumAsiento & "' WHERE (((vta_ventas.id)=" & xId & "))"
'''''''''
'''''''''            'grabamos el diario
...
'''''''''
'''''''''            If NulosN(Fg1.TextMatrix(A, 24)) <> 0 Then
'''''''''                sTC = NulosN(Fg1.TextMatrix(A, 24))
'''''''''            Else
'''''''''                Set RstTC = Nothing
'''''''''                Set RstTC = BuscaConCriterio("SELECT * FROM con_tc WHERE fecha = cdate('" & Fg1.TextMatrix(A, 3) & "')", xCon)
'''''''''                sTC = NulosN(RstTC("impven"))
'''''''''            End If
'''''''''            Set RstTC = Nothing
'''''''''
'''''''''            RstTmp.Filter = adFilterNone
'''''''''            RstTmp.Filter = "numdoc = '" & Fg1.TextMatrix(A, 5) & "' and numruc ='" & NulosC(Fg1.TextMatrix(A, 1)) & "' and tipdoc=" & NulosN(Fg1.TextMatrix(A, 20))
'''''''''            If RstTmp.RecordCount <> 0 Then
'''''''''                H = 0
'''''''''                RstTmp.MoveFirst
...
''''''''''''''                    RstDia("idcue") = Busca_Codigo(NulosC(RstTmp("codite")), "cuenta", "id", "con_planctas", "C", xCon)
'''''''''                    RstDia("idcue") = NulosN(RstTmp("ctavta"))
'''''''''
'''''''''                    RstDia("iddoc") = NulosN(xTipDoc)
'''''''''                    RstDia("fchasi") = CDate("01/" + Format(LblIdMes.Caption, "00") & "/" & AnoTra)
...
'''''''''                            If sTC <> 0 Then
'''''''''                                RstDia("tc") = sTC
'''''''''                                RstDia("imphabsol") = NulosN(RstTmp("precio")) * sTC
...
'''''''''                            If sTC <> 0 Then
'''''''''                                RstDia("tc") = sTC
'''''''''                                'RstDia("imphabsol") = NulosN(Fg1.TextMatrix(A, 6)) * sTC
'''''''''                                RstDia("impdebsol") = NulosN(RstTmp("precio")) * sTC
...
''''''''''
''''''''''                If xCodMon = 1 Then
''''''''''                    RstDia("imphabsol") = NulosN(Fg1.TextMatrix(A, 6))
''''''''''                    RstDia("imphabdol") = 0
''''''''''                Else
''''''''''                    If sTC <> 0 Then
''''''''''                        RstDia("tc") = sTC
''''''''''                        RstDia("imphabsol") = NulosN(Fg1.TextMatrix(A, 6)) * sTC
''''''''''                        RstDia("imphabdol") = NulosN(Fg1.TextMatrix(A, 6))
''''''''''                    Else
''''''''''                        RstDia("tc") = 0
''''''''''                        RstDia("imphabdol") = NulosN(Fg1.TextMatrix(A, 6))
''''''''''                    End If
...
'''''''''                        If sTC <> 0 Then
'''''''''                            RstDia("tc") = sTC
'''''''''                            RstDia("imphabsol") = NulosN(Fg1.TextMatrix(A, 10)) * sTC
...
'''''''''                        If sTC <> 0 Then
'''''''''                            RstDia("tc") = sTC
'''''''''                            RstDia("impdebsol") = NulosN(Fg1.TextMatrix(A, 10)) * sTC
...
'''''''''                RstDia("idmov") = xId
'''''''''                RstDia("numasi") = xNumAsiento
'''''''''                RstDia("idcue") = NulosN(LblIdCtaISC.Caption)
'''''''''                RstDia("iddoc") = NulosN(xTipDoc)
'''''''''                RstDia("fchasi") = CDate("01/" + Format(LblIdMes.Caption, "00") & "/" & AnoTra)
'''''''''                RstDia("fchdoc") = CDate(Fg1.TextMatrix(A, 3))
'''''''''
...
'''''''''                        If sTC <> 0 Then
'''''''''                            RstDia("tc") = sTC
'''''''''                            RstDia("imphabsol") = NulosN(Fg1.TextMatrix(A, 11)) * sTC
...
'''''''''                        If sTC <> 0 Then
'''''''''                            RstDia("tc") = sTC
'''''''''                            RstDia("impdebsol") = NulosN(Fg1.TextMatrix(A, 11)) * sTC
...
'''''''''
'''''''''                If xCodMon = 1 Then
'''''''''                    RstDia("idcue") = NulosN(LblIdCtaBru.Caption)
'''''''''                Else
...
'''''''''                        If sTC <> 0 Then
'''''''''                            RstDia("tc") = sTC
'''''''''                            RstDia("impdebsol") = NulosN(Fg1.TextMatrix(A, 12)) * sTC
...
'''''''''                        If sTC <> 0 Then
'''''''''                            RstDia("tc") = sTC
'''''''''                            RstDia("imphabsol") = NulosN(Fg1.TextMatrix(A, 12)) * sTC
...
'''''''''
    ...
    Frame2.Visible = False
    If Chk_Asiento.Value = 0 Then
        MsgBox "Los datos se importaron con éxito" & vbCr & "Proceda a generar los asientos contables de los registros importados", vbInformation + vbOKOnly + vbDefaultButton1, xTitulo
    Else
        MsgBox "Los datos se importaron con éxito", vbInformation + vbOKOnly + vbDefaultButton1, xTitulo
    End If
    Grabar = True
...
Sub PreparaRstTmp()
    ...
    xCampos(6, 0) = "ctavta":        xCampos(6, 1) = "N":      xCampos(6, 2) = "8"
    xCampos(7, 0) = "IdItem":        xCampos(7, 1) = "N":      xCampos(7, 2) = "8"
    xCampos(8, 0) = "IdUniMed":      xCampos(8, 1) = "N":      xCampos(8, 2) = "8"
    
    xCampos(9, 0) = "numruc":        xCampos(9, 1) = "C":      xCampos(9, 2) = "11"
    xCampos(10, 0) = "tipdoc":       xCampos(10, 1) = "N":     xCampos(10, 2) = "2"
    
    xCampos(11, 0) = "IdTipVen":      xCampos(11, 1) = "N":      xCampos(11, 2) = "8"
...
''''            Next B
            ...
            If RstTmpCli.RecordCount <> 0 Then
                Fg1.TextMatrix(A - 1, 1) = Trim(.Cells(A, 1))
                Fg1.TextMatrix(A - 1, 18) = RstTmpCli("id")
            End If
            '--tipo documento
            If NulosN(.Cells(A, 2)) <> 0 Then
                RstTmpTDoc.Filter = "id=" & NulosN(.Cells(A, 2))
                If RstTmpTDoc.RecordCount <> 0 Then
                    Fg1.TextMatrix(A - 1, 2) = NulosC(RstTmpTDoc("abrev"))
                    Fg1.TextMatrix(A - 1, 20) = NulosN(.Cells(A, 2))
                End If
            End If
            
                       
            If IsDate(CDate(.Cells(A, 3))) = True Then Fg1.TextMatrix(A - 1, 3) = CDate(.Cells(A, 3)) '--fchdoc
            If IsDate(CDate(.Cells(A, 4))) = True Then Fg1.TextMatrix(A - 1, 4) = CDate(.Cells(A, 4)) '--fchvenc

            Fg1.TextMatrix(A - 1, 5) = NulosC(.Cells(A, 5)) '--numero doc
            
            Fg1.TextMatrix(A - 1, 6) = NulosN(.Cells(A, 6)) '--imp bruto
            Fg1.TextMatrix(A - 1, 7) = NulosN(.Cells(A, 7)) '--imp bruto2
            Fg1.TextMatrix(A - 1, 8) = NulosN(.Cells(A, 8)) '--impbruto3
            Fg1.TextMatrix(A - 1, 9) = NulosN(.Cells(A, 9)) '--inafecto
            Fg1.TextMatrix(A - 1, 10) = NulosN(.Cells(A, 10)) '--igv
            Fg1.TextMatrix(A - 1, 11) = NulosN(.Cells(A, 11)) '--isc
            Fg1.TextMatrix(A - 1, 12) = NulosN(.Cells(A, 12)) '--imp total
            Fg1.TextMatrix(A - 1, 13) = NulosN(.Cells(A, 13)) '--saldo
            ...
            If NulosN(.Cells(A, 14)) <> 0 Then
                ...
                If RstTmpMon.RecordCount <> 0 Then
                    Fg1.TextMatrix(A - 1, 14) = NulosC(RstTmpMon("simbolo"))
                    Fg1.TextMatrix(A - 1, 22) = NulosN(.Cells(A, 14))
                End If
            End If
            '--cond venta 15
            If NulosN(.Cells(A, 15)) <> 0 Then
                RstTmpCondVta.Filter = "id=" & NulosN(.Cells(A, 15))
                If RstTmpCondVta.RecordCount <> 0 Then
                    Fg1.TextMatrix(A - 1, 15) = NulosC(RstTmpCondVta("descripcion"))
                    Fg1.TextMatrix(A - 1, 23) = NulosN(.Cells(A, 15))
                End If
            End If
            '--tipo venta 16
            If NulosN(.Cells(A, 16)) <> 0 Then
                RstTmpTVenta.Filter = "id=" & NulosN(.Cells(A, 16))
                If RstTmpTVenta.RecordCount <> 0 Then
                    Fg1.TextMatrix(A - 1, 16) = NulosC(RstTmpTVenta("descripcion"))
                    Fg1.TextMatrix(A - 1, 21) = NulosN(.Cells(A, 16))
                End If
            End If
            '--tipo item 17
            If NulosN(.Cells(A, 17)) <> 0 Then
                RstTmpTProd.Filter = "id=" & NulosN(.Cells(A, 17))
                If RstTmpTProd.RecordCount <> 0 Then
                    Fg1.TextMatrix(A - 1, 17) = NulosC(RstTmpTProd("descripcion"))
                    Fg1.TextMatrix(A - 1, 19) = NulosN(.Cells(A, 17))
                End If
            End If
            
            '--tipo cambio
            
            Fg1.TextMatrix(A - 1, 24) = NulosN(.Cells(A, 18))
        ...
        For A = 2 To xNumFilas
            ...
            For B = 1 To 8
                ...
                If B = 6 Then
                    ...
                    End If
                End If
                If B = 7 Then RstTmp("cantid") = NulosN(.Cells(A, B))
                If B = 8 Then RstTmp("precio") = NulosN(.Cells(A, B))
...
Private Sub TxtCtaIGV_KeyDown(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyF5 Then CmdBusIGV_Click
End Sub

Private Sub TxtCtaISC_KeyDown(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyF5 Then CmdBusISC_Click
End Sub

Private Sub TxtCtaTotME_KeyDown(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyF5 Then CmdBusImpTot_Click
End Sub

Private Sub TxtCtaTotMN_KeyDown(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyF5 Then CmdBusBruto_Click
End Sub
