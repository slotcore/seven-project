...
Sub VerEstaEntrega()
    ...
    'Propósito: Muestra datos del pedido en formulario
    '
    'Entradas:  Ninguna
    '
    'Resultados: Pedido en pantalla
    '
    'Nota:       1.- Identificar la celda que tiene pedido.
    '            2.- Hacer doble clic para ver el detalle.
    
    'Modificado: 05/01/11 Por: Johan Castro
    '           Saltar el error cuando la celta del cronograma este vacio
    '
    '===================================================================================================
    ...
    Set HitTest = FrmCalendario.CalendarControl.ActiveView.HitTest
...
Sub Blanquea()
    '===================================================================================================
    'Creado : 05/01/11 Por: Johan Castro
    'Propósito: Limpiar los controles del formulario.
    '
    'Entradas:  Ninguna
    '
    'Resultados: Controles limpios listos para que se escriban datos
    '
    '===================================================================================================
