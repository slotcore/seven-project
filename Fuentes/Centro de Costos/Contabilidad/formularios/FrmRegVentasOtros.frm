...
Begin VB.Form FrmRegVentasOtros 
      ...
      Begin VB.Frame Frame7 
         ...
         Begin VB.Frame Frame13 
            ...
            Begin VB.CommandButton CmdBusMon 
               Height          =   230
               Left            =   495
               Picture         =   "FrmRegVentasOtros.frx":0000
               Style           =   1  'Graphical
               TabIndex        =   8
               Top             =   270
               Width           =   210
      ...
      Begin VB.Frame Frame9 
         ...
         Begin VB.Frame Frame12 
            ...
            Begin VB.CommandButton CmdBusTipDoc 
               Height          =   240
               Left            =   735
               Picture         =   "FrmRegVentasOtros.frx":0132
               Style           =   1  'Graphical
               TabIndex        =   37
               Top             =   270
               Width           =   240
         ...
         Begin VB.Frame Frame5 
            ...
            Begin VB.CommandButton CmdBusCliPro 
               ...
               Height          =   240
               Left            =   8640
               Picture         =   "FrmRegVentasOtros.frx":0264
               Style           =   1  'Graphical
               TabIndex        =   32
               Top             =   210
               Width           =   210
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmRegVentasOtros.frx":0396
            Key             =   "IMG1"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmRegVentasOtros.frx":08DA
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmRegVentasOtros.frx":0C6C
            Key             =   "IMG2"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmRegVentasOtros.frx":0DF0
            Key             =   "IMG3"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmRegVentasOtros.frx":1244
            Key             =   "IMG4"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmRegVentasOtros.frx":135C
            Key             =   "IMG5"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmRegVentasOtros.frx":18A0
            Key             =   "IMG6"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmRegVentasOtros.frx":1DE4
            Key             =   "IMG7"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmRegVentasOtros.frx":1EF8
            Key             =   "IMG8"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmRegVentasOtros.frx":200C
            Key             =   "IMG9"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmRegVentasOtros.frx":2460
            Key             =   "IMG10"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmRegVentasOtros.frx":25CC
            Key             =   "IMG11"
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmRegVentasOtros.frx":2B14
            Key             =   ""
         EndProperty
         BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmRegVentasOtros.frx":2E2E
            Key             =   ""
         EndProperty
         BeginProperty ListImage15 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmRegVentasOtros.frx":31C0
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin SizerOneLibCtl.TabOne TabOne1 
      ...
      Begin VB.Frame Frame10 
         ...
         Begin VSFlex7Ctl.VSFlexGrid Fg1 
            ...
            FormatString    =   $"FrmRegVentasOtros.frx":3552
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
      ...
      Begin VB.Frame Frame8 
         ...
         Begin VSFlex7Ctl.VSFlexGrid Fg2 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   0   'False
            FormatString    =   $"FrmRegVentasOtros.frx":378A
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "FrmRegVentasOtros"
...
Sub pImprimir()
    ...
    'RST_Busq Rst, "SELECT con_formatostipodet.* From con_formatostipodet Where (((con_formatostipodet.idformato) = 3) And ((con_formatostipodet.idformatotipo) = 1) " _
...
Private Sub Form_Load()
    ...
    xFormatoActual = xRs("id")
    SetearCuadricula Fg1, 3, xCon, 1, xFormatoActual
...
Sub Configurar()
    ...
    If xform.CambioOpcionLiro(3, xCon, 1) = True Then
        ' CONFIGURAMOS LAS COLUMNAS DEL CONTROL Fg1
        SetearCuadricula Fg1, 3, xCon, 1
...
Sub MostrarVentasResumen()
    ...
    If TxtIdMon.Text = 1 Then
        ...
        SqlCad = "SELECT CONSULTA1.tdocnombre, CONSULTA1.abrev, CONSULTA1.tipdoc, Sum(CONSULTA1.impbru2_c) AS impbru2_c1, Sum(CONSULTA1.impbru_c) AS impbru_c1, Sum(CONSULTA1.impbru3_c) AS impbru3_c1, Sum(CONSULTA1.impinaf_c) AS impinaf_c1, Sum(CONSULTA1.impisc_c) AS impisc_c1, Sum(CONSULTA1.impigv_c) AS impigv_c1, Sum(CONSULTA1.otrostrib) AS otrostrib1, Sum(CONSULTA1.imptotdoc_c) AS imptotdoc_c1 " _
            ...
            & " ON vta_ventas.tipdoc = mae_documento.id) LEFT JOIN con_tc ON vta_ventas.fchdoc = con_tc.fecha) LEFT JOIN mae_libros ON vta_ventas.idlib = mae_libros.id) " _
            & " LEFT JOIN mae_moneda ON vta_ventas.idmon = mae_moneda.id) ON mae_cliente.id = vta_ventas.idcli " _
            & vbCr & " WHERE (((vta_ventas.fchreg)>=CDate('" & TxtFchIni.Valor & "') And (vta_ventas.fchreg)<=CDate('" & TxtFchFin.Valor & "')) AND ((Mid([numreg],1,2))<>0)) " & nSQLTipDoc & nSQLCli & " ) " _
            & vbCr & " AS CONSULTA1 " _
    ...
    ElseIf TxtIdMon = 2 Then
        ...
        SqlCad = "SELECT CONSULTA1.tdocnombre, CONSULTA1.abrev, CONSULTA1.tipdoc, Sum(CONSULTA1.impbru2_c) AS impbru2_c1, Sum(CONSULTA1.impbru_c) AS impbru_c1, Sum(CONSULTA1.impbru3_c) AS impbru3_c1, Sum(CONSULTA1.impinaf_c) AS impinaf_c1, Sum(CONSULTA1.impisc_c) AS impisc_c1, Sum(CONSULTA1.impigv_c) AS impigv_c1, Sum(CONSULTA1.otrostrib) AS otrostrib1, Sum(CONSULTA1.imptotdoc_c) AS imptotdoc_c1 " _
            ...
            & " ON vta_ventas.tipdoc = mae_documento.id) LEFT JOIN con_tc ON vta_ventas.fchdoc = con_tc.fecha) LEFT JOIN mae_libros ON vta_ventas.idlib = mae_libros.id) " _
            & " LEFT JOIN mae_moneda ON vta_ventas.idmon = mae_moneda.id) ON mae_cliente.id = vta_ventas.idcli  " _
            & vbCr & " WHERE (((vta_ventas.fchreg)>=CDate('" & TxtFchIni.Valor & "') And (vta_ventas.fchreg)<=CDate('" & TxtFchFin.Valor & "')) AND ((Mid([numreg],1,2))<>'00')) " & nSQLTipDoc & " ) AS CONSULTA1 " _
            & vbCr & " GROUP BY CONSULTA1.tdocnombre, CONSULTA1.abrev, CONSULTA1.tipdoc " _
            & vbCr & " ORDER BY CONSULTA1.tipdoc; "
