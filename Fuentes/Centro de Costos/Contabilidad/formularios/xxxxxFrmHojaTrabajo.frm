...
Private Sub pExportar(Indice As Integer)
    ...
    xFun.VSFlexGrid_Exportar_MSExcel xCon, Fg1(Indice), "BALANCE DE COMPROBACION", "DEL " + TxtFchIni.Valor + " AL " + TxtFchFin.Valor, "Expresado en : Nuevos Soles", "Balance de Comprobación"
    Set xFun = Nothing
