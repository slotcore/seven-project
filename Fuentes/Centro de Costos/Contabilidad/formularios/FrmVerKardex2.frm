...
Begin VB.Form FrmVerKardex2 
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmVerKardex2.frx":07A8
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmVerKardex2.frx":0B3A
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmVerKardex2.frx":0C94
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmVerKardex2.frx":1026
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmVerKardex2.frx":11AA
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmVerKardex2.frx":15FE
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmVerKardex2.frx":1716
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmVerKardex2.frx":1C5A
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmVerKardex2.frx":219E
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmVerKardex2.frx":22B2
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmVerKardex2.frx":23C6
            Key             =   ""
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmVerKardex2.frx":281A
            Key             =   ""
         EndProperty
         BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmVerKardex2.frx":2986
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin VSFlex7Ctl.VSFlexGrid Fg1 
      ...
      FormatString    =   $"FrmVerKardex2.frx":2ECE
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
...
Sub pCargarDetallado(IdItem As Double)
    ...
    '--Generar la consulta SQL para obtener el detalle de movimientos del kardex
    xCadSQL = KardexMovimientoSQL(IdItem, TxtFchIni.Valor, TxtFchFin.Valor)
    ...
    '***
    xPrecioIni = Format(xPrecioIni, FORMAT_MONTO)
    '***
    '--------------------------------------
        ...
        For A = 1 To Rst.RecordCount
            ...
            If Rst("tipo") = "C" Or Rst("tipo") = "AI" Or Rst("tipo") = "P" Then
                ...
                If Rst("tipo") = "P" Then
                    ...
                    cSQL = "SELECT con_librocostodet.impmprima, con_librocostodet.impmanobr, con_librocostodet.impgasfab, con_librocostodet.cantidad " _
                        ...
                        + vbCr + "WHERE (((con_librocostodet.idprod)=" & NulosN(Rst("id")) & ") AND ((con_librocostodet.iditem)=" & IdItem & "));"
                ...
                If Rst("descdoc") = "NC" Then
                    ...
                    'xSaldoImp = xSaldoImp - (NulosN(Rst("canpro")) * (xPrecioUni))
                    xSaldoImp = xSaldoImp - Format(NulosN(Rst("canpro")) * (xPrecioUni), FORMAT_IMPORTEKARDEX)
                Else
                ...
                UltPreCosto = xPrecioUni
                'UltPreCosto = Format(xPrecioUni, FORMAT_IMPORTEKARDEX)
            ...
            Else
                ...
                ' ----------------------PRECIO UNITARIO
                 ...
                 Fg1.TextMatrix(xFila, COLUMNAPRECIOUNI_) = Format(xPrecioUni, FORMAT_IMPORTEKARDEX)
                   'Fg1.TextMatrix(xFila, COLUMNAPRECIOUNI_) = Format(xPrecioUni, FORMAT_MONTO)
