   ...
   Begin SizerOneLibCtl.TabOne TabOne1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VSFlex7Ctl.VSFlexGrid Fg1 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   0   'False
            FormatString    =   $"FrmVentas.frx":4F9C
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
...
Sub MuestraSegundoTab()
    ...
    If NulosN(RstVent("iddocref")) <> 0 Then
        'LA NOTA DE CREDITO HACE REFERENCIA A UNA FACTURA
        TxtDocRefCredi.Visible = True
        Label33.Visible = True
        CmdBusDocRef.Visible = True
        
        LblIdDocRef.Caption = RstVent("iddocref")
        TxtDocRefCredi.Text = Busca_Codigo(RstVent("iddocref"), "id", "numser", "vta_ventas", "N", xCon) + "-" + Busca_Codigo(RstVent("iddocref"), "id", "numdoc", "vta_ventas", "N", xCon)
    Else
...
Private Sub Dg1_KeyUp(KeyCode As Integer, Shift As Integer)
    If KeyCode = 123 Then
        VerMovimientos "SELECT var_edicion.*, UCase(mae_usuarios!ape) & ', ' & mae_usuarios!nom AS apenom, mae_formularios.descripcion AS formulario, " _
            ...
            & " WHERE (((var_edicion.idform)=2) AND ((var_edicion.idmov)=" & RstVent("id") & "))", xCon
    End If
End Sub
...
''''        End If
        ...
        If xRs.RecordCount <> 0 Then
            ...
            Fg1.TextMatrix(Fg1.Row, 11) = xRs("idtipven")
...
'    RST_Busq RstGui, "SELECT [vta_guia]![numser]+'-'+[vta_guia]![numdoc] AS numdoc From vta_guia WHERE (((vta_guia.iddocven)=" & RstVent("id") & "))" _
        ...
        If xRs.RecordCount <> 0 Then
            ...
            For X = 1 To xRs.RecordCount
                ...
                If Agregar = True Then
                    ...
                    Fg1.TextMatrix(Fg1.Rows - 1, 11) = xRs("idtipven")
