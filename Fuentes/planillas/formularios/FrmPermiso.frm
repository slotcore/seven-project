...
Begin VB.Form FrmPermiso 
   ...
   Begin VB.Frame FraEditor 
      ...
      Begin VB.CommandButton cb 
         ...
         Index           =   1
         Left            =   1335
         Picture         =   "FrmPermiso.frx":0559
         Style           =   1  'Graphical
         TabIndex        =   8
         ToolTipText     =   "Seleccione el Permiso"
         Top             =   1080
         Width           =   210
      End
      Begin VB.CommandButton cb 
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmPermiso.frx":07BD
            Key             =   "IMG1"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmPermiso.frx":0D01
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmPermiso.frx":1093
            Key             =   "IMG2"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmPermiso.frx":1217
            Key             =   "IMG3"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmPermiso.frx":166B
            Key             =   "IMG4"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmPermiso.frx":1783
            Key             =   "IMG5"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmPermiso.frx":1CC7
            Key             =   "IMG6"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmPermiso.frx":220B
            Key             =   "IMG7"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmPermiso.frx":231F
            Key             =   "IMG8"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmPermiso.frx":2433
            Key             =   "IMG9"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmPermiso.frx":2887
            Key             =   "IMG10"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmPermiso.frx":29F3
            Key             =   "IMG11"
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmPermiso.frx":2F3B
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin VSFlex7Ctl.VSFlexGrid Fg1 
      ...
      FormatString    =   $"FrmPermiso.frx":32CD
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
...
Private Sub cmd_Click(Index As Integer)
    ...
    Select Case Index
        Case 0 '--Add Permiso
            nuevo
        Case 1 '--Modificar Permiso
            Modificar
        Case 2 '--Eliminar Permiso
            Eliminar
    End Select
End Sub
...
Private Sub dtpk_GotFocus(Index As Integer)
'    dtpk_KeyDown Index, vbKeyF5, 0
End Sub
        ...
        If RstTmp.RecordCount <> 0 Then
            ...
            Do While Not RstTmp.EOF
                With Fg1
                    ...
                    .TextMatrix(.Rows - 1, 3) = NulosN(RstTmp.Fields("idper"))
                    ...
                    .TextMatrix(.Rows - 1, 10) = NulosC(RstTmp.Fields("permiso"))
...
Sub Eliminar()
    ...
    If MsgBox("¿Esta seguro de eliminar el registro?", vbQuestion + vbYesNo, xTitulo) = vbYes Then
        ...
        '---------------------------------------------------------
        xCon.Execute "DELETe * FROM pla_permiso WHERE id = " & NulosN(Fg1.TextMatrix(Fg1.Row, 1)) & "; "
...
Private Sub Modificar()
   '------
    ...
    pPonerDatos
     LblTituloFrame.Caption = "Modificar Permiso"
    txtfecha(0).SetFocus
...
Private Sub nuevo()
    ...
    LblTituloFrame.Caption = "Agregar Permiso"
    txtfecha(0).SetFocus
End Sub
...
Function Grabar() As Boolean
    ...
    If QueHace = 1 Then
        RST_Busq RstCab, "SELECT top 1 * FROM pla_permiso ", xCon
        xCod = HallaCodigoTabla("pla_permiso", xCon, "id")
        RstCab.AddNew
        RstCab("id") = xCod
    Else
        xCod = NulosN(Fg1.TextMatrix(Fg1.Row, 1))
        
        RST_Busq RstCab, "SELECT * FROM pla_permiso WHERE id =" & xCod & "", xCon
        '******************************************************************************************************
    ...
    RstCab("idper") = NulosN(lbl_cod(1).Caption)
    ...
    For dFecha = CDate(txtfecha(1).Valor) To CDate(txtfecha(2).Valor)
        pMacacionDia dFecha, e_Asist_Permiso, NulosN(lbl_cod(0).Caption)
    Next dFecha
    '******************************************************************************************************
    xCon.CommitTrans
    '----
...
Private Function fValidarDatos() As Boolean
    ...
    '--------------------------------
    '--restringir si se programo licencias
    nSQL = "SELECT pla_licencia.id,pla_licencia.fchini,pla_licencia.fchfin ,mae_tipolicencia.descripcion FROM pla_licencia LEFT JOIN mae_tipolicencia ON pla_licencia.idlic=mae_tipolicencia.id " _
    ...
    If RstTmp.BOF = False Or RstTmp.EOF = False Or RstTmp.RecordCount <> 0 Then
        MsgBox "No se puede " + IIf(QueHace = 1, "agregar", "modificar") + vbCr + _
               "Porque se ha programado una Licencia del " & Format(RstTmp.Fields("fchini"), "dd/mm/yy") & " al " & Format(RstTmp.Fields("fchfin"), "dd/mm/yy") + vbCr + _
    ...
    If QueHace = 1 Then
        nSQL = "SELECT id,fchini,fchfin FROM pla_permiso " _
                + vbCr + " WHERE idemp = " & NulosN(txt_cb(0).Text) & " AND " _
                + vbCr + " ((fchini BETWEEN cdate('" & txtfecha(1).Valor & "') AND cdate('" & txtfecha(2).Valor & "')) OR " _
                + vbCr + "  (fchfin BETWEEN cdate('" & txtfecha(1).Valor & "') AND cdate('" & txtfecha(2).Valor & "'))) "
    Else
    ...
    If RstTmp.BOF = False Or RstTmp.EOF = False Or RstTmp.RecordCount <> 0 Then
        MsgBox "No se puede " + IIf(QueHace = 1, "agregar", "modificar") + vbCr + _
               "Porque tiene permiso del " & Format(RstTmp.Fields("fchini"), "dd/mm/yy") & " al " & Format(RstTmp.Fields("fchfin"), "dd/mm/yy"), vbExclamation, xTitulo
        Set RstTmp = Nothing
        Exit Function
    End If
    '--------------------------------
...
Sub Buscar()
    ...
    xCampos(2, 0) = "Motivo":   xCampos(2, 1) = "permiso":      xCampos(2, 2) = "1500":     xCampos(2, 3) = "C"
    ...
    CARGAR_DLL_EPSBUSCAR xCon, xRs, nSQL, xCampos(), "Buscando Permisos", "nombres", "nombres", Principio
...
Private Sub pImprimir()
    ...
    oPrint.Imprimir_x_VSFlexGrid Fg1, "Consulta de Permisos", , "Periodo:  " + lblperiodo(0).Caption, False, True
    Set oPrint = Nothing
    Me.MousePointer = vbDefault
    Exit Sub
error:
...
Private Sub pExportarExcel()
    ...
    oExport.VSFlexGrid_Exportar_MSExcel xCon, Fg1, "Consulta de Permisos", "Periodo:  " + lblperiodo(0).Caption, "", "Permisos"
    Set oExport = Nothing
    Me.MousePointer = vbDefault
    Exit Sub
error:
...
Private Sub cb_Click(Index As Integer)
    ...
    Select Case Index
        ...
        Case 1 '--MOTIVO
            ...
            xCampos(0, 0) = "Desripción":   xCampos(0, 1) = "nombre":         xCampos(0, 2) = "4500":   xCampos(0, 3) = "C"
            xCampos(1, 0) = "Goce Haber":   xCampos(1, 1) = "congocehaber":   xCampos(1, 2) = "1200":    xCampos(1, 3) = "C"
            
            nTitulo = "Buscando Permisos"
            nSQL = "SELECT mae_tipopermiso.id, mae_tipopermiso.descripcion AS nombre, mae_tipopermiso.id AS cod, IIf([mae_tipopermiso].[gocehaber]=-1,'Si','No') AS congocehaber " _
                + vbCr + " FROM mae_tipopermiso; "
    ...
    Select Case Index
        ...
        Case 1 '--MOTIVO
            nSQL = "SELECT mae_tipopermiso.id, mae_tipopermiso.descripcion AS nombre, mae_tipopermiso.id AS cod, IIf([mae_tipopermiso].[gocehaber]=-1,'Si','No') AS congocehaber " _
                ...
                + vbCr + " WHERE mae_tipopermiso.id = " & NulosN(txt_cb(Index).Text) & ";"
...
Private Sub pConfigurarGrilla()
    With Fg1
        ...
        .TextMatrix(0, 3) = "idper":    .ColWidth(3) = 0:     .ColAlignment(3) = flexAlignLeftCenter
        ...
        .TextMatrix(0, 5) = "Personal": .ColWidth(5) = 2100:    .ColAlignment(5) = flexAlignLeftCenter:     .Row = 0: .Col = 5: .CellAlignment = flexAlignLeftCenter
        ...
        .TextMatrix(0, 10) = "Motivo":   .ColWidth(10) = 2100:    .ColAlignment(10) = flexAlignLeftCenter:   .Row = 0: .Col = 10: .CellAlignment = flexAlignLeftCenter
...
Private Sub pEliminarAsistencia(mIdCodigo&)
    ...
    nSQL = "SELECT pla_permiso.idemp, pla_marcacion.dia, pla_marcaciondet.idori, pla_marcaciondet.idmarca " _
        + vbCr + " FROM pla_permiso, pla_marcacion INNER JOIN pla_marcaciondet ON pla_marcacion.id = pla_marcaciondet.idmarca " _
        + vbCr + " WHERE (((pla_marcacion.dia) Between [pla_permiso].[fchini] And [pla_permiso].[fchfin]) " & _
                 " AND ((pla_marcaciondet.idori)=2) AND ((pla_permiso.id)=" & mIdCodigo & "));"
    RST_Busq RstTmp, nSQL, xCon
    ...
    If RstTmp.RecordCount <> 0 Then
        ...
        xCon.Execute "DELETE FROM pla_marcaciondet " & _
                     "WHERE idemp = " & mIdEmp & " AND idori=2 AND idmarca In " & nSQL & " ;"
        '--tipos de horas
        xCon.Execute "DELETE FROM pla_marcacionhora " & _
                     "WHERE idemp = " & mIdEmp & " AND idhora IN (5,6) AND idmarca In " & nSQL & " ;"
        '--5:hora permiso con goce haber; 6: hora permiso sin goce haber
