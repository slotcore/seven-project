...
Begin VB.Form FrmManLicencia 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Planillas - Tipo de Licencia"
   ClientHeight    =   7215
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   10650
   ...
   Begin SizerOneLibCtl.TabOne TabOne1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.Label Label1 
            Alignment       =   2  'Center
            Caption         =   "Detalle del Tipo de Licencia"
            BeginProperty Font 
               Name            =   "Courier New"
               Size            =   11.25
               Charset         =   0
      ...
      Begin VB.Frame Frame1 
         ...
         Begin TrueOleDBGrid70.TDBGrid Dg3 
            ...
            Splits(0)._ColumnProps(8)=   "Column(1).Width=12753"
            Splits(0)._ColumnProps(9)=   "Column(1).DividerColor=0"
            Splits(0)._ColumnProps(10)=   "Column(1)._WidthInPix=12674"
         ...
         Begin VB.Label Label2 
            Alignment       =   2  'Center
            Caption         =   "Consulta de Tipo de Licencia"
            BeginProperty Font 
               Name            =   "Courier New"
               Size            =   11.25
               Charset         =   0
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmManLicencia.frx":0007
               Key             =   "IMG1"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmManLicencia.frx":054B
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmManLicencia.frx":08DD
               Key             =   "IMG2"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmManLicencia.frx":0A61
               Key             =   "IMG3"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmManLicencia.frx":0EB5
               Key             =   "IMG4"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmManLicencia.frx":0FCD
               Key             =   "IMG5"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmManLicencia.frx":1511
               Key             =   "IMG6"
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmManLicencia.frx":1A55
               Key             =   "IMG7"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmManLicencia.frx":1B69
               Key             =   "IMG8"
            EndProperty
            BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmManLicencia.frx":1C7D
               Key             =   "IMG9"
            EndProperty
            BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmManLicencia.frx":20D1
               Key             =   "IMG10"
            EndProperty
            BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmManLicencia.frx":223D
               Key             =   "IMG11"
            EndProperty
         EndProperty
      End
   ...
   End
End
Attribute VB_Name = "FrmManLicencia"
...
Private Sub Form_Activate()
    ...
    If RstFrm.RecordCount = 0 Then
        Rpta = MsgBox("No se ha registrado ningún Tipo de Licencia, ¿Desea agregar uno ahora?", vbQuestion + vbYesNo + vbDefaultButton1, xTitulo)
        If Rpta = vbYes Then
            nuevo
        Else
            Set RstFrm = Nothing
...
Private Sub pCargarGrid()
    ...
    nSQL = "SELECT mae_tipolicencia.* " _
        + vbCr + " From mae_tipolicencia " _
        + vbCr + " ORDER BY mae_tipolicencia.descripcion;"
...
Sub Eliminar()
    ...
    RST_Busq RstTmp, "select * from pla_licencia where idlic=" & RstFrm("id") & " ;", xCon
    If RstTmp.RecordCount <> 0 Then
        MsgBox "El Tipo de Licencia que desea eliminar tiene registros relacionados" + vbCr + "No se puede eliminar"
        Set RstTmp = Nothing
        Exit Sub
    End If
    Set RstTmp = Nothing
    ...
    If Rpta = vbYes Then
        xCon.Execute "DELETe * FROM mae_tipolicencia WHERE id = " & RstFrm("id") & ""
...
Sub Cancelar()
    ...
    ActivaTool
    Habilitar_Obj False
    Label1.Caption = "Detalle del Tipo de Licencia"
    TabOne1.CurrTab = 0
    Dg3.SetFocus
End Sub
...
Private Sub Modificar()
    ...
    Label1.Caption = "Modificando el Tipo de Licencia"
...
Private Sub nuevo()
    ...
    Blanquea
    Habilitar_Obj True
    Label1.Caption = "Agregar Tipo de Licencia"
    '-----
...
Function Grabar() As Boolean
   If fValidarDatos() = False Then Exit Function
    ...
    If QueHace = 1 Then
        RST_Busq RstCab, "SELECT TOP 1 * FROM mae_tipolicencia ", xCon
        xCod = HallaCodigoTabla("mae_tipolicencia", xCon, "id")
        RstCab.AddNew
        RstCab("id") = xCod
        txt(0).Text = xCod
    Else
        RST_Busq RstCab, "SELECT * FROM mae_tipolicencia WHERE id =" & RstFrm("id") & "", xCon
        xCod = RstFrm("id")
    End If
    ...
    MsgBox "El Tipo de Licencia se " + IIf(QueHace = 1, "grabó", "modificó") + " con éxito", vbInformation, xTitulo
    xCon.CommitTrans
    Grabar = True
salir:
    Set RstCab = Nothing
...
Private Function fValidarDatos() As Boolean
    ...
    Dim RstTmp As New ADODB.Recordset
    If QueHace = 1 Then
        RST_Busq RstTmp, "SELECT mae_tipolicencia.id From mae_tipolicencia WHERE ((ucase(trim(mae_tipolicencia.descripcion))='" + UCase(Trim(txt(1).Text)) + "'));", xCon
    Else
        RST_Busq RstTmp, "SELECT mae_tipolicencia.id FROM mae_tipolicencia WHERE (((mae_tipolicencia.id)<>" + CStr(RstFrm.Fields("id")) + ") AND (ucase(trim(mae_tipolicencia.descripcion))='" + UCase(Trim(txt(1).Text)) + "'));", xCon
    End If
...
Sub Buscar()
    ...
    CARGAR_DLL_EPSBUSCAR xCon, xRs, nSQL, xCampos(), "Buscando Tipo de Licencia", "Descripcion", "Descripcion", Principio
