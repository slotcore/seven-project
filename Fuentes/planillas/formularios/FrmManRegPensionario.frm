...
Private Sub Form_Activate()
    ...
    If RstFrm.RecordCount = 0 Then
        If MsgBox("No se ha registrado Régimen Pensionario, ¿Desea agregar uno ahora?", vbQuestion + vbYesNo, xTitulo) = vbYes Then
            nuevo
        End If
    End If
...
Function Grabar() As Boolean
    ...
    Else
        ...
        xCon.Execute "Delete from pla_conceptoregpen where idregpen =  " & RstFrm("id") & " ;"
        xId = RstCab("id")
    End If
...
Sub MuestraSegundoTab()
    ...
    If NulosN(RstFrm("ctaresumen")) = -1 Then
        OptCta(1).Value = True
        If NulosN(RstFrm("idcuenta")) = -1 Then
