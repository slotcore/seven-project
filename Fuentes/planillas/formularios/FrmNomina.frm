   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmNomina.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmNomina.frx":0544
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmNomina.frx":06C8
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmNomina.frx":0B1C
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmNomina.frx":0C34
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmNomina.frx":1178
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmNomina.frx":16BC
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmNomina.frx":17D0
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmNomina.frx":18E4
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmNomina.frx":1D38
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmNomina.frx":1EA4
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmNomina.frx":23EC
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin SizerOneLibCtl.TabOne TabOne1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin TrueOleDBGrid70.TDBGrid Dg1 
            ...
            Splits(0)._ColumnProps(59)=   "Column(11).Width=2196"
            Splits(0)._ColumnProps(60)=   "Column(11).DividerColor=0"
            Splits(0)._ColumnProps(61)=   "Column(11)._WidthInPix=2117"
         ...
         Begin SizerOneLibCtl.TabOne TabOne2 
            ...
            Begin VB.Frame Frame8 
               ...
               Begin VB.Frame Frame10 
                  ...
                  Begin VSFlex7Ctl.VSFlexGrid Fg3 
                     ...
                     FormatString    =   $"FrmNomina.frx":2C46
                     ScrollTrack     =   0   'False
                     ScrollBars      =   3
                     ScrollTips      =   0   'False
                     MergeCells      =   0
            ...
            Begin VB.Frame Frame4 
               ...
               Begin VSFlex7Ctl.VSFlexGrid Fg1 
                  ...
                  ColWidthMax     =   0
                  ExtendLastCol   =   0   'False
                  FormatString    =   $"FrmNomina.frx":2E13
                  ScrollTrack     =   0   'False
                  ScrollBars      =   3
                  ScrollTips      =   0   'False
                  MergeCells      =   0
            ...
            Begin VB.Frame Frame7 
               ...
               Begin VSFlex7Ctl.VSFlexGrid Fg2 
                  ...
                  ColWidthMax     =   0
                  ExtendLastCol   =   0   'False
                  FormatString    =   $"FrmNomina.frx":2F02
                  ScrollTrack     =   0   'False
                  ScrollBars      =   3
                  ScrollTips      =   0   'False
                  MergeCells      =   0
...
Function Grabar() As Boolean
    ...
    Else
        ...
        RST_Busq Rst, "SELECT * FROM pla_empleados WHERE idtipdoc = " & NulosN(txt_cb(0).Text) & " AND numdoc = '" & txt(4).Text & "'", xCon
        If Quehace = 1 Then
    ...
    If Quehace = 1 Then
        ...
        xId = HallaCodigoTabla("pla_empleados", xCon, "id")
        RST_Busq RstCab, "SELECT TOP 1 * FROM pla_empleados", xCon

        RstCab.AddNew
        RstCab("id") = xId
    Else
        xId = RstFrm("id")
        RST_Busq RstCab, "SELECT * FROM pla_empleados WHERE id = " & xId & "", xCon
        '--eliminar el periodo laboral
        xCon.Execute "Delete from pla_periodolaboral where idemp =  " & xId & " ;"
        '--eliminar los conceptos relacionado con el centro de costo
        xCon.Execute "DELETE FROM pla_empleadoscos WHERE idemp = " & xId & ";"
        '--eliminar las imagenes relacionadas
        xCon.Execute "DELETE FROM pla_empleadosimg WHERE idemp = " & xId & ";"
    ...
    mIdRegistro = xId
    '---
    RST_Busq RstPerLab, "SELECT TOP 1 * FROM pla_periodolaboral ; ", xCon
    RST_Busq RstCenCos, "SELECT TOP 1 * FROM pla_empleadoscos", xCon
    ...
    RST_Busq Rst, "SELECT TOP 1 * FROM pla_empleadosimg ", xCon
...
Sub Eliminar()
    ...
    Dim RstBus As New ADODB.Recordset
    RST_Busq RstBus, "SELECT TOP 1 * FROM pla_boleta WHERE idemp = " & RstFrm("id") & "", xCon
    ...
    If Rpta = vbYes Then
        xCon.Execute "DELETE FROM pla_derechohab WHERE idemp=" & RstFrm.Fields("id") & " ;"
        xCon.Execute "DELETE * FROM pla_empleados WHERE id = " & RstFrm("id") & ""
