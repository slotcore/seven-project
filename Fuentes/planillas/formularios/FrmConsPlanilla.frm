...
Begin VB.Form FrmConsPlanilla 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cb 
         ...
         Index           =   0
         Left            =   4440
         Picture         =   "FrmConsPlanilla.frx":0382
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmConsPlanilla.frx":04B4
               Key             =   "IMG1"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmConsPlanilla.frx":09F8
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmConsPlanilla.frx":0D8A
               Key             =   "IMG2"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmConsPlanilla.frx":0F0E
               Key             =   "IMG3"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmConsPlanilla.frx":1362
               Key             =   "IMG4"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmConsPlanilla.frx":147A
               Key             =   "IMG5"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmConsPlanilla.frx":19BE
               Key             =   "IMG6"
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmConsPlanilla.frx":1F02
               Key             =   "IMG7"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmConsPlanilla.frx":2016
               Key             =   "IMG8"
            EndProperty
            BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmConsPlanilla.frx":212A
               Key             =   "IMG9"
            EndProperty
            BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmConsPlanilla.frx":257E
               Key             =   "IMG10"
            EndProperty
            BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmConsPlanilla.frx":26EA
               Key             =   "IMG11"
            EndProperty
            BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmConsPlanilla.frx":2C32
               Key             =   ""
            EndProperty
            BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmConsPlanilla.frx":2F4C
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin SizerOneLibCtl.TabOne TabOne1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VSFlex7Ctl.VSFlexGrid Fg 
            ...
            FormatString    =   $"FrmConsPlanilla.frx":32DE
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VSFlex7Ctl.VSFlexGrid Fg 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   0   'False
            FormatString    =   $"FrmConsPlanilla.frx":33C3
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
...
Private Sub pCargarDetalle()
    ...
    nSQL = "SELECT pla_boleta.idemp,mae_categoria.nomcor AS Cat, mae_dociden.abrev AS TipDoc, pla_empleados.numdoc as NumDoc, [pla_empleados].[apepat] & ' ' & [pla_empleados].[apemat] & ' ' & [pla_empleados].[nom] AS Nombres, mae_cargo.descripcion AS Cargo " _
        ...
        + vbCr + " WHERE (((pla_boleta.ano)=" & AnoTra & ") AND ((pla_boleta.idmes)=" & mMesIni & ")) " & nSQLIdEmp & " ;"
    ...
    With Fg(0)
        ...
        For mColRst = 0 To RstTmp.Fields.Count - 1
            ...
            Select Case LCase(RstTmp.Fields(mColRst).Name)
                ...
                Case "cat"
                    .ColWidth(mColGrid) = 500:  .ColAlignment(mColGrid) = flexAlignLeftCenter:  .Row = 1: .Col = mColGrid:  .CellAlignment = flexAlignLeftCenter
                Case "cargo"
                    .ColWidth(mColGrid) = 1100:  .ColAlignment(mColGrid) = flexAlignLeftCenter:  .Row = 1: .Col = mColGrid:  .CellAlignment = flexAlignLeftCenter
                Case "numdoc", "tipdoc"
    ...
    nSQL = "TRANSFORM Sum(pla_boletadet.imptot) AS total " _
        ...
        + vbCr + " WHERE (((pla_boleta.ano)=" & AnoTra & ") AND ((pla_boleta.idmes)=" & mMesIni & ") AND ((pla_conceptotipo.idcat)=1) AND ((pla_concepto.aplanilla)=-1)) " & nSQLIdEmp & " " _
    ...
    nSQL = "TRANSFORM Sum(pla_boletadet.imptot) AS total " _
        + vbCr + " SELECT pla_boleta.idemp, Sum(pla_boletadet.imptot) AS acumulado " _
        + vbCr + " FROM (pla_conceptotipo INNER JOIN pla_concepto ON pla_conceptotipo.id = pla_concepto.idtipo) INNER JOIN ((mae_moneda RIGHT JOIN pla_boleta ON mae_moneda.id = pla_boleta.idmon) INNER JOIN pla_boletadet ON pla_boleta.id = pla_boletadet.idbol) ON pla_concepto.id = pla_boletadet.idcpto " _
        + vbCr + " WHERE (((pla_boleta.ano)=" & AnoTra & ") AND ((pla_boleta.idmes)=" & mMesIni & ") AND ((pla_conceptotipo.idcat)=3) AND ((pla_concepto.aplanilla)=-1)) OR (((pla_boleta.ano)=" & AnoTra & ") AND ((pla_boleta.idmes)=" & mMesIni & ") AND ((pla_conceptotipo.idcat)=2) AND ((pla_concepto.idtipo)=9)) " & nSQLIdEmp & " " _
    ...
    nSQL = "TRANSFORM Sum(pla_boletadet.imptot) AS total " _
        + vbCr + " SELECT pla_boleta.idemp, Sum(pla_boletadet.imptot) AS acumulado " _
        + vbCr + " FROM (pla_conceptotipo INNER JOIN pla_concepto ON pla_conceptotipo.id = pla_concepto.idtipo) INNER JOIN ((mae_moneda RIGHT JOIN pla_boleta ON mae_moneda.id = pla_boleta.idmon) INNER JOIN pla_boletadet ON pla_boleta.id = pla_boletadet.idbol) ON pla_concepto.id = pla_boletadet.idcpto " _
        + vbCr + " WHERE (((pla_boleta.ano)=" & AnoTra & ") AND ((pla_boleta.idmes)=" & mMesIni & ") AND ((pla_conceptotipo.idcat)=2) AND ((pla_concepto.idtipo)=10) AND ((pla_concepto.aplanilla)=-1)) " & nSQLIdEmp & " " _
        + vbCr + " GROUP BY pla_boleta.idemp, pla_conceptotipo.idcat, pla_concepto.idtipo " _
        + vbCr + " ORDER BY pla_boleta.idemp " _
        + vbCr + " PIVOT pla_concepto.nomcorto; "
    RST_Busq RstTmp, nSQL, xCon
