...
Begin VB.Form FrmManDocumento 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Planillas - Documentos"
   ClientHeight    =   7590
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   11850
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManDocumento.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManDocumento.frx":0544
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManDocumento.frx":06C8
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManDocumento.frx":0B1C
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManDocumento.frx":0C34
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManDocumento.frx":1178
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManDocumento.frx":16BC
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManDocumento.frx":17D0
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManDocumento.frx":18E4
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManDocumento.frx":1D38
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManDocumento.frx":1EA4
            Key             =   ""
         EndProperty
      EndProperty
   End
         ...
         Begin SizerOneLibCtl.TabOne TabOne2 
            ...
            Begin VB.Frame Frame7 
               ...
               Begin VSFlex7Ctl.VSFlexGrid Fg1 
                  ...
                  FormatString    =   $"FrmManDocumento.frx":23EC
                  ScrollTrack     =   0   'False
                  ScrollBars      =   3
                  ScrollTips      =   0   'False
                  MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "FrmManDocumento"
...
Function Grabar() As Boolean
    ...
    Else
        ...
        xCon.Execute "Delete from pla_conceptopro where idproc =  " & RstFrm("id") & " ;"
        xId = RstCab("id")
    End If

    RST_Busq RstDet, "SELECT TOP 1 * FROM pla_conceptopro ; ", xCon
...
Sub Eliminar()
    ...
    RST_Busq RstBus, "SELECT * FROM pla_conceptopro WHERE idproc = " & RstFrm("id") & "", xCon
    If RstFrm.RecordCount <> 0 Then
    ...
    If Rpta = vbYes Then
        xCon.Execute "DELETE FROM pla_conceptopro WHERE idproc=" & RstFrm.Fields("id") & " ;"
...
Private Sub pCargarDatosDet()
    ...
    nSQL = "SELECT pla_concepto.id, pla_conceptocat.descripcion AS catnombre, pla_conceptotipo.descripcion AS tipnombre, pla_concepto.codsun, pla_concepto.descripcion, pla_concepto.variable, pla_concepto.formula " _
        + vbCr + " FROM ((pla_conceptocat RIGHT JOIN pla_conceptotipo ON pla_conceptocat.id = pla_conceptotipo.idcat) RIGHT JOIN pla_concepto ON pla_conceptotipo.id = pla_concepto.idtipo) INNER JOIN pla_conceptopro ON pla_concepto.id = pla_conceptopro.idcpto " _
        + vbCr + " WHERE (((pla_conceptopro.idproc) = " & RstFrm.Fields("id") & ")) " _
...
Private Sub pConfigurarGrilla()
    With Fg1 '--
        ...
        .TextMatrix(0, 4) = "Tipo":          .ColWidth(4) = 1600: .ColAlignment(4) = flexAlignLeftCenter:    .Row = 0: .Col = 4: .CellAlignment = flexAlignLeftCenter
        ...
        .TextMatrix(0, 6) = "Variable":      .ColWidth(6) = 2000: .ColAlignment(6) = flexAlignLeftCenter:    .Row = 0: .Col = 6: .CellAlignment = flexAlignLeftCenter
        .TextMatrix(0, 7) = "Fórmula":       .ColWidth(7) = 5500: .ColAlignment(7) = flexAlignLeftCenter:    .Row = 0: .Col = 7: .CellAlignment = flexAlignLeftCenter
