...
Begin VB.Form FrmGestionCompras 
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmGestionCompras.frx":0000
               Key             =   "IMG1"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmGestionCompras.frx":0544
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmGestionCompras.frx":08D6
               Key             =   "IMG2"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmGestionCompras.frx":0A5A
               Key             =   "IMG3"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmGestionCompras.frx":0EAE
               Key             =   "IMG4"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmGestionCompras.frx":0FC6
               Key             =   "IMG5"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmGestionCompras.frx":150A
               Key             =   "IMG6"
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmGestionCompras.frx":1A4E
               Key             =   "IMG7"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmGestionCompras.frx":1B62
               Key             =   "IMG8"
            EndProperty
            BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmGestionCompras.frx":1C76
               Key             =   "IMG9"
            EndProperty
            BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmGestionCompras.frx":20CA
               Key             =   "IMG10"
            EndProperty
            BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmGestionCompras.frx":2236
               Key             =   "IMG11"
            EndProperty
            BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmGestionCompras.frx":277E
               Key             =   ""
            EndProperty
            BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmGestionCompras.frx":2A98
               Key             =   ""
            EndProperty
            BeginProperty ListImage15 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmGestionCompras.frx":2E2A
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin VB.Frame fr 
      ...
      Begin VB.Frame fr 
         ...
         Begin VB.CommandButton CmdMas 
            ...
            Index           =   1
            Left            =   1200
            Picture         =   "FrmGestionCompras.frx":327C
            Style           =   1  'Graphical
            TabIndex        =   70
            ToolTipText     =   "Reducir"
            Top             =   1110
         ...
         Begin VB.CommandButton CmdMas 
            ...
            Index           =   0
            Left            =   1200
            Picture         =   "FrmGestionCompras.frx":337E
            Style           =   1  'Graphical
            TabIndex        =   69
            ToolTipText     =   "Ampliar"
            Top             =   420
      ...
      Begin VB.CommandButton CmdBusProducto 
         Height          =   225
         Left            =   9075
         Picture         =   "FrmGestionCompras.frx":3480
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   855
         Width           =   210
      ...
      Begin VSFlex7Ctl.VSFlexGrid fg 
         ...
         FormatString    =   $"FrmGestionCompras.frx":35B2
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin VSFlex7Ctl.VSFlexGrid fg 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"FrmGestionCompras.frx":360F
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin VSFlex7Ctl.VSFlexGrid fg 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"FrmGestionCompras.frx":3671
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin VSFlex7Ctl.VSFlexGrid fg 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"FrmGestionCompras.frx":36CD
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin VSFlex7Ctl.VSFlexGrid Fg1 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   0   'False
      FormatString    =   $"FrmGestionCompras.frx":3726
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin VB.Menu mn_proveedor 
      Caption         =   "Proveedor"
      Visible         =   0   'False
      Begin VB.Menu mn_proveedor1 
         Caption         =   "Agregar"
      End
      Begin VB.Menu mn_proveedor2 
         Caption         =   "Seleccionar"
      End
   End
   ...
   End
End
Attribute VB_Name = "FrmGestionCompras"
...
Private Sub CONSULTAR()
    ...
    If (NulosN(TxtIdTipProd.Text) = 0 And ChkMostrarItem.Value = 0) Or opt_consulta(0).Value = True Then
        ...
        '--Ordenar columnas cuando sea x Proveedor
...
'            xCampos(2, 0) = "Id":   xCampos(2, 1) = "id":        xCampos(2, 2) = "800":   xCampos(2, 3) = "N"
            '--si hay filtros
            nSQLNotIn = GRID_GENERAR_SQL_ID(Fg(0), 1, " and mae_prov.id", "NOT IN", True)
            If NulosC(Fg(Index).TextMatrix(Row, Col)) <> "" Then
                nSQLNotIn = nSQLNotIn & " and  (UCASE(mae_prov.nombre) LIKE '%" & UCase(NulosC(Fg(Index).TextMatrix(Row, Col))) & "%' OR UCASE(mae_prov.nombre) LIKE '%" & UCase(NulosC(Fg(Index).TextMatrix(Row, Col))) & "%' ) "
            End If
            '--------------
            nSQL = "SELECT 0 as xsel,id, nombre,numruc FROM mae_prov where id <> 0 " & nSQLNotIn & "  order by nombre asc"
...
Private Sub mn_proveedor1_Click()
    F_SELECCION = False
    Fg_CellButtonClick 0, Fg(0).Row, Fg(0).Col
End Sub

Private Sub mn_proveedor2_Click()
    F_SELECCION = True
    Fg_CellButtonClick 0, Fg(0).Row, Fg(0).Col
End Sub
...
Private Function fGenerarConsulta(M_ANYO As String) As String
    ...
    Dim nSQLIdProv As String         '--Sentencia SQL para Proveedores
...
'    Dim nSQLFrom As String
    ...
    Dim TipoTabla As Integer    '--Indica tipos de SubConsultas que se utilizara
                                '--1:Año, Tipo documento, Proveedor
                                '--2:Producto
...
'''''    Q_COL_COMPARAR_GRUPO    '--NO HAY GRUPO
    ...
    '--DEL AÑO
    nSQLWhere = " Year(com_compras.fchdoc)= " + M_ANYO + " "
    '--
    '--DEL PROVEEDOR
    nSQLIdProv = GRID_GENERAR_SQL_ID(Fg(0), 1, " AND com_compras.idpro", "IN")
    ...
    '--CONCATENAR FECHA + PROVEEDOR + ITEM
    nSQLWhere = nSQLWhere + nSQLIdProv + nSQLIdItem
    '---------------
    '--DE LA MONEDA
    '--SOLO MN
    If opt_mon(0).Value = True Then nSQLWhere = nSQLWhere + " AND com_compras.idmon= 1 "
    '--SOLO ME
    If opt_mon(1).Value = True Then nSQLWhere = nSQLWhere + " AND com_compras.idmon= 2 "
    '---------------
    
    '--restringir apertura de documento
    If chkAnioPasados.Value = 0 Then nSQLWhere = nSQLWhere + " AND com_compras.numreg<>'000001'  "
    ...
    nSQLPivot = Replace(nSQLPivot, "com_compras", "vista")
...
'''            nSQLCampos = "YEAR(com_compras.fchdoc) AS idanyo,alm_inventario.tippro,  YEAR(com_compras.fchdoc) AS anyo, mae_tipoproducto.descripcion "
'''            nSQLGroupBy = "alm_inventario.tippro,YEAR(com_compras.fchdoc),mae_tipoproducto.descripcion "
...
'''            T_RPT_TITULO = "RESUMEN DE COMPRAS POR AÑO CON ITEM"
'''            nSQLCampos = "YEAR(com_compras.fchdoc) AS idanyo,alm_inventario.tippro,alm_inventario.id,  YEAR(com_compras.fchdoc) AS anyo,mae_tipoproducto.descripcion,alm_inventario.descripcion AS desctipcom "
'''            nSQLGroupBy = "alm_inventario.tippro,alm_inventario.id,  YEAR(com_compras.fchdoc),mae_tipoproducto.descripcion,alm_inventario.descripcion"
...
'''        End If
    ...
    ElseIf opt_consulta(1).Value = True Then '--X PROVEEDOR
        If (Me.TxtIdTipProd.Text <> "" And ChkMostrarItem.Value = 0) Or (Me.TxtIdTipProd.Text <> "" And ChkMostrarItem.Value = 0) Then '--CLIETNE/PRODUCTO
            ...
            nSQLCampos = "vista.idpro,vista.tippro,  vista.nomproveedor,vista.desctipcom "
            nSQLGroupBy = "vista.idpro,vista.tippro,  vista.nomproveedor,vista.desctipcom "
            nSQLOrderBy = "vista.nomproveedor,vista.desctipcom "
            
            nSQLWhere = nSQLWhere + " AND alm_inventario.tippro IS NOT NULL " '--SOLO LOS QUE TIENEN TIPO DE PRODUCTO
            
            TipoTabla = 2
            
        ElseIf ChkMostrarItem.Value = 1 Then '--PROVEEDOR/PRODUCTO/ITEM
            ...
            nSQLCampos = "vista.idpro,vista.tippro,vista.iditem,  vista.nomproveedor,vista.desctipcom,vista.codigo,vista.descitem "
            nSQLGroupBy = "vista.idpro,vista.tippro,vista.iditem,  vista.nomproveedor,vista.desctipcom,vista.codigo,vista.descitem "
            nSQLOrderBy = "vista.nomproveedor,vista.desctipcom,vista.descitem "
        ...
        Else    '--SOLO PROVEEDOR
            ...
            nSQLCampos = " vista.idpro,vista.numruc, vista.nomproveedor "
            nSQLGroupBy = "com_compras.idpro,vista.numruc,vista.nomproveedor "
            nSQLOrderBy = "vista.nomproveedor "
    ...
    ElseIf opt_consulta(4).Value = True Then '--X PRODUCTO
        If TxtIdTipProd.Text <> "" And ChkMostrarItem.Value = 0 Then
            Q_COL_FILA_OCULTA = 1:        Q_COL_FILA = 2:        Q_POSICION_TOTAL = 2:        Q_COL_COMPARAR_GRUPO = -1
            T_RPT_TITULO = "RESUMEN DE COMPRAS POR TIPO PRODUCTO"
        ...
        ElseIf ChkMostrarItem.Value = 1 Then
            ...
            T_RPT_TITULO = "RESUMEN DE COMPRAS POR TIPO PRODUCTO CON ITEM"
    ...
    ElseIf opt_consulta(5).Value = True Then '--X TIPO DE DOCUMENTO
        If (Me.TxtIdTipProd.Text <> "" And ChkMostrarItem.Value = 0) Or (Me.TxtIdTipProd.Text <> "" And ChkMostrarItem.Value = 0) Then '--VENDEDOR/PRODUCTO
            Q_COL_FILA_OCULTA = 2:        Q_COL_FILA = 4:        Q_POSICION_TOTAL = 4:        Q_COL_COMPARAR_GRUPO = -1
            T_RPT_TITULO = "RESUMEN DE COMPRAS POR TIPO DE DOCUMENTO CON TIPO PRODUCTO"
        ...
        ElseIf ChkMostrarItem.Value = 1 Then '--TIPO DE DOCUM
            Q_COL_FILA_OCULTA = 3:        Q_COL_FILA = 7:        Q_POSICION_TOTAL = 7:        Q_COL_COMPARAR_GRUPO = 3
            T_RPT_TITULO = "RESUMEN DE COMPRAS POR TIPO DE DOCUMENTO CON ITEM"
        ...
        Else    '--SOLO TIPO DE DOCUMENTO
            Q_COL_FILA_OCULTA = 1:        Q_COL_FILA = 2:        Q_POSICION_TOTAL = 2:        Q_COL_COMPARAR_GRUPO = -1
            T_RPT_TITULO = "RESUMEN DE COMPRAS POR TIPO DE DOCUMENTO"
    ...
    If TipoTabla = 1 Then
        ...
        '*tipo documento
        '*Proveedor
        '--consulta compras resumen
        nSQLTabla = "( SELECT YEAR(com_compras.fchreg) AS anyo, Left([com_compras].[numreg],2) & Format(mae_libros.codsun,'00') & Right([com_compras].[numreg],4) AS registro, mae_prov.numruc, mae_prov.nombre as nomproveedor, mae_documento.abrev AS tdocabrev, com_compras!numser+'-'+com_compras!numdoc AS numerodoc,com_compras.fchreg,com_compras.fchdoc, com_compras.fchven, mae_condpago.abrev AS conpagabre, " _
                ...
                + vbCr + " IIf(com_compras.idmon=1,impreal,0) AS imptotmn, " _
                + vbCr + " IIf(com_compras.idmon=2,impreal,0) AS imptotme, " _
                + vbCr + " (imptotmn + imptotme * tipcam) as imptotexpmn, " _
                + vbCr + " (imptotme + iif(tipcam=0,0, imptotmn / tipcam) )  as imptotexpme, " _
                + vbCr + " IIf(com_compras.tipdoc=7,(-1)*com_compras.impigv,com_compras.impigv) AS impigvreal, " _
                + vbCr + " IIf(com_compras.idmon=1,impigvreal,0) AS impigvmn, " _
                + vbCr + " IIf(com_compras.idmon=2,impigvreal,0) AS impigvme, " _
                + vbCr + " (impigvmn + impigvme * tipcam) as impigvexpmn, " _
                + vbCr + " (impigvme + iif(tipcam=0,0, impigvmn / tipcam) )  as impigvexpme, " _
                + vbCr + " YEAR(com_compras.fchreg) AS idanyo,com_compras.idpro , com_compras.tipdoc, com_compras.idmon " _
                + vbCr + " FROM mae_prov RIGHT JOIN (((((com_compras LEFT JOIN mae_documento ON com_compras.tipdoc = mae_documento.id) LEFT JOIN mae_moneda ON com_compras.idmon = mae_moneda.id) " _
                + vbCr + " LEFT JOIN con_tc ON com_compras.fchdoc = con_tc.fecha) LEFT JOIN mae_libros ON com_compras.idlib = mae_libros.id) LEFT JOIN mae_condpago ON com_compras.idconpag = mae_condpago.id) ON mae_prov.id = com_compras.idpro " _
    ...
    ElseIf TipoTabla = 2 Then
        ...
        nSQLTabla = " ( SELECT YEAR(com_compras.fchreg) AS anyo, Left([com_compras].[numreg],2) & Format(mae_libros.codsun,'00') & Right([com_compras].[numreg],4) AS registro, mae_prov.numruc, mae_prov.nombre AS nomproveedor, mae_documento.abrev AS tdocabrev, com_compras!numser+'-'+com_compras!numdoc AS numerodoc, com_compras.fchreg,com_compras.fchdoc, com_compras.fchven, mae_condpago.abrev AS conpagabre, " _
                ...
                + vbCr + " mae_tipoproducto.descripcion AS desctipcom,mae_familia.descripcion AS descfam, alm_inventario.codpro as codigo ,alm_inventario.descripcion as descitem, mae_unidades.abrev AS prodabrev, IIf([com_compras].[tipdoc]=7,(-1) * com_comprasdet.canpro,com_comprasdet.canpro) as canpro,  " _
                + vbCr + " IIf([com_compras].[tipdoc]=7,(-1)*[com_comprasdet].[imptot],[com_comprasdet].[imptot]) AS impreal, " _
                + vbCr + " IIf([com_compras].[idmon]=1,[impreal],0) AS imptotmn, " _
                + vbCr + " IIf([com_compras].[idmon]=2,[impreal],0) AS imptotme, " _
                ...
                + vbCr + " IIf([com_compras].[idmon]=1,[imptotmn],[impreal]*[tipcam]) AS imptotexpmn, " _
                + vbCr + " IIf([com_compras].[idmon]=2,[imptotme],IIf([tipcam]=0,0,[impreal]/[tipcam])) As imptotexpme, " _
                + vbCr + " IIf([com_compras].[idmon]=1,[pumn],[pume]*[tipcam]) AS puexpmn, " _
                + vbCr + " IIf([com_compras].[idmon]=2,[pume],IIF( tipcam=0,0,[pumn]/[tipcam])) AS puexpme, " _
                + vbCr + " YEAR(com_compras.fchreg) AS idanyo,com_compras.idpro , com_compras.tipdoc, com_compras.idmon ,alm_inventario.id AS iditem, alm_inventario.tippro,alm_inventario.idfam " _
                ...
                + vbCr + " INNER JOIN com_comprasdet ON com_compras.id = com_comprasdet.idcom) LEFT JOIN (mae_unidades RIGHT JOIN (mae_tipoproducto RIGHT JOIN alm_inventario ON mae_tipoproducto.id = alm_inventario.tippro) ON mae_unidades.id = alm_inventario.idunimed) ON com_comprasdet.iditem = alm_inventario.id) LEFT JOIN mae_familia ON alm_inventario.idfam = mae_familia.id " _
                + vbCr + " WHERE " & nSQLWhere _
                + vbCr + "  ) AS vista "
    ...
    With Fg1
        ...
        Else
            ...
            If opt_consulta(1).Value = True Then '--X PROVEEDOR
                If (Me.TxtIdTipProd.Text <> "" And ChkMostrarItem.Value = 0) Or (Me.TxtIdTipProd.Text <> "" And ChkMostrarItem.Value = 0) Then '--CLIETNE/PRODUCTO
                    .TextMatrix(1, 3) = "Proveedor":       .ColWidth(3) = 1500:   .ColAlignment(3) = flexAlignLeftCenter
                ...
                ElseIf ChkMostrarItem.Value = 1 Then '--CLIETNE/PRODUCTO/ITEM
                    .TextMatrix(1, 4) = "Proveedor":       .ColWidth(4) = 1500:   .ColAlignment(4) = flexAlignLeftCenter
                ...
                Else    '--SOLO PROVEEDOR
                    ...
                    .TextMatrix(1, 3) = "Proveedor":       .ColWidth(3) = 2500:   .ColAlignment(3) = flexAlignLeftCenter
