...
'*****************************************************************************************************
'* Nombre Archivo   : FRMVISTAESTACIONALIDAD
'* Tipo             : FORMULARIO
'* Descripcion      : MUESTRA LA ESTACIONALIDAD DE UN PRODUCTO Y HACE LA DISTRIBUCION DEL ABASTECIMIENTO
'*                    EN FUNCION A LA ESTACIONALIDAD
...
Private Sub CmdAcep_Click()
    If Trim(TxtNumGrid.Text) = "2" Then
        FrmPlanProduccion3.Fg2.TextMatrix(FrmPlanProduccion3.Fg2.Row, 4) = Fg3.TextMatrix(1, 1)
        FrmPlanProduccion3.Fg2.TextMatrix(FrmPlanProduccion3.Fg2.Row, 5) = Fg3.TextMatrix(1, 2)
        FrmPlanProduccion3.Fg2.TextMatrix(FrmPlanProduccion3.Fg2.Row, 6) = Fg3.TextMatrix(1, 3)
        FrmPlanProduccion3.Fg2.TextMatrix(FrmPlanProduccion3.Fg2.Row, 7) = Fg3.TextMatrix(1, 4)
        FrmPlanProduccion3.Fg2.TextMatrix(FrmPlanProduccion3.Fg2.Row, 8) = Fg3.TextMatrix(1, 5)
        FrmPlanProduccion3.Fg2.TextMatrix(FrmPlanProduccion3.Fg2.Row, 9) = Fg3.TextMatrix(1, 6)
        FrmPlanProduccion3.Fg2.TextMatrix(FrmPlanProduccion3.Fg2.Row, 10) = Fg3.TextMatrix(1, 7)
        FrmPlanProduccion3.Fg2.TextMatrix(FrmPlanProduccion3.Fg2.Row, 11) = Fg3.TextMatrix(1, 8)
        FrmPlanProduccion3.Fg2.TextMatrix(FrmPlanProduccion3.Fg2.Row, 12) = Fg3.TextMatrix(1, 9)
        FrmPlanProduccion3.Fg2.TextMatrix(FrmPlanProduccion3.Fg2.Row, 13) = Fg3.TextMatrix(1, 10)
        FrmPlanProduccion3.Fg2.TextMatrix(FrmPlanProduccion3.Fg2.Row, 14) = Fg3.TextMatrix(1, 11)
        FrmPlanProduccion3.Fg2.TextMatrix(FrmPlanProduccion3.Fg2.Row, 15) = Fg3.TextMatrix(1, 12)
    Else
        FrmPlanProduccion3.Fg1.TextMatrix(FrmPlanProduccion3.Fg1.Row, 4) = Fg3.TextMatrix(1, 1)
        FrmPlanProduccion3.Fg1.TextMatrix(FrmPlanProduccion3.Fg1.Row, 5) = Fg3.TextMatrix(1, 2)
        FrmPlanProduccion3.Fg1.TextMatrix(FrmPlanProduccion3.Fg1.Row, 6) = Fg3.TextMatrix(1, 3)
        FrmPlanProduccion3.Fg1.TextMatrix(FrmPlanProduccion3.Fg1.Row, 7) = Fg3.TextMatrix(1, 4)
        FrmPlanProduccion3.Fg1.TextMatrix(FrmPlanProduccion3.Fg1.Row, 8) = Fg3.TextMatrix(1, 5)
        FrmPlanProduccion3.Fg1.TextMatrix(FrmPlanProduccion3.Fg1.Row, 9) = Fg3.TextMatrix(1, 6)
        FrmPlanProduccion3.Fg1.TextMatrix(FrmPlanProduccion3.Fg1.Row, 10) = Fg3.TextMatrix(1, 7)
        FrmPlanProduccion3.Fg1.TextMatrix(FrmPlanProduccion3.Fg1.Row, 11) = Fg3.TextMatrix(1, 8)
        FrmPlanProduccion3.Fg1.TextMatrix(FrmPlanProduccion3.Fg1.Row, 12) = Fg3.TextMatrix(1, 9)
        FrmPlanProduccion3.Fg1.TextMatrix(FrmPlanProduccion3.Fg1.Row, 13) = Fg3.TextMatrix(1, 10)
        FrmPlanProduccion3.Fg1.TextMatrix(FrmPlanProduccion3.Fg1.Row, 14) = Fg3.TextMatrix(1, 11)
        FrmPlanProduccion3.Fg1.TextMatrix(FrmPlanProduccion3.Fg1.Row, 15) = Fg3.TextMatrix(1, 12)
    End If
...
Private Sub CmdMas_Click()
    ' DECREMENTA EN 10 PIXEL EL ANCHO DE LAS COLUMNAS DEL CONTROL Fg2 Y Fg3
...
Private Sub CmdMenos_Click()
    ' INCREMENTA EN 10 PIXEL EL ANCHO DE LAS COLUMNAS DEL CONTROL Fg2 Y Fg3
    Fg2.ColWidth(1) = Fg2.ColWidth(1) + 10
    Fg2.ColWidth(2) = Fg2.ColWidth(2) + 10
    Fg2.ColWidth(3) = Fg2.ColWidth(3) + 10
    Fg2.ColWidth(4) = Fg2.ColWidth(4) + 10
...
'*****************************************************************************************************
'* Nombre Archivo   : SumarTotales
'* Tipo             : PROCEDIMIENTO
'* Descripcion      : SUMA LOS TOTALES DEL CONTROL Fg3
'* DISEÑADO POR     : ENRIQUE POLLONGO SIERRA
'* PARAMETROS       :
'* DEVUELVE         :
'*****************************************************************************************************
...
Private Sub Form_Activate()
    ...
    If SeEjecuto = False Then
        SeEjecuto = True
        Dim A As Integer
        RST_Busq Rst, "SELECT * FROM pro_estacionalidad ORDER BY descripcion", xCon
...
'*****************************************************************************************************
'* Nombre Archivo   : MuestraEstacionalidad
'* Tipo             : PROCEDIMIENTO
'* Descripcion      : MUESTRA LA ESTACIONALIDAD DEL PRODUCTO
'* DISEÑADO POR     : ENRIQUE POLLONGO SIERRA
'* PARAMETROS       : PARAMENTO    |  TIPO      |  DESCRIPCION
'*                    --------------------------------------------------------------------------------
'*                    xFila        |  Integer   |  ESPECIFICA EL ID DE LA FILA DEL CONTROL FLEXGRID
'* DEVUELVE         :
'*****************************************************************************************************
...
'*****************************************************************************************************
'* Nombre Archivo   : MostrarValoresEnEstacionalidad
'* Tipo             : PROCEDIMIENTO
'* Descripcion      : DISTRIBUYE LOS VALORES PARA EL ABASTECIMIENTO EN FUNCION A AL ESTACIONALIDAD
'* DISEÑADO POR     : ENRIQUE POLLONGO SIERRA
'* PARAMETROS       : PARAMENTO    |  TIPO      |  DESCRIPCION
'*                    --------------------------------------------------------------------------------
'*                    xFila        |  Integer   |  ID DE LA FILA DEL CONTROL Fg1
'* DEVUELVE         :
'*****************************************************************************************************
...
'*****************************************************************************************************
'* Nombre Archivo   : MuestraPlan
'* Tipo             : PROCEDIMIENTO
'* Descripcion      : MUESTRA EL PLAN DE PRODUCCION ACTIVO
'* DISEÑADO POR     : ENRIQUE POLLONGO SIERRA
'* PARAMETROS       :
'* DEVUELVE         :
'*****************************************************************************************************
Sub MuestraPlan()
    ...
    If Trim(TxtNumGrid.Text) = "2" Then
        LblProducto.Caption = FrmPlanProduccion3.Fg2.TextMatrix(FrmPlanProduccion3.Fg2.Row, 1)
        xTotal = 0
        Fg2.TextMatrix(1, 1) = FrmPlanProduccion3.Fg2.TextMatrix(FrmPlanProduccion3.Fg2.Row, 4)
        xTotal = xTotal + Val(Fg2.TextMatrix(1, 1))
        Fg2.TextMatrix(1, 2) = FrmPlanProduccion3.Fg2.TextMatrix(FrmPlanProduccion3.Fg2.Row, 5)
        xTotal = xTotal + Val(Fg2.TextMatrix(1, 2))
        Fg2.TextMatrix(1, 3) = FrmPlanProduccion3.Fg2.TextMatrix(FrmPlanProduccion3.Fg2.Row, 6)
        xTotal = xTotal + Val(Fg2.TextMatrix(1, 3))
        Fg2.TextMatrix(1, 4) = FrmPlanProduccion3.Fg2.TextMatrix(FrmPlanProduccion3.Fg2.Row, 7)
        xTotal = xTotal + Val(Fg2.TextMatrix(1, 4))
        Fg2.TextMatrix(1, 5) = FrmPlanProduccion3.Fg2.TextMatrix(FrmPlanProduccion3.Fg2.Row, 8)
        xTotal = xTotal + Val(Fg2.TextMatrix(1, 5))
        Fg2.TextMatrix(1, 6) = FrmPlanProduccion3.Fg2.TextMatrix(FrmPlanProduccion3.Fg2.Row, 9)
        xTotal = xTotal + Val(Fg2.TextMatrix(1, 6))
        Fg2.TextMatrix(1, 7) = FrmPlanProduccion3.Fg2.TextMatrix(FrmPlanProduccion3.Fg2.Row, 10)
        xTotal = xTotal + Val(Fg2.TextMatrix(1, 7))
        Fg2.TextMatrix(1, 8) = FrmPlanProduccion3.Fg2.TextMatrix(FrmPlanProduccion3.Fg2.Row, 11)
        xTotal = xTotal + Val(Fg2.TextMatrix(1, 8))
        Fg2.TextMatrix(1, 9) = FrmPlanProduccion3.Fg2.TextMatrix(FrmPlanProduccion3.Fg2.Row, 12)
        xTotal = xTotal + Val(Fg2.TextMatrix(1, 9))
        Fg2.TextMatrix(1, 10) = FrmPlanProduccion3.Fg2.TextMatrix(FrmPlanProduccion3.Fg2.Row, 13)
        xTotal = xTotal + Val(Fg2.TextMatrix(1, 10))
        Fg2.TextMatrix(1, 11) = FrmPlanProduccion3.Fg2.TextMatrix(FrmPlanProduccion3.Fg2.Row, 14)
        xTotal = xTotal + Val(Fg2.TextMatrix(1, 11))
        Fg2.TextMatrix(1, 12) = FrmPlanProduccion3.Fg2.TextMatrix(FrmPlanProduccion3.Fg2.Row, 15)
        xTotal = xTotal + Val(Fg2.TextMatrix(1, 12))
    Else
        LblProducto.Caption = FrmPlanProduccion3.Fg1.TextMatrix(FrmPlanProduccion3.Fg1.Row, 1)
        xTotal = 0
        Fg2.TextMatrix(1, 1) = FrmPlanProduccion3.Fg1.TextMatrix(FrmPlanProduccion3.Fg1.Row, 4)
        xTotal = xTotal + Val(Fg2.TextMatrix(1, 1))
        Fg2.TextMatrix(1, 2) = FrmPlanProduccion3.Fg1.TextMatrix(FrmPlanProduccion3.Fg1.Row, 5)
        xTotal = xTotal + Val(Fg2.TextMatrix(1, 2))
        Fg2.TextMatrix(1, 3) = FrmPlanProduccion3.Fg1.TextMatrix(FrmPlanProduccion3.Fg1.Row, 6)
        xTotal = xTotal + Val(Fg2.TextMatrix(1, 3))
        Fg2.TextMatrix(1, 4) = FrmPlanProduccion3.Fg1.TextMatrix(FrmPlanProduccion3.Fg1.Row, 7)
        xTotal = xTotal + Val(Fg2.TextMatrix(1, 4))
        Fg2.TextMatrix(1, 5) = FrmPlanProduccion3.Fg1.TextMatrix(FrmPlanProduccion3.Fg1.Row, 8)
        xTotal = xTotal + Val(Fg2.TextMatrix(1, 5))
        Fg2.TextMatrix(1, 6) = FrmPlanProduccion3.Fg1.TextMatrix(FrmPlanProduccion3.Fg1.Row, 9)
        xTotal = xTotal + Val(Fg2.TextMatrix(1, 6))
        Fg2.TextMatrix(1, 7) = FrmPlanProduccion3.Fg1.TextMatrix(FrmPlanProduccion3.Fg1.Row, 10)
        xTotal = xTotal + Val(Fg2.TextMatrix(1, 7))
        Fg2.TextMatrix(1, 8) = FrmPlanProduccion3.Fg1.TextMatrix(FrmPlanProduccion3.Fg1.Row, 11)
        xTotal = xTotal + Val(Fg2.TextMatrix(1, 8))
        Fg2.TextMatrix(1, 9) = FrmPlanProduccion3.Fg1.TextMatrix(FrmPlanProduccion3.Fg1.Row, 12)
        xTotal = xTotal + Val(Fg2.TextMatrix(1, 9))
        Fg2.TextMatrix(1, 10) = FrmPlanProduccion3.Fg1.TextMatrix(FrmPlanProduccion3.Fg1.Row, 13)
        xTotal = xTotal + Val(Fg2.TextMatrix(1, 10))
        Fg2.TextMatrix(1, 11) = FrmPlanProduccion3.Fg1.TextMatrix(FrmPlanProduccion3.Fg1.Row, 14)
        xTotal = xTotal + Val(Fg2.TextMatrix(1, 11))
        Fg2.TextMatrix(1, 12) = FrmPlanProduccion3.Fg1.TextMatrix(FrmPlanProduccion3.Fg1.Row, 15)
        xTotal = xTotal + Val(Fg2.TextMatrix(1, 12))
    End If
