...
Sub CargaTerminados(Indice As Integer)
    ...
    If RstPro.RecordCount <> 0 Then
        ...
        For A = 1 To RstPro.RecordCount
            ...
            Fg5(Indice).TextMatrix(A, 5) = Format(RstPro("stckini"), FORMAT_MONTO)
...
Sub CargarIntermedios(Indice As Integer)
    ...
    If RstPro.RecordCount <> 0 Then
        ...
        For A = 1 To RstPro.RecordCount
            ...
            Fg6(Indice).TextMatrix(A, 5) = Format(RstPro("stckini"), FORMAT_MONTO)
            ...
            If RstTmp.RecordCount <> 0 Then
                Fg6(Indice).TextMatrix(A, 6) = Format(NulosN(RstTmp("SumaDecantidad")), FORMAT_MONTO)
            Else
                Fg6(Indice).TextMatrix(A, 6) = 0
            End If
