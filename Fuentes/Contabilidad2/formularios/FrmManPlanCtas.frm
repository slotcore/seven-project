   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManPlanCtas.frx":0A5A
            Key             =   "IMG3"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManPlanCtas.frx":0EAE
            Key             =   "IMG4"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManPlanCtas.frx":0FC6
            Key             =   "IMG5"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManPlanCtas.frx":150A
            Key             =   "IMG6"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManPlanCtas.frx":1A4E
            Key             =   "IMG7"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManPlanCtas.frx":1B62
            Key             =   "IMG8"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManPlanCtas.frx":1C76
            Key             =   "IMG9"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManPlanCtas.frx":20CA
            Key             =   "IMG10"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManPlanCtas.frx":2236
            Key             =   "IMG11"
         EndProperty
      EndProperty
   End
   Begin SizerOneLibCtl.TabOne TabOne1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.Frame Frame3 
            ...
            Begin VB.CommandButton cb 
               ...
               Index           =   2
               Left            =   3645
               Picture         =   "FrmManPlanCtas.frx":277E
               Style           =   1  'Graphical
               TabIndex        =   23
               Top             =   2790
               Visible         =   0   'False
            ...
            Begin VB.CommandButton cb 
               ...
               Index           =   0
               Left            =   3645
               Picture         =   "FrmManPlanCtas.frx":28B0
               Style           =   1  'Graphical
               TabIndex        =   21
               Top             =   2010
               Width           =   225
            ...
            Begin VB.CommandButton cb 
               ...
               Index           =   1
               Left            =   3645
               Picture         =   "FrmManPlanCtas.frx":29E2
               Style           =   1  'Graphical
               TabIndex        =   22
               Top             =   2415
               Width           =   225
            ...
            Begin VB.CommandButton CmdBusDesHaber 
               Height          =   240
               Left            =   3645
               Picture         =   "FrmManPlanCtas.frx":2B14
               Style           =   1  'Graphical
               TabIndex        =   20
               Top             =   1635
               Width           =   240
            ...
            Begin VB.CommandButton CmdBusDesDebe 
               Height          =   240
               Left            =   3645
               Picture         =   "FrmManPlanCtas.frx":2C46
               Style           =   1  'Graphical
               TabIndex        =   19
               Top             =   1275
               Width           =   240
      ...
      Begin VB.Frame Frame1 
         ...
         Begin TrueOleDBGrid70.TDBGrid Dg1 
            ...
            Columns(0).Caption=   "Nº Cuenta"
            Columns(0).DataField=   "cuenta"
            ...
            Columns(2).Caption=   "Dest. Debe"
            Columns(2).DataField=   "ctadeb"
            Columns(2)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
            Columns(3)._VlistStyle=   0
            Columns(3)._MaxComboItems=   5
            Columns(3).Caption=   "Dest. Haber"
            Columns(3).DataField=   "ctahab"
            Columns(3)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
            Columns(4)._VlistStyle=   0
            Columns(4)._MaxComboItems=   5
            Columns(4).Caption=   "Distribución"
            Columns(4).DataField=   "des"
            Columns(4)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
            Columns(5)._VlistStyle=   0
            Columns(5)._MaxComboItems=   5
            Columns(5).Caption=   "2da Distribución"
            Columns(5).DataField=   "des2"
            ...
            Splits(0)._ColumnProps(7)=   "Column(1).Width=7620"
            Splits(0)._ColumnProps(8)=   "Column(1).DividerColor=0"
            Splits(0)._ColumnProps(9)=   "Column(1)._WidthInPix=7541"
            ...
            Splits(0)._ColumnProps(19)=   "Column(3).Width=2011"
            Splits(0)._ColumnProps(20)=   "Column(3).DividerColor=0"
            Splits(0)._ColumnProps(21)=   "Column(3)._WidthInPix=1931"
...
Private Sub Dg1_HeadClick(ByVal ColIndex As Integer)
    ...
    RstCta.Sort = CStr(Dg1.Columns(ColIndex).DataField)
    Err.Clear
...
Private Sub Form_Activate()
    If SeEjecuto = False Then
        ...
        RST_Busq RstCta, "SELECT con_planctas.*, con_planctas_1.cuenta AS ctadeb, con_planctas_1.descripcion AS desctadeb, con_planctas_2.cuenta AS ctahab, con_planctas_2.descripcion AS desctahab, con_planctasdes.descripcion AS des, con_planctasdes_1.descripcion AS des2, con_planctasdes_2.descripcion AS des3 " _
        ...
        If RstCta.RecordCount = 0 Then
            Rpta = MsgBox("No se han detectado registros en el Plan de Cuentas ¿Desea agregar uno ahora?", vbInformation + vbOKOnly + vbDefaultButton1, xTitulo)
            If Rpta = vbYes Then
                Nuevo
            Else
                Set RstCta = Nothing
...
On Error GoTo LaCague
    ...
    If QueHace = 1 Then
        ...
        RST_Busq RstCab, "SELECT * FROM con_planctas", xCon
        RstCab.AddNew
        RstCab("id") = xId
    Else
        xId = RstCta("id")
...
Sub Eliminar()
    ...
    If Rpta = vbYes Then
        ...
        MsgBox "La cuenta contable se elimino con exito", vbInformation + vbOKOnly + vbDefaultButton1, xTitulo
        RstCta.Requery
        Dg1.Refresh
    End If
End Sub
...
Private Function VALIDAR_DATOS() As Boolean
    ...
    If QueHace <> 1 Then
        ...
        If RstTmp.EOF = False Or RstTmp.BOF = False Or RstTmp.RecordCount <> 0 Then
            MsgBox "La Cuenta Contable tiene Divisionaria" + vbCr + "Modifique las Divisionarias primero", vbExclamation, xTitulo
            Set RstTmp = Nothing
            Exit Function
        End If
    End If
