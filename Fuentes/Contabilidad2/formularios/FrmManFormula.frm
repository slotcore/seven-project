...
'*****************************************************************************************************
'* Nombre Archivo   : FRMMANFORMULA.FRM
'* Tipo             : FORMULARIO
'* Descripcion      : FORMULARIO QUE PERMITE GENERAR Y PROBAR FORMULAS PARA LOS ESTADOS FINANCIERO
'* DISEÑADO POR     : ENRIQUE POLLONGO SIERRA
'* ULTIMA REVISION  : 27/10/09
'* VERSION          : 1.0
'*****************************************************************************************************
'Option Explicit            ' ESTA LINEA SE COMENTO PORQUE EN EL PROCEDIMIENTO RECIBE_LINK_FRM SE DECLARO UNA VARIABLE DEL TIPO
                            ' INDEX LA CUAL NO ESTA DECLARADA EN NINGUN LADO
...
'*                    --------------------------------------------------------------------------------
'*                    GridTmp       |  VSFlexGrid  |  CONTIENE LOS REGISTROS A MOSTRAR EN EL GRID
'*                    GridFormula   |  VSFlexGrid  |  CONTIENE EL REGISTRO DE LA FORMULA(SE USARA
'*                                                    CUANDO SE GENERE LA FORMULA, SE ALMACENARA EN LA
'*                                                    POSICION DE LA FORMULA SEGUN (Q_ROW,Q_COL))
'*                    Q_ROW         |  Long        |  VALORES DE GridFormula
'*                    Q_COL         |  Long        |  VALORES DE GridFormula
'*                    FORMULA       |  String      |  FORMULA QUE SE EVALUARA
'*                    N_CAPTION     |  String      |  TEXTO A MOSTRAR EN EL TITULO DEL FORM.
'*                    COL_ID        |  Integer     |  COLUMNAS A MOSTRAR EN EL GRID, DEPENDE DE GridTmp
'*                    COL_VALOR     |  Integer     |  COLUMNAS A MOSTRAR EN EL GRID, DEPENDE DE GridTmp
'*                    SOLO_CTA      |  Boolean     |  FALSE = CARGAR TODOS LOS REGISTROS DE GridTmp
...
'*****************************************************************************************************
'* Nombre           : ARMAR_FORMULA
'* Tipo             : PROCEDIMIENTO
'* Descripcion      : ESTA FUNCION CREARA LA FORMULA EN FUNCION A LA CADENA DE ID'S
'* Paranetros       :
'* Devuelve         :
'*****************************************************************************************************
