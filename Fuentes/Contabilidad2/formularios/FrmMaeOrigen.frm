...
Begin VB.Form FrmMaeOrigen 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Contabilidad - Origen de Movimientos"
   ClientHeight    =   7170
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   11685
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmMaeOrigen.frx":0000
            Key             =   "IMG1"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmMaeOrigen.frx":0544
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmMaeOrigen.frx":08D6
            Key             =   "IMG2"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmMaeOrigen.frx":0A5A
            Key             =   "IMG3"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmMaeOrigen.frx":0EAE
            Key             =   "IMG4"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmMaeOrigen.frx":0FC6
            Key             =   "IMG5"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmMaeOrigen.frx":150A
            Key             =   "IMG6"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmMaeOrigen.frx":1A4E
            Key             =   "IMG7"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmMaeOrigen.frx":1B62
            Key             =   "IMG8"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmMaeOrigen.frx":1C76
            Key             =   "IMG9"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmMaeOrigen.frx":20CA
            Key             =   "IMG10"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmMaeOrigen.frx":2236
            Key             =   "IMG11"
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmMaeOrigen.frx":277E
            Key             =   ""
         EndProperty
      EndProperty
   End
      ...
      BeginProperty Buttons {66833FE8-8583-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Button3 {66833FEA-8583-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ButtonMenus {66833FEC-8583-11D1-B16A-00C0F0283628} 
               NumButtonMenus  =   2
               BeginProperty ButtonMenu1 {66833FEE-8583-11D1-B16A-00C0F0283628} 
                  Text            =   "Eliminar Origen"
               EndProperty
               BeginProperty ButtonMenu2 {66833FEE-8583-11D1-B16A-00C0F0283628} 
                  Text            =   "Desactivar Origen"
               EndProperty
            EndProperty
         EndProperty
   ...
   Begin SizerOneLibCtl.TabOne TabOne1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin TrueOleDBGrid70.TDBGrid Dg1 
            ...
            Splits(0)._ColumnProps(7)=   "Column(1).Width=6138"
            Splits(0)._ColumnProps(8)=   "Column(1).DividerColor=0"
            Splits(0)._ColumnProps(9)=   "Column(1)._WidthInPix=6059"
            Splits(0)._ColumnProps(10)=   "Column(1)._EditAlways=0"
            Splits(0)._ColumnProps(11)=   "Column(1)._ColStyle=512"
            Splits(0)._ColumnProps(12)=   "Column(1).Order=2"
            Splits(0)._ColumnProps(13)=   "Column(2).Width=820"
            Splits(0)._ColumnProps(14)=   "Column(2).DividerColor=0"
            Splits(0)._ColumnProps(15)=   "Column(2)._WidthInPix=741"
            ...
            Splits(0)._ColumnProps(25)=   "Column(4).Width=6191"
            Splits(0)._ColumnProps(26)=   "Column(4).DividerColor=0"
            Splits(0)._ColumnProps(27)=   "Column(4)._WidthInPix=6112"
            ...
            Splits(0)._ColumnProps(37)=   "Column(6).Width=1191"
            Splits(0)._ColumnProps(38)=   "Column(6).DividerColor=0"
            Splits(0)._ColumnProps(39)=   "Column(6)._WidthInPix=1111"
         ...
         Begin VB.Label Label2 
            Alignment       =   2  'Center
            Caption         =   "Mantenimiento de Origenes"
            BeginProperty Font 
               Name            =   "Courier New"
               Size            =   11.25
               Charset         =   0
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.Frame Frame3 
            ...
            Begin VSFlex7Ctl.VSFlexGrid Fg1 
               ...
               FormatString    =   $"FrmMaeOrigen.frx":310A
               ScrollTrack     =   0   'False
               ScrollBars      =   3
               ScrollTips      =   0   'False
               MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "FrmMaeOrigen"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'*****************************************************************************************************
'* Nombre Archivo   : FRMMAEORIGEN.FRM
'* Tipo             : FORMULARIO
'* Descripcion      : PERMITE LAS ALTAS Y BAJAS EN LA TABLA tes_origen
...
Dim RstDes As New ADODB.Recordset    ' RECORDSET QUE ALMACENARA LOS DATOS DE LA TABLA tes_origen
...
Public TipoMovimmiento As Integer    ' ESPECIFICA EL TIPO DE ORIGEN QUE SE ESTA CONSULTANDO EN EL FORMULARIO
                                     ' 1 = INGRESO
                                     ' 2 = EGRESO
...
Private Sub CmdAdd_Click()
    ...
    If xRs.State = 1 Then
        ...
        Else
            MsgBox "El documento seleccionado ya fue agregado al origen", vbInformation + vbOKOnly + vbDefaultButton1, xTitulo
...
Private Sub CmdEnt_Click()
    ' EJECUTA LA BUSQUEDA DE UN MODULO
    If QueHace = 3 Then Exit Sub
...
Private Sub Form_Activate()
    ...
    '            Se considera la variable TipoMovimmiento = 1 (Idmenu = 128)
    '                                     TipoMovimmiento = 2 (Idmenu = 129)
    ...
    If SeEjecuto = False Then
        ...
        If TipoMovimmiento = 1 Then Label1.Caption = "Detalle Origen del Ingreso"
        If TipoMovimmiento = 2 Then Label1.Caption = "Detalle Origen del Egreso"
        
        nSQL = "SELECT tes_origen.*, con_planctas.cuenta, con_planctas.descripcion AS desccta, mae_tipomov.descripcion AS destipmov, mae_moneda.simbolo, mae_moneda.descripcion AS desmon, tes_modulos.descripcion AS descmodulo, IIf([activo]=-1,'Activo','Desactivo') AS activo1, IIf([tes_origen].[detallar]=-1,'Si','No') AS detallar1,  mae_banconumcta.numcue, mae_bancos.descripcion AS banco " _
            + vbCr + " FROM ((mae_tipomov RIGHT JOIN (mae_moneda RIGHT JOIN (con_planctas RIGHT JOIN tes_origen ON con_planctas.id = tes_origen.idcuen) ON mae_moneda.id = tes_origen.idmon) ON mae_tipomov.id = tes_origen.tipmov) LEFT JOIN tes_modulos ON tes_origen.idmod = tes_modulos.id) LEFT JOIN (mae_bancos RIGHT JOIN mae_banconumcta ON mae_bancos.id = mae_banconumcta.idban) ON tes_origen.idbcocta = mae_banconumcta.id " _
            + vbCr + " Where (((tes_origen.tipmov) = " & TipoMovimmiento & ")) " _
            + vbCr + " ORDER BY tes_origen.descripcion;"

        RST_Busq RstDes, nSQL, xCon

        Set Dg1.DataSource = RstDes
        If RstDes.RecordCount = 0 Then
            Rpta = MsgBox("No se han registrado registros para los origens, ¿Desea agregar uno ahora?", vbQuestion + vbYesNo + vbDefaultButton1, xTitulo)
            If Rpta = vbYes Then
                Nuevo
            Else
                Set RstDes = Nothing
...
'* Nombre           : Bloquea
'* Tipo             : PROCEDIMIENTO
'* Descripcion      : ACTIVA O DESACTIVA LOS COTROLES TEXTBOX
'* Paranetros       :
'* Devuelve         :
'*****************************************************************************************************
Sub Bloquea()
...
Sub Nuevo()
    ...
    If TipoMovimmiento = 1 Then Label1.Caption = "Agregando Origen del Ingreso"
    If TipoMovimmiento = 2 Then Label1.Caption = "Agregando Origen del Egreso"
    ...
    TxtId.Text = HallaCodigoTabla("tes_origen", xCon, "id")
...
Sub Anular()
    ...
    Rpta = MsgBox("¿Esta seguro de anular el origen?", vbQuestion + vbYesNo + vbDefaultButton1, xTitulo)
    If Rpta = vbYes Then
        xCon.Execute "UPDATE tes_origen SET tes_origen.activo = 0 WHERE (((tes_origen.id)=" & NulosN(RstDes("id")) & "))"
        
        'grabamos el movimiento en la tabla var_edicion
        GrabarOperacion xIdUsuario, IdMenuActivo, 2, Time, Time, Date, xCon, NulosN(RstDes("id"))
        
        
        MsgBox "El origen se anulo con exito", vbInformation + vbOKOnly + vbDefaultButton1
        RstDes.Requery
        Exit Sub
    End If
End Sub
...
'* Nombre           : Activar
'* Tipo             : PROCEDIMIENTO
'* Descripcion      : ACTIVA UN REGISTRO DE LA TABLA tes_origen PARA ELLO PONE A -1 EL CAMPO activo
'* Paranetros       :
'* Devuelve         :
'*****************************************************************************************************
Sub Activar()
    ...
    Rpta = MsgBox("¿Esta seguro de activar el origen?", vbQuestion + vbYesNo + vbDefaultButton1, xTitulo)
    If Rpta = vbYes Then
        xCon.Execute "UPDATE tes_origen SET tes_origen.activo = -1 WHERE (((tes_origen.id)=" & NulosN(RstDes("id")) & "))"
        
        'grabamos el movimiento en la tabla var_edicion
        GrabarOperacion xIdUsuario, IdMenuActivo, 2, Time, Time, Date, xCon, NulosN(RstDes("id"))
        
        MsgBox "El origen se activo con exito", vbInformation + vbOKOnly + vbDefaultButton1
        RstDes.Requery
        Exit Sub
    End If
End Sub
...
'* Nombre           : Grabar
'* Tipo             : FUNCION
'* Descripcion      : GRABA UN REGISTRO EN LA TABLA tes_origen, ESTA FUNCION DEVUELVE VERDADERO
'*                    CUANDO TIENE EXITO
'* Paranetros       :
'* Devuelve         : Boolean
'*****************************************************************************************************
Function Grabar() As Boolean
    ...
    If NulosC(TxtDescripcion.Text) = "" Then
        MsgBox "No ha especificado la descripcion del origen", vbInformation + vbOKOnly + vbDefaultButton1, xTitulo
        TxtDescripcion.SetFocus
        Exit Function
    End If

    If NulosC(TxtCuenta.Text) = "" Then
        MsgBox "No ha especificado la cuenta contable para el origen", vbInformation + vbOKOnly + vbDefaultButton1, xTitulo
        TxtCuenta.SetFocus
        Exit Function
    End If

    If NulosC(TxtIdMon.Text) = "" Then
        MsgBox "No ha especificado la moneda del origen", vbInformation + vbOKOnly + vbDefaultButton1, xTitulo
        TxtIdMon.SetFocus
        Exit Function
    End If

    If NulosC(TxtEntGen.Text) = "" Then
        MsgBox "No ha especificado la entidad generadora para el origen", vbInformation + vbOKOnly + vbDefaultButton1, xTitulo
        TxtEntGen.SetFocus
        Exit Function
    End If
...
On Error GoTo LaCague
    ...
    xCon.BeginTrans
    If QueHace = 1 Then
        ' SI ES UN NUEVO REGISTRO OBTENEMOS EL ULTIMO ID DE LA TABLA tes_origen
        xId = HallaCodigoTabla("tes_origen", xCon, "id")
        RST_Busq RstCab, "SELECT * FROM tes_origen", xCon
        RST_Busq RstDet, "SELECT * FROM tes_origendoc", xCon
        RstCab.AddNew
        RstCab("id") = xId
    Else
        ' SI SE ESTA MODIFICANDO UN REGISTRO OBTENEMOS EL ID DEL REGISTRO ACTUAL
        xId = RstDes("id")
        RST_Busq RstCab, "SELECT * FROM tes_origen WHERE id = " & xId & "", xCon
        xCon.Execute "DELETE * FROM tes_origendoc WHERE id = " & xId & ""
        RST_Busq RstDet, "SELECT * FROM tes_origendoc", xCon
    End If
    ...
    ' GRABAMOS LOS DOCUMENTOS REFERENTES AL ORIGEN
    For A = 1 To Fg1.Rows - 1
        RstDet.AddNew
        RstDet("id") = xId
    ...
    '--Actualizar en Tesoreria origen para ingresos y egresos
    xCon.Execute "UPDATE tes_cajaori SET tes_cajaori.idbcocta = " & NulosN(LblIdBcoCta.Caption) & " WHERE (((tes_cajaori.idori)=" & xId & ")) "
    ...
    xCon.CommitTrans
    Grabar = True
    MsgBox "El origen se grabo con exito ", vbInformation + vbOKOnly + vbDefaultButton1, xTitulo
    Exit Function

LaCague:
    xCon.RollbackTrans
    Set RstCab = Nothing:    Set RstDet = Nothing
    MsgBox "No se pudo guardar el origen por el siguiente motivo : " + Err.Description
    Grabar = False
End Function
...
'* Nombre           : Eliminar
'* Tipo             : PROCEDIMIENTO
'* Descripcion      : ELIMINA UN REGISTRO DE LA TABLA tes_origen
'* Paranetros       :
'* Devuelve         :
'*****************************************************************************************************
Sub Eliminar()
    ...
    CadSql = "SELECT tes_cajaori.idori FROM tes_cajaori WHERE (((tes_cajaori.idori)=" & xId & "));"
    RST_Busq Rst, CadSql, xCon
    If Rst.RecordCount <> 0 Then
        MsgBox "No se puede eliminar el Origen porque tiene datos relacionados con el módulo de Caja y Bancos", vbInformation + vbOKOnly + vbDefaultButton1, xTitulo
        Set Rst = Nothing
        Exit Sub
    End If
    Set Rst = Nothing
    
    Rpta = MsgBox("¿Esta seguro de eliminar el origen seleccionado?", vbQuestion + vbYesNo + vbDefaultButton1, xTitulo)
    
    If Rpta = vbYes Then
        'buscamos que el origen no tenga movimientos en la tabla con_cajabanco, con_ctasrendir, con_devoluciones
...
'        If Rst.RecordCount <> 0 Then
'            MsgBox "No se puede eliminar el origen porque tiene datos relacionados con el modulo de Cargas a Rendir", vbInformation + vbOKOnly + vbDefaultButton1, xTitulo
'            Set Rst = Nothing
'            Exit Sub
'        End If
'        Set Rst = Nothing
...
'        Set Rst = BuscaConCriterio(CadSql, xCon)
'        If Rst.RecordCount <> 0 Then
'            MsgBox "No se puede eliminar el origen porque tiene datos relacionados con el modulo de Rendir Cuentas ", vbInformation + vbOKOnly + vbDefaultButton1, xTitulo
'            Set Rst = Nothing
'            Exit Sub
'        End If
'        Set Rst = Nothing

        xCon.Execute "DELETE * FROM tes_origen WHERE id = " & RstDes("id") & ""
        ...
        RstDes.Requery
        Dg1.Refresh
        MsgBox "El origen se elimino con exito", vbInformation + vbOKOnly + vbDefaultButton1, xTitulo
    End If
End Sub
...
Sub Modificar()
    ...
    If TipoMovimmiento = 1 Then Label1.Caption = "Modificando Origen del Ingreso"
    If TipoMovimmiento = 2 Then Label1.Caption = "Modificando Origen del Egreso"
...
Sub MuestraSegundoTab()
    ...
    Dim xRs As New ADODB.Recordset
    Dim A As Integer
    RST_Busq xRs, "SELECT mae_documento.id AS iddoc, mae_documento.descripcion, mae_documento.abrev, tes_origendoc.id FROM tes_origendoc LEFT JOIN mae_documento " _
        & " ON tes_origendoc.iddoc = mae_documento.id WHERE (((tes_origendoc.id) = " & NulosN(TxtId.Text) & "))", xCon
...
'* Nombre           : pExportar
'* Tipo             : PROCEDIMIENTO
'* Descripcion      : EXPORTA MS EXCEL LOS DATOS DEL RECORDSET RstDes
'* Paranetros       :
'* Devuelve         :
'*****************************************************************************************************
Private Sub pExportar()
    ...
    oExport.VSFlexGrid_Exportar_MSExcel xCon, , "Origen - " & LblTipo.Caption, "", "", "Origen - " & LblTipo.Caption, Rst, xCampos
    Set oExport = Nothing
    Set Rst = Nothing
    Dg1.Refresh
End Sub
