...
'*****************************************************************************************************
'* Nombre Archivo   : FUNCIONES.BAS
'* Tipo             : MODULO
'* Descripcion      : MODULO DONDE SE DECLARAN FUNCIONES QUE SERAN UTILIZADAS EN TODA LA CLASE
...
'*****************************************************************************************************
'* Nombre           : CargarTMPBalance
'* Tipo             : FUNCCION
'* Descripcion      : LLENA CON DATOS UN RECORDSET CON LOS DATOS DE UN BALANCE ESPECIFICADO, ESTA
'*                    FUNCION DEVUELVE EL RECORDSET PASADO CON LOS NUEVOS DATOS
'* Paranetros       : NOMBRE          |  TIPO            |  DESCRIPCION
'*                    --------------------------------------------------------------------------------
'*                    xFchIni         |  String          |  ESPECIFICA LA FECHA DE INICIO
'*                    xFchFin         |  String          |  ESPECIFICA LA FECHA FINAL
'*                    xCodigoBalance  |  Integer         |  ESPECIFICA EL CODIGO DE BALANCE QUE SE
'*                                                          APLICARA
'*                    Rst             | ADODB.Recordset  |  ESPECIFICA EL RECORDSET AL QUE SE LE
'*                                                          AÑADIRA LOS DATOS QUE GENERE LA FUNCION
'* Devuelve         : ADODB.Recordset
'*****************************************************************************************************
Function CargarTMPBalance(xFchIni As String, xFchFin As String, xCodigoBalance As Integer, Rst As ADODB.Recordset) As ADODB.Recordset
    ...
    ' cargamos los movimientos del periodo EN UNA TABLA PIVOT
    ...
    ' cargamos los saldos EN UNA TABLA PIVOT
...
'*****************************************************************************************************
'* Nombre           : EjecutarFormula
'* Tipo             : PROCEDIMIENTO
'* Descripcion      : EJECUTA LAS FORMULAS PARA CALCULAR LOS DATOS DEL BALANCE
'* Paranetros       : NOMBRE    |  TIPO             |  DESCRIPCION
'*                    --------------------------------------------------------------------------------
'*                    FORMULA   |  String           |  ESPECIFICA LA FORMULA QUE SE EJECUTARA
'*                    Rst       |  ADODB.Recordset  |  ESPECICA EL RECORDSET CON LOS DATOS A PROCESAR
'* Devuelve         : Double
'*****************************************************************************************************
