...
Begin VB.Form FrmManCotizacion 
   Caption         =   "Compras - Cotizacion de Compra"
   ClientHeight    =   7605
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11880
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManCotizacion.frx":0000
            Key             =   "IMG1"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManCotizacion.frx":0544
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManCotizacion.frx":08D6
            Key             =   "IMG2"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManCotizacion.frx":0A5A
            Key             =   "IMG3"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManCotizacion.frx":0EAE
            Key             =   "IMG4"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManCotizacion.frx":0FC6
            Key             =   "IMG5"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManCotizacion.frx":150A
            Key             =   "IMG6"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManCotizacion.frx":1A4E
            Key             =   "IMG7"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManCotizacion.frx":1B62
            Key             =   "IMG8"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManCotizacion.frx":1C76
            Key             =   "IMG9"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManCotizacion.frx":20CA
            Key             =   "IMG10"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmManCotizacion.frx":2236
            Key             =   "IMG11"
         EndProperty
      EndProperty
   End
   Begin SizerOneLibCtl.TabOne TabOne1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.Label Label4 
            Alignment       =   2  'Center
            Caption         =   "Consulta de Cotizacion"
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   12
               Charset         =   0
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton cmd 
            ...
            Index           =   0
            Left            =   2190
            Picture         =   "FrmManCotizacion.frx":277E
            Style           =   1  'Graphical
            TabIndex        =   64
            Top             =   510
            Width           =   240
         ...
         Begin VB.CommandButton CmdBusMon 
            Height          =   240
            Left            =   2175
            Picture         =   "FrmManCotizacion.frx":28B0
            Style           =   1  'Graphical
            TabIndex        =   57
            Top             =   1155
            Width           =   240
         ...
         Begin VB.CommandButton CmdBusTipDoc 
            Height          =   240
            Left            =   2175
            Picture         =   "FrmManCotizacion.frx":29E2
            Style           =   1  'Graphical
            TabIndex        =   54
            Top             =   1470
            Width           =   240
         ...
         Begin VB.CommandButton CmdBusAutoriza 
            Height          =   240
            Left            =   11205
            Picture         =   "FrmManCotizacion.frx":2B14
            Style           =   1  'Graphical
            TabIndex        =   51
            Top             =   2805
            Width           =   240
         ...
         Begin VB.CommandButton CmdBusContacto 
            Height          =   240
            Left            =   5440
            Picture         =   "FrmManCotizacion.frx":2C46
            Style           =   1  'Graphical
            TabIndex        =   46
            Top             =   2460
            Width           =   240
         ...
         Begin VB.CommandButton CmdBusTipoCompra 
            Height          =   240
            Left            =   2175
            Picture         =   "FrmManCotizacion.frx":2D78
            Style           =   1  'Graphical
            TabIndex        =   15
            Top             =   840
            Width           =   240
         ...
         Begin VB.CommandButton CmdBusCondicion 
            Height          =   240
            Left            =   2175
            Picture         =   "FrmManCotizacion.frx":2EAA
            Style           =   1  'Graphical
            TabIndex        =   17
            Top             =   3090
            Width           =   240
         ...
         Begin VB.CommandButton CmdBusProv 
            Height          =   240
            Left            =   2635
            Picture         =   "FrmManCotizacion.frx":2FDC
            Style           =   1  'Graphical
            TabIndex        =   16
            Top             =   2145
            Width           =   240
         ...
         Begin VSFlex7Ctl.VSFlexGrid Fg1 
            ...
            FormatString    =   $"FrmManCotizacion.frx":310E
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "FrmManCotizacion"
...
Dim RstOrd As New ADODB.Recordset     ' RECORDSET QUE ALMACENARA Y MOSTRARA LOS REGISTROS DE LA TABLA com_cotizacion
...
Private Sub CmdAprobada_Click()
    ' APRUEBA UNA ORDEN DE COMPRA ACTUALIZANDO A 2 EL CAMPO idest DE LA TABLA com_cotizacion
    LblIdEstado.Caption = "2"
    LblEstado.ForeColor = &H8000&
    LblEstado = "Aprobada"
    
    xCon.Execute "UPDATE com_cotizacion SET com_cotizacion.idest = " & Val(LblIdEstado.Caption) & " WHERE (com_cotizacion.id = " & RstOrd("id") & ")"
    RstOrd.Requery
    Dg1.Refresh
End Sub
...
Private Sub CmdRecha_Click()
    ' ACTUALIZA A RECHAZADO UNA ORDEN DE COMPRA, PARA ELLO ACTUALIZA EL CAMPO idest A 4 DE LA TABLA com_cotizacion
...
Sub pCargarDatos()
    ...
    cSQL = "SELECT mae_prov.nombre AS nomprov, mae_prov.numruc, mae_tipoproducto.descripcion AS desctipcom, mae_estadoordcom.descripcion AS descestado, mae_moneda.simbolo AS moneda, mae_condpago.descripcion AS descconpag, mae_documento.descripcion AS desctipdoc, mae_moneda.descripcion AS descmon, com_cotizacion.*, UCase([pla_empleados]![apepat] & ' ' & [pla_empleados]![apemat]) & ', ' & [pla_empleados]![nom] AS apenomaut " _
            + vbCr + "FROM mae_moneda RIGHT JOIN (mae_tipoproducto RIGHT JOIN (mae_estadoordcom RIGHT JOIN (mae_prov RIGHT JOIN (((com_cotizacion LEFT JOIN mae_condpago ON com_cotizacion.idconpag = mae_condpago.id) LEFT JOIN mae_documento ON com_cotizacion.idtipdoc = mae_documento.id) LEFT JOIN pla_empleados ON com_cotizacion.idaut = pla_empleados.id) ON mae_prov.id = com_cotizacion.idpro) ON mae_estadoordcom.id = com_cotizacion.idest) ON mae_tipoproducto.id = com_cotizacion.idtippro) ON mae_moneda.id = com_cotizacion.idmon " _
            + vbCr + "WHERE (((com_cotizacion.ano) = " & AnoTra & ") And ((com_cotizacion.idmes) = " & mMesActivo & ")) " _
            + vbCr + "ORDER BY com_cotizacion.fchemi DESC"
...
Sub MuestraSegundoTab()
    ...
    TxtFchVen.Valor = Empty 'RstOrd("fchven")
    ...
    LblTipoCompra.Caption = NulosC(RstOrd("desctipcom"))
    ...
    Dim xCad As String
    Dim A As Integer
    xCad = "SELECT com_cotizaciondet.*, alm_inventario.descripcion, mae_unidades.abrev, alm_inventario.idcuenta, " _
        & " alm_inventario.idtipcom FROM mae_unidades RIGHT JOIN (alm_inventario RIGHT JOIN com_cotizaciondet " _
        & " ON alm_inventario.id = com_cotizaciondet.iditem) ON mae_unidades.id = com_cotizaciondet.idunimed " _
        & " WHERE (((com_cotizaciondet.idcom)=" & RstOrd("id") & "))"
...
Sub Nuevo()
    ...
    Fg1.Editable = flexEDKbdMouse
    Fg1.SelectionMode = flexSelectionFree
    'LblNumero.Caption = Format(HallaCodigoTabla("com_cotizacion", xCon, "id"), "000000")
    TxtTipCom.SetFocus
End Sub
...
Private Sub menu2_1_Click()
    If RstOrd("idest") = 3 Then
        ...
        Exit Sub
    End If
    xCon.Execute "UPDATE com_cotizacion SET com_cotizacion.idest = 2 WHERE (com_cotizacion.id = " & RstOrd("id") & ")"
    RstOrd.Requery
    Dg1.Refresh
End Sub
...
Private Sub menu2_3_Click()
    If RstOrd("idest") = 3 Then
        ...
        Exit Sub
    End If
    xCon.Execute "UPDATE com_cotizacion SET com_cotizacion.idest = 4 WHERE (com_cotizacion.id = " & RstOrd("id") & ")"
    RstOrd.Requery
    Dg1.Refresh
End Sub
...
Private Sub Toolbar1_ButtonClick(ByVal Button As MSComctlLib.Button)
    ...
    If Button.Index = 13 Then ImprimirOrden
...
Sub ImprimirOrden()
    ...
    RST_Busq Rst, "SELECT com_cotizaciondet.*, alm_inventario.descripcion, mae_unidades.abrev, alm_inventario.idcuenta, " _
        & " alm_inventario.idtipcom FROM mae_unidades RIGHT JOIN (alm_inventario RIGHT JOIN com_cotizaciondet " _
        & " ON alm_inventario.id = com_cotizaciondet.iditem) ON mae_unidades.id = com_cotizaciondet.idunimed  " _
        & " WHERE (((com_cotizaciondet.idcom)=" & RstOrd("id") & "))", xCon
...
Sub Buscar()
    ...
    xform.SQLCad = "SELECT mae_prov.nombre AS nomprov, mae_prov.numruc, mae_trabajadores.apellnom, com_cotizacion.id " _
        & " FROM mae_trabajadores RIGHT JOIN (mae_prov RIGHT JOIN com_cotizacion ON mae_prov.id = com_cotizacion.idpro) " _
        & " ON mae_trabajadores.id = com_cotizacion.idaut ORDER BY mae_trabajadores.apellnom, com_cotizacion.id"
...
'* Nombre           : Eliminar
'* Tipo             : PROCEDIMIENTO
'* Descripcion      : ELIMINA UN REGISTRO DE LA TABLA com_cotizacion
'* Paranetros       :
'* Devuelve         :
'*****************************************************************************************************
Sub Eliminar()
    ...
    If Rpta = vbYes Then
        TabOne1.CurrTab = 0
        xCon.Execute "DELETE * FROM com_cotizacion WHERE id = " & RstOrd("id") & ""
...
Private Sub TxtNumSer_Validate(Cancel As Boolean)
    ...
    If NulosC(TxtNumSer.Text) <> "" Then
        ...
        RST_Busq RstNumOrden, "SELECT com_cotizacion.numser, com_cotizacion.numdoc From com_cotizacion Where (((com_cotizacion.numser) = '" & Format(TxtNumSer.Text, "0000") & "'))" _
            & " ORDER BY com_cotizacion.numdoc", xCon
...
Function ExisteNumDocOrdenCompra() As Boolean
    Dim Rst As New ADODB.Recordset
    Dim nSQL As String
    If QueHace <> 1 Then nSQL = " and com_cotizacion.id <> " & NulosN(RstOrd("id"))
    
    ' BUSCAMOS EN NUMERO DE DOCUMENTO
    RST_Busq Rst, "SELECT com_cotizacion.fchemi, com_cotizacion.numcot, com_cotizacion.numser & '-' & com_cotizacion.numdoc As numdoc FROM com_cotizacion WHERE numser = '" & NulosC(TxtNumSer.Text) & "' and numdoc = '" & NulosC(TxtNumDoc.Text) & "'" & nSQL, xCon
...
'* Nombre           : Grabar
'* Tipo             : FUNCION
'* Descripcion      : GRABA UN REGISTRO EN LA TABLA com_cotizacion, ESTA FUNCION DEVUELVE VERDADERO
'*                    CUANDO TIENE EXITO
'* Paranetros       :
'* Devuelve         : BOOLEAN
'*****************************************************************************************************
...
'    End If
    ...
    If QueHace = 1 Then
        ...
        ' OBTENEMOS EL ULTIMO ID DE LA TABLA com_cotizacion
        xId = HallaCodigoTabla("com_cotizacion", xCon, "id")
        LblNumero.Caption = Format(xId, "000000")
        
        RST_Busq RstCab, "SELECT * FROM com_cotizacion", xCon
        RST_Busq RstDet, "SELECT * FROM com_cotizaciondet", xCon
    ...
    Else
        ...
        xId = RstOrd("id")
        RST_Busq RstCab, "SELECT * FROM com_cotizacion WHERE id = " & xId & "", xCon
        xCon.Execute "DELETE * FROM com_cotizaciondet WHERE idcom = " & xId & ""
