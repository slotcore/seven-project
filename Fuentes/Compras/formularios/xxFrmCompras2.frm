...
Begin VB.Form FrmCompras2 
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmCompras2.frx":0000
            Key             =   "IMG1"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmCompras2.frx":0544
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmCompras2.frx":08D6
            Key             =   "IMG2"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmCompras2.frx":0A5A
            Key             =   "IMG3"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmCompras2.frx":0EAE
            Key             =   "IMG4"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmCompras2.frx":0FC6
            Key             =   "IMG5"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmCompras2.frx":150A
            Key             =   "IMG6"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmCompras2.frx":1A4E
            Key             =   "IMG7"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmCompras2.frx":1B62
            Key             =   "IMG8"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmCompras2.frx":1C76
            Key             =   "IMG9"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmCompras2.frx":20CA
            Key             =   "IMG10"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmCompras2.frx":2236
            Key             =   "IMG11"
         EndProperty
      EndProperty
   End
   Begin VB.Frame Frame6 
      ...
      Begin VSFlex7Ctl.VSFlexGrid Fg5 
         ...
         FormatString    =   $"FrmCompras2.frx":277E
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin VB.Frame Frame11 
      ...
      Begin VSFlex7Ctl.VSFlexGrid Fg4 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"FrmCompras2.frx":2839
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin SizerOneLibCtl.TabOne TabOne1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin TrueOleDBGrid70.TDBGrid Dg1 
            ...
            Splits(0)._ColumnProps(38)=   "Column(6).Width=6033"
            Splits(0)._ColumnProps(39)=   "Column(6).DividerColor=0"
            Splits(0)._ColumnProps(40)=   "Column(6)._WidthInPix=5953"
            ...
            Splits(0)._ColumnProps(50)=   "Column(8).Width=1640"
            Splits(0)._ColumnProps(51)=   "Column(8).DividerColor=0"
            Splits(0)._ColumnProps(52)=   "Column(8)._WidthInPix=1561"
            ...
            Splits(0)._ColumnProps(56)=   "Column(9).Width=1667"
            Splits(0)._ColumnProps(57)=   "Column(9).DividerColor=0"
            Splits(0)._ColumnProps(58)=   "Column(9)._WidthInPix=1588"
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VSFlex7Ctl.VSFlexGrid Fg1 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   0   'False
            FormatString    =   $"FrmCompras2.frx":33D8
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
...
Sub Eliminar()
    ...
    nSQL = "SELECT tes_cajadestinodet.iddoc, Mid([numreg],1,2) & '01' & Mid([numreg],3,4) AS registro, 'Tesoreria - Egresos' AS modulo, tes_caja.idmon, con_tc.impven AS tipcam, tes_cajadestinodet.acuenta AS imptotal, IIf([tes_caja]![idmon]=1,[tes_cajadestinodet]![acuenta],[tes_cajadestinodet]![acuenta]*[con_tc]![impven]) AS imptotsol, IIf([tes_caja]![idmon]=2,[tes_cajadestinodet]![acuenta],[tes_cajadestinodet]![acuenta]/[con_tc]![impven]) AS imptotdol " _
        ...
        + vbCr + " Where (((tes_cajadestinodet.idmod) = 1) And ((tes_caja.tipmov) = 2)) And tes_cajadestinodet.iddoc = " & xxId
    nSQL = nSQL + vbCr + " Union " _
        ...
        + vbCr + " Where (((con_diario.idlib) = 8) And ((con_canjesdet.Tipo) = 2)) And con_canjesdet.iddoc = " & xxId
    nSQL = nSQL + vbCr + " Union " _
        ...
        + vbCr + " Where (((con_diario.idlib) = 39)) And con_devolucionesdet.idcom = " & xxId
    ...
    If Rpta = vbYes Then
        ...
        If RstComp("tipcom") = 2 Then
            ...
            xCon.Execute "UPDATE alm_ingreso SET alm_ingreso.idfac = 0 WHERE (((alm_ingreso.idfac)=" & xxId & "))"
        End If
    
        If RstComp("tipcom") = 3 Then
            ' actualizamos orden de compra
            xCon.Execute "UPDATE com_ordencompra SET com_ordencompra.idfac = 0 WHERE (((com_ordencompra.idfac)=" & xxId & "))"
        End If
        
        ' --eliminando el diario
        xCon.Execute "DELETE * FROM con_diario WHERE idmov = " & xxId & " AND idlib = 1"
        
        xCon.Execute "DELETE * FROM com_comprascosto WHERE idcom = " & xxId & ""
        xCon.Execute "DELETE * FROM com_comprasdet WHERE idcom = " & xxId & ""
        xCon.Execute "DELETE * FROM com_compras WHERE id = " & xxId & ""
...
Sub MuestraSegundoTab()
    ...
    If RstDet.RecordCount <> 0 Then
        ...
        For A = 1 To RstDet.RecordCount
            ...
            Fg1.TextMatrix(Fg1.Rows - 1, 3) = NulosN(RstDet("canpro"))
            Fg1.TextMatrix(Fg1.Rows - 1, 4) = NulosN(RstDet("preunibru"))
            Fg1.TextMatrix(Fg1.Rows - 1, 5) = NulosN(RstDet("preunibruina"))
            Fg1.TextMatrix(Fg1.Rows - 1, 6) = NulosN(NulosN(RstDet("valdes")))
            Fg1.TextMatrix(Fg1.Rows - 1, 7) = NulosN(RstDet("preuni"))
            Fg1.TextMatrix(Fg1.Rows - 1, 8) = NulosN(RstDet("imptot"))
...
Private Sub CmdBusDocRef2_Click()
    ...
    If NulosN(TxtTipDocRef.Text) = 1 Then
        ...
        xform.SQLCad = "SELECT com_ordencompra.id, mae_documento.descripcion, [com_ordencompra]![numser] & '-' & [com_ordencompra]![numdoc] AS numdoc2, " _
            ...
            & " ON com_ordencompra.idtipdoc = mae_documento.id) LEFT JOIN mae_prov ON com_ordencompra.idpro = mae_prov.id Where (((com_ordencompra.idcond) = 1)) " _
    ...
    If NulosN(TxtTipDocRef.Text) = 6 Then
        ...
        xform.SQLCad = "SELECT com_ordenreq.id, com_ordenreq.idtipdoc, [com_ordenreq]![numser] & '-' & [com_ordenreq]![numdoc] AS numdoc, " _
            & " com_ordenreq.fchemi, com_ordenreq.fchent, [pla_empleados]![apepat] & ' ' & [pla_empleados]![apemat] & ', ' & [pla_empleados]![nom] AS solicitante " _
...
Sub CargarOrdenCompra(IdOrdCompra As Integer)
    ...
    If xRs.RecordCount <> 0 Then
        ...
        RST_Busq xRs, "SELECT com_ordencompradet.*, alm_inventario.descripcion, mae_unidades.abrev, alm_inventario.idcuenta, alm_inventario.idtipcom, " _
            ...
            & " WHERE (((com_ordencompradet.idoc)=1))", xCon
        ...
        If xRs.RecordCount <> 0 Then
            ...
            For A = 1 To xRs.RecordCount
                ...
                Fg1.TextMatrix(A, 2) = xRs("abrev")
                Fg1.TextMatrix(A, 3) = Format(xRs("cantidad"), "0.00")
                Fg1.TextMatrix(A, 4) = Format(xRs("impuni"), "0.00")
                Fg1.TextMatrix(A, 8) = Format(xRs("impuni") * xRs("cantidad"), "0.00")
                ...
                Fg1.TextMatrix(A, 13) = xRs("ctadesdeb")
                Fg1.TextMatrix(A, 14) = xRs("ctadeshab")
                xRs.MoveNext
...
Sub AdjuntarEntradas(Tipo As Integer, Opcion As Integer)
    ...
    If Tipo = 1 Then
        ...
        If Opcion = 1 Then
            xfrm.SQLCad = "SELECT 0 as xsel, alm_ingreso.fchdoc, mae_documento.abrev, alm_ingreso.nombre, alm_ingreso!numser+'-'+alm_ingreso!numdoc AS numdoc, alm_ingreso.id, " _
                & " (SELECT Count(1) AS numdocs From alm_ingresodoc WHERE (((alm_ingresodoc.id)=alm_ingreso.id))) AS numdocs FROM alm_ingreso LEFT JOIN mae_documento " _
                & " ON alm_ingreso.tipdoc = mae_documento.id WHERE ((((SELECT Count(1) AS numdocs From alm_ingresodoc  WHERE (((alm_ingresodoc.id)=alm_ingreso.id))))=0) " _
                & " AND ((alm_ingreso.idpro)=" & NulosN(LblIdProveedor.Caption) & ") AND ((alm_ingreso.tipmov)=-1)) ORDER BY alm_ingreso!numser+'-'+alm_ingreso!numdoc"
        Else
            xfrm.SQLCad = "SELECT 0 as xsel, alm_ingreso.fchdoc, mae_documento.abrev, alm_ingreso.nombre, alm_ingreso!numser+'-'+alm_ingreso!numdoc AS numdoc, alm_ingreso.id, " _
                & " (SELECT Count(1) AS numdocs From alm_ingresodoc WHERE (((alm_ingresodoc.id)=alm_ingreso.id))) AS numdocs FROM alm_ingreso LEFT JOIN mae_documento " _
                & " ON alm_ingreso.tipdoc = mae_documento.id WHERE ((((SELECT Count(1) AS numdocs From alm_ingresodoc  WHERE (((alm_ingresodoc.id)=alm_ingreso.id))))=0) " _
    ...
    Else
        ...
        If Opcion = 1 Then
            xfrm.SQLCad = "SELECT 0 as xsel, alm_ingreso.fchdoc, mae_documento.abrev, alm_ingreso.nombre, alm_ingreso!numser+'-'+alm_ingreso!numdoc AS numdoc, alm_ingreso.id, " _
                & " (SELECT Count(1) AS numdocs From alm_ingresodoc WHERE (((alm_ingresodoc.id)=alm_ingreso.id))) AS numdocs FROM alm_ingreso LEFT JOIN mae_documento " _
                & " ON alm_ingreso.tipdoc = mae_documento.id WHERE ((((SELECT Count(1) AS numdocs From alm_ingresodoc  WHERE (((alm_ingresodoc.id)=alm_ingreso.id))))<>0) " _
                & " AND ((alm_ingreso.idpro)=" & NulosN(LblIdProveedor.Caption) & ")) ORDER BY alm_ingreso.fchdoc"
        Else
...
'*                    IdCompra      |  IdCompra         |  ESPECITICA EL ID DE LA COMPRA
'* Devuelve         :
'*****************************************************************************************************
...
Sub BuscarImpuestos()
    ...
    Else
        ...
        For A = 1 To Fg1.Rows - 1
            ...
            xNeto2 = Fg1.TextMatrix(A, 8) * (xNeto / 100)
            xImpIGV = xNeto2 * 0.3
        Next A
...
Sub OpcionesPeriodo()
    ...
    CierrePeriodo Toolbar1, 1, mMesActivo, fCierrePeriodo, xCon
    '------------------------------------------------------------------------------------------
    TDB_FiltroLimpiar Dg1
    Set RstComp = Nothing
    '------------------------------------------
...
Function Grabar() As Boolean
    ...
    Else
        ...
        If RstDia.RecordCount <> 0 Then
            xNumAsiento = NulosC(RstDia("numasi"))
        End If
        If xNumAsiento = "" Then xNumAsiento = NuevoNumAsiento(1, mMesActivo, xCon)
...
'            RstDia.Update
        ...
        Dim xImporIGV As Double
        If NulosN(TxtIGV.Text) <> 0 Then xImporIGV = TxtIGV.Text        ' SI ES EL PRIMER IGV DE LA COMPRA
        If NulosN(TxtIGV2.Text) <> 0 Then xImporIGV = TxtIGV2.Text      ' SI ES EL SEGUNDO IGV DE LA COMPRA
        If NulosN(TxtIGV3.Text) <> 0 Then xImporIGV = TxtIGV3.Text      ' SI ES EL TERCER IGV DE LA COMPRA
        
        EscribirAsiento NulosN(AnoTra), mMesActivo, TxtIdMon.Text, 1, xId, xNumAsiento, LblTipoCambio.Caption, xIdCuenTasa, TxtFchDoc.Valor, xFchAsi, TxtTipDoc.Text, xImporIGV, 1, xCon
        
        ' GRABAMOS EL IMPUESTO PARA LAS OPERACIONES CON PROVEEDORES NO DOMICILIADOS
        If NulosN(TxtOtros.Text) <> 0 And NulosN(TxtTipDoc.Text) = 107 Then
            EscribirAsiento NulosN(AnoTra), mMesActivo, TxtIdMon.Text, 1, xId, xNumAsiento, LblTipoCambio.Caption, xIdCuenTasa, TxtFchDoc.Valor, xFchAsi, TxtTipDoc.Text, TxtOtros.Text, 1, xCon
        End If
...
'09/05/10
'Escribe mal el asiento cuando en detalle de compra hay mas de un item Ej. LR 2010 05080001
'            If A = 1 Then
'            '    xTotal = RstItem("importe")
'            End If
'
'            If xIdCue <> RstItem("idcuen") Then
...
'            Else
'                xTotal = xTotal + NulosN(RstItem("importe"))
'            End If
'            RstItem.MoveNext
...
'            End If
        ...
        xNumAsiento = Format(Busca_Codigo(1, "id", "codsun", "mae_libros", "N", xCon), "00") & Format(mMesActivo, "00") & xNumAsiento
        If NulosN(TxtTipDoc.Text) <> 7 Then
...
Private Sub TxtTipDocRef_Validate(Cancel As Boolean)
    ...
    Dim xRs1 As New ADODB.Recordset
    SeSeleTipDocRef = True
    RST_Busq xRs1, "SELECT * FROM mae_docreferencia WHERE id = " & Val(TxtTipDocRef.Text) & "", xCon
