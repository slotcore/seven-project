...
Begin VB.Form FrmConsHonorario 
   Caption         =   "Compras - Consulta de Renta de 4ta Categoria"
   ClientHeight    =   8085
   ClientLeft      =   120
   ClientTop       =   615
   ClientWidth     =   12045
   HasDC           =   0   'False
   Icon            =   "FrmConsHonorario.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   ScaleHeight     =   8085
   ...
   Begin VSFlex7Ctl.VSFlexGrid Fg1 
      ...
      FormatString    =   $"FrmConsHonorario.frx":000C
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmConsHonorario.frx":0243
               Key             =   "IMG1"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmConsHonorario.frx":0787
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmConsHonorario.frx":0B19
               Key             =   "IMG2"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmConsHonorario.frx":0C9D
               Key             =   "IMG3"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmConsHonorario.frx":10F1
               Key             =   "IMG4"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmConsHonorario.frx":1209
               Key             =   "IMG5"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmConsHonorario.frx":174D
               Key             =   "IMG6"
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmConsHonorario.frx":1C91
               Key             =   "IMG7"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmConsHonorario.frx":1DA5
               Key             =   "IMG8"
            EndProperty
            BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmConsHonorario.frx":1EB9
               Key             =   "IMG9"
            EndProperty
            BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmConsHonorario.frx":230D
               Key             =   "IMG10"
            EndProperty
            BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmConsHonorario.frx":2479
               Key             =   "IMG11"
            EndProperty
            BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmConsHonorario.frx":29C1
               Key             =   ""
            EndProperty
            BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmConsHonorario.frx":2CDB
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin SizerOneLibCtl.TabOne TabOne2 
      ...
      Begin VB.Frame Frame11 
         ...
         Begin VSFlex7Ctl.VSFlexGrid Fg3 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   0   'False
            FormatString    =   $"FrmConsHonorario.frx":306D
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
         ...
         Begin VSFlex7Ctl.VSFlexGrid Fg2 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   0   'False
            FormatString    =   $"FrmConsHonorario.frx":30DE
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
      ...
      Begin VB.Frame Frame7 
         ...
         Begin VB.CommandButton CmdBusProducto 
            Height          =   240
            Left            =   7845
            Picture         =   "FrmConsHonorario.frx":3159
            Style           =   1  'Graphical
            TabIndex        =   33
            Top             =   315
            Width           =   225
   ...
   End
End
Attribute VB_Name = "FrmConsHonorario"
    ...
    DoEvents
        ...
        For i = 0 To vCampos - 1
            ...
            If Me.OptDetalle.Value = True And Me.ChkMostrarItem.Value = 1 And LCase(vStrCampo) = "total_pu_mn" Then
                '--PARA ACUMULAR LOS REGISTROS ENCONTRDOS POR PRESTADORES DE SERVICIO Y A LA VEZ ACUMULAR LOS REGISTROS ENCONTRADO DE TODA LA CONSULTA
                '--NOS SERVIRA PARA CALCULAR EL PRE. PROM. POR PRESTADORES DE SERVICIO Y PRE. PROM. GRAL
...
Private Function pGenerarConsulta() As String
    ...
    Dim nSQLFiltro_CLI As String    '--SOLO PRESTADORES DE SERVICIO
    ...
    '--DE LA FECHA
    If CDate(TxtFchIni.Valor) < CDate(TxtFchFin.Valor) Then
        'nSQLFecha = " com_honorarios.fchdoc >= cdate('" + Format(TxtFchIni.Valor, "dd/mm/yyyy") + "') AND com_honorarios.fchdoc<= cdate('" + Format(TxtFchFin.Valor, "dd/mm/yyyy") + "') "
        nSQLFecha = " com_honorarios.fchdoc between cdate('" + Format(TxtFchIni.Valor, "dd/mm/yyyy") + "') AND cdate('" + Format(TxtFchFin.Valor, "dd/mm/yyyy") + "') "
        T_RPT_PERIODO = " Del: " + TxtFchIni.Valor + " Al: " + TxtFchFin.Valor
    Else
        nSQLFecha = " com_honorarios.fchdoc = cdate('" + Format(TxtFchIni.Valor, "dd/mm/yyyy") + "') "
        T_RPT_PERIODO = "Al: " + TxtFchFin.Valor
    End If
    
    '--SI OPCION DE SELECCIONAR POR FECHA DE VENCIMIENTO
    If Me.OptVenc.Value = True Then nSQLFecha = Replace(nSQLFecha, "com_honorarios.fchdoc", "com_honorarios.fchven")
    
    '--SI OPCION SELECCIONA POR FECHA DE REGISTRO
    If Me.OptReg.Value = True Then nSQLFecha = Replace(nSQLFecha, "com_honorarios.fchdoc", "com_honorarios.fchreg")
    ...
    vFiltro = vFiltro & GRID_GENERAR_SQL_ID(Fg3, 1, " AND com_honorarios.idpro", "IN")
 
    '--DE LA MONEDA
    If OptSol.Value = True Then vFiltro = vFiltro + " AND com_honorarios.idmon= 1 "       '--SOLES
    If Me.OptDol.Value = True Then vFiltro = vFiltro + " AND com_honorarios.idmon= 2 "    '--DOLARES
    '---------------
    
    If OptPag.Value = True Then         '---SI ES CANCELADO
        vFiltro = vFiltro + " AND com_honorarios.impsal = 0 "
    ...
    If chkAnioPasados.Value = 0 Then nSQLFiltro = nSQLFiltro & " and com_honorarios.numreg<>'000001' "
    ...
    If OptResum.Value = True Then '--RESUMEN
        ...
        nSQL = "SELECT vista.numruc, vista.nomcliente, vista.desctipcom, Sum(vista.impdmn) AS totdmn, Sum(vista.impdme) AS totdme, Sum(vista.impdexpmn) AS totdexpmn, Sum(vista.impdexpme) AS totdexpme " _
            + vbCr + " FROM ( " _
            + vbCr + " SELECT Left([com_honorarios].[numreg],2) & Format(mae_libros.codsun,'00') & Right([com_honorarios].[numreg],4) AS registro, mae_prov.numruc, mae_prov.nombre AS nomcliente, mae_documento.abrev AS tdocabrev, com_honorarios!numser+'-'+com_honorarios!numdoc AS numerodoc, com_honorarios.fchdoc, com_honorarios.fchven, mae_condpago.abrev AS conpagabre, " _
            + vbCr + " IIf([com_honorarios].[impsal]<>0 And Date()>=[com_honorarios.fchven],Date()-[com_honorarios.fchven],'') AS diasvenc, mae_moneda.simbolo, IIf([com_honorarios].[tc]=0,IIf([con_tc].[impven] Is Null,0,[con_tc].[impven]),[com_honorarios].[tc]) AS tipcam, " _
            + vbCr + " com_honorarios.idpro, com_honorarios.tipdoc, com_honorarios.idmon, " _
            + vbCr + " mae_tipoproducto.descripcion AS desctipcom, alm_inventario.codpro as codigo ,alm_inventario.descripcion, mae_unidades.abrev AS prodabrev, com_honorariosdet.canpro, " _
            + vbCr + " IIf([com_honorarios].[tipdoc]=7,(-1)*[com_honorariosdet].[imptot],[com_honorariosdet].[imptot]) AS impdreal, " _
            + vbCr + " IIf([com_honorarios].[idmon]=2,[com_honorariosdet].[preuni],0) AS pume, " _
            + vbCr + " IIf([com_honorarios].[idmon]=2,[impdreal],0) AS impdme, " _
            + vbCr + " IIf([com_honorarios].[idmon]=1,[com_honorariosdet].[preuni],0) AS pumn, " _
            + vbCr + " IIf([com_honorarios].[idmon]=1,[impdreal],0) AS impdmn, " _
            + vbCr + " IIf([com_honorarios].[idmon]=1,[impdmn],[impdreal]*[tipcam]) AS impdexpmn, " _
            + vbCr + " IIf([com_honorarios].[idmon] = 2, [impdme], IIf([tipcam] = 0, 0, [impdreal] / [tipcam])) As impdexpme " _
            + vbCr + " FROM ((mae_prov RIGHT JOIN (((((com_honorarios LEFT JOIN mae_documento ON com_honorarios.tipdoc = mae_documento.id) LEFT JOIN mae_moneda ON com_honorarios.idmon = mae_moneda.id) LEFT JOIN con_tc ON com_honorarios.fchdoc = con_tc.fecha) LEFT JOIN mae_libros ON com_honorarios.idlib = mae_libros.id) LEFT JOIN mae_condpago ON com_honorarios.idconpag = mae_condpago.id) ON mae_prov.id = com_honorarios.idpro) INNER JOIN com_honorariosdet ON com_honorarios.id = com_honorariosdet.idhon) LEFT JOIN (mae_unidades RIGHT JOIN (mae_tipoproducto RIGHT JOIN alm_inventario ON mae_tipoproducto.id = alm_inventario.tippro) ON mae_unidades.id = alm_inventario.idunimed) ON com_honorariosdet.iditem = alm_inventario.id " _
        ...
        Else '--GENERAL
                ...
                T_RPT_TITULO = "REPORTE DE COMPRAS RESUMIDO POR PRESTADOR DE SERVICIO"
                ...
                nSQL = "SELECT vista.numruc, vista.nomcliente , Count(vista.numruc) AS candoc, Sum(vista.impmn) AS totmn, Sum(vista.impsalmn) AS totsalmn, Sum(vista.impme) AS totme, Sum(vista.impsalme) AS totsalme,  Sum(vista.impexpmn) AS totexpmn, totexpmn-totsalexpmn AS totaboexpmn , Sum(vista.impsalexpmn) AS totsalexpmn,Sum(vista.impexpme) AS totexpme, totexpme-totsalexpme AS totaboexpme , Sum(vista.impsalexpme) AS totsalexpme " _
                    + vbCr + "  FROM ( " _
                        ...
                        + vbCr + " IIf([com_honorarios].[impsal]<>0 And Date()>=[com_honorarios.fchven],Date()-[com_honorarios.fchven],'') AS diasvenc, mae_moneda.simbolo, " _
                        + vbCr + " IIf([com_honorarios].[tc]=0,IIf([con_tc].[impven] is null,0,[con_tc].[impven]),[com_honorarios].[tc]) AS tipcam, " _
                        + vbCr + " IIf(com_honorarios.tipdoc=7,(-1)*com_honorarios.imptot,com_honorarios.imptot) AS impreal, " _
                        + vbCr + " IIf(com_honorarios.idmon=1,impreal,0) AS impmn, " _
                        + vbCr + " IIf(com_honorarios.idmon=2,impreal,0) AS impme, " _
                        + vbCr + " IIf(com_honorarios.tipdoc=7,(-1)*com_honorarios.impsal,com_honorarios.impsal) AS impsalreal, " _
                        + vbCr + " IIf(com_honorarios.idmon=1,impsalreal,0) AS impsalmn, " _
                        + vbCr + " IIf(com_honorarios.idmon=2,impsalreal,0) AS impsalme, " _
                        ...
                        + vbCr + " com_honorarios.idpro , com_honorarios.TipDoc, com_honorarios.idmon " _
                        + vbCr + " FROM mae_prov RIGHT JOIN (((((com_honorarios LEFT JOIN mae_documento ON com_honorarios.tipdoc = mae_documento.id) LEFT JOIN mae_moneda ON com_honorarios.idmon = mae_moneda.id) LEFT JOIN con_tc ON com_honorarios.fchdoc = con_tc.fecha) LEFT JOIN mae_libros ON com_honorarios.idlib = mae_libros.id) LEFT JOIN mae_condpago ON com_honorarios.idconpag = mae_condpago.id) ON mae_prov.id = com_honorarios.idpro " _
                        + vbCr + " WHERE  " & nSQLFiltro _
                    + vbCr + "  ) AS vista " _
    ...
    Else '--DETALLADO
        If ChkMostrarItem.Value = 1 Or TxtIdTipProd.Text <> "" Then
            If TxtIdTipProd.Text <> "" And ChkMostrarItem.Value = 0 Then '--MOSTRAR SOLO PRODUCTO
                ...
                '--en esta consulta solo se considera la base imponible
                nSQL = "SELECT vista.registro, vista.tdocabrev, vista.nomcliente, vista.numerodoc, vista.fchdoc, vista.fchven, vista.conpagabre, vista.diasvenc, vista.simbolo, vista.tipcam, vista.desctipcom, Sum(vista.impdmn) AS totdmn, Sum(vista.impdme) AS totdme, Sum(vista.impdexpmn) AS totdexpmn, Sum(vista.impdexpme) AS totdexpme " _
                    + vbCr + " FROM ( " _
                    + vbCr + " SELECT Left([com_honorarios].[numreg],2) & Format(mae_libros.codsun,'00') & Right([com_honorarios].[numreg],4) AS registro, mae_prov.numruc, mae_prov.nombre AS nomcliente, mae_documento.abrev AS tdocabrev, com_honorarios!numser+'-'+com_honorarios!numdoc AS numerodoc, com_honorarios.fchdoc, com_honorarios.fchven, mae_condpago.abrev AS conpagabre, " _
                    + vbCr + " IIf([com_honorarios].[impsal]<>0 And Date()>=[com_honorarios.fchven],Date()-[com_honorarios.fchven],'') AS diasvenc, mae_moneda.simbolo, IIf([com_honorarios].[tc]=0,IIf([con_tc].[impven] Is Null,0,[con_tc].[impven]),[com_honorarios].[tc]) AS tipcam, " _
                    + vbCr + " com_honorarios.idpro, com_honorarios.tipdoc, com_honorarios.idmon, " _
            ...
            '--MOSTRAR PRODUCTO Y ITEM
                T_RPT_TITULO = "REPORTE DE COMPRAS DETALLADO POR TIPO PRODUCTO CON ITEM"
                    ...
                    '--en esta consulta solo se considera la base imponible
                    nSQL = "SELECT registro,tdocabrev,nomcliente,numerodoc,fchdoc,fchven,conpagabre,diasvenc,simbolo,tipcam,desctipcom,codigo,descripcion,prodabrev,canpro,pumn,impdmn,pume,impdme,impdexpmn,impdexpme " _
                    + vbCr + " FROM ( " _
                    + vbCr + " SELECT Left([com_honorarios].[numreg],2) & Format(mae_libros.codsun,'00') & Right([com_honorarios].[numreg],4) AS registro, mae_prov.numruc, mae_prov.nombre AS nomcliente, mae_documento.abrev AS tdocabrev, com_honorarios!numser+'-'+com_honorarios!numdoc AS numerodoc, com_honorarios.fchdoc, com_honorarios.fchven, mae_condpago.abrev AS conpagabre, " _
                    + vbCr + " IIf([com_honorarios].[impsal]<>0 And Date()>=[com_honorarios.fchven],Date()-[com_honorarios.fchven],'') AS diasvenc, mae_moneda.simbolo, IIf([com_honorarios].[tc]=0,IIf([con_tc].[impven] Is Null,0,[con_tc].[impven]),[com_honorarios].[tc]) AS tipcam, " _
                    + vbCr + " com_honorarios.idpro, com_honorarios.tipdoc, com_honorarios.idmon, " _
        ...
        Else '--MOSTRAR SIN DETALLE
            ...
            T_RPT_TITULO = "REPORTE DE COMPRAS DETALLADO POR PRESTADOR DE SERVICIO"

                nSQL = "SELECT registro,tdocabrev,nomcliente,numerodoc,fchdoc,fchven,conpagabre,diasvenc,simbolo,tipcam,impmn,impsalmn,impme,impsalme,impexpmn, (impexpmn-impsalexpmn) as impaboexpmn ,impsalexpmn " _
                    + vbCr + "  FROM ( " _
                        + vbCr + " SELECT Left([com_honorarios].[numreg],2) & Format(mae_libros.codsun,'00') & Right([com_honorarios].[numreg],4) AS registro, mae_prov.numruc, mae_prov.nombre as nomcliente, mae_documento.abrev AS tdocabrev, com_honorarios!numser+'-'+com_honorarios!numdoc AS numerodoc, com_honorarios.fchdoc, com_honorarios.fchven, mae_condpago.abrev AS conpagabre, " _
                        + vbCr + " IIf([com_honorarios].[impsal]<>0 And Date()>=[com_honorarios.fchven],Date()-[com_honorarios.fchven],'') AS diasvenc, mae_moneda.simbolo, " _
                        + vbCr + " IIf([com_honorarios].[tc]=0,IIf([con_tc].[impven] is null,0,[con_tc].[impven]),[com_honorarios].[tc]) AS tipcam, " _
...
Private Sub Comparar_Grupo(RST_ORIGEN As ADODB.Recordset, BAND_ADD_REG As Boolean)
    '--FUNCION QUE NOS PERMITE ARMAR LOS GRUPOS POR EL PRESTADOR DE SERVICIO
    '--CUANDO SE GENERA EL GRUPO SE ARGEGA EL NOMBRE DEL PRESTADOR DE SERVICIO COMO CABECERA
    ...
    '---------------------------------------------------------
    If RST_ORIGEN.Bookmark <> 1 Then
        If NulosC(RST_TEPM_1.Fields("nomcliente")) <> NulosC(RST_ORIGEN.Fields("nomcliente")) Then  '--PRESTADOR DE SERVICIO
    ...
    If Me.OptResum.Value = True Then '--RESUMEN
        With Fg1
            If Trim(Me.TxtIdTipProd.Text) <> "" Or Me.ChkMostrarItem.Value = 1 Then
                .ColWidth(1) = 0 'RUC
                .ColWidth(2) = 0 'PRESTADOR DE SERVICIO
            Else
                .TextMatrix(1, 1) = "RUC":          .ColWidth(1) = 1200:    .ColAlignment(1) = flexAlignCenterBottom
                .TextMatrix(1, 2) = "Prestador de Servicio":      .ColWidth(2) = 2500:    .ColAlignment(2) = flexAlignLeftBottom
            End If
...
'                If Me.OptSol.Value = True Then .ColWidth(4) = 0: .ColWidth(5) = 0
    ...
    Else '--DETALLE
        With Fg1
            ...
            .TextMatrix(1, 3) = "Prestador de Servicio":    .ColWidth(3) = 0:     .ColAlignment(3) = flexAlignLeftBottom
            ...
            .TextMatrix(1, 7) = "Cond. Pago":       .ColWidth(7) = 950:     .ColAlignment(7) = flexAlignLeftCenter
            ...
            If Me.TxtIdTipProd.Text <> "" And Me.ChkMostrarItem.Value = 0 Then '--SOLO PRODUCTO
                ...
                .TextMatrix(1, 12) = "MN":      .ColWidth(12) = 1000: .ColAlignment(12) = flexAlignRightBottom
                .TextMatrix(1, 13) = "ME":    .ColWidth(13) = 1000: .ColAlignment(13) = flexAlignRightBottom
                .TextMatrix(1, 14) = "MN":   .ColWidth(14) = 1000: .ColAlignment(14) = flexAlignRightBottom
                .TextMatrix(1, 15) = "ME":   .ColWidth(15) = 1000: .ColAlignment(15) = flexAlignRightBottom
'                '--SOLO DOLARES OCULTAR SOLES
'                If Me.OptDol.Value = True Then .ColWidth(13) = 0:
'                '--SOLO SOLES OCULTAR DOLARES
'                If Me.OptSol.Value = True Then .ColWidth(12) = 0
                '--SOLO PAGADO OCULTAR SALDOS
    '            If Me.OptPag.Value = True Then .ColWidth(11) = 0: .ColWidth(13) = 0: .ColWidth(16) = 0
                UNIR_CELDAS Fg1, 0, 1, 0, 11, " "
                UNIR_CELDAS Fg1, 0, 12, 0, 13, "TOTALES"
                UNIR_CELDAS Fg1, 0, 14, 0, 15, "EXPRESADO EN"
                OCULTAR_COL Fg1, 16, Fg1.Cols - 1
            ...
            ElseIf Me.ChkMostrarItem.Value = 1 Then '--ITEM
                ...
                .TextMatrix(1, 12) = "Código":    .ColWidth(12) = 900:    .ColAlignment(11) = flexAlignLeftBottom
                
                .TextMatrix(1, 13) = "Item":        .ColWidth(13) = 2800:   .ColAlignment(13) = flexAlignLeftBottom
                
                .TextMatrix(1, 14) = "U.M.":        .ColWidth(14) = 500:    .ColAlignment(14) = flexAlignLeftBottom
                .TextMatrix(1, 15) = "Cant.":       .ColWidth(15) = 700:    .ColAlignment(15) = flexAlignRightBottom
                .TextMatrix(1, 16) = "P/U":         .ColWidth(16) = 500:    .ColAlignment(16) = flexAlignRightBottom
                .TextMatrix(1, 17) = "Imp.Total":   .ColWidth(17) = 900:    .ColAlignment(17) = flexAlignRightBottom
                .TextMatrix(1, 18) = "P/U":         .ColWidth(18) = 500:    .ColAlignment(18) = flexAlignRightBottom
                .TextMatrix(1, 19) = "Imp.Total":   .ColWidth(19) = 900:    .ColAlignment(19) = flexAlignRightBottom
                .TextMatrix(1, 20) = "MN":          .ColWidth(20) = 1000:   .ColAlignment(20) = flexAlignRightBottom
                .TextMatrix(1, 21) = "ME":          .ColWidth(21) = 1000:   .ColAlignment(21) = flexAlignRightBottom
                
                UNIR_CELDAS Fg1, 0, 1, 0, 15, " "
                UNIR_CELDAS Fg1, 0, 16, 0, 17, "MN"
                UNIR_CELDAS Fg1, 0, 18, 0, 19, "ME"
                UNIR_CELDAS Fg1, 0, 20, 0, 21, "EXPRESADO EN"
                
            Else
                .FrozenCols = 6
                UNIR_CELDAS Fg1, 0, 11, 0, 12, "MN"
                ...
                UNIR_CELDAS Fg1, 0, 15, 0, 17, "EXPRESADO EN MN"
...
Private Function VERIFICAR_PONER_PRECIO_PROMEDIO() As Boolean
    ...
    '--SOLO ESTA ACTIVO CUANDO SELECCIONE UN ITEM, LA SELECCION DE PRESTADOR DE SERVICIO
...
Private Function Verificar_Poner_Datos_Grls() As Boolean
    ...
    '--NO INSERTARA CUANDO SELECCIONA UN PRESTADOR DE SERVICIO
...
Private Sub pCargarProveedor(Seleccionar As Boolean)
    ...
    nSQLNotIn = GRID_GENERAR_SQL_ID(Fg3, 1, " and mae_prov.id", "NOT IN", True)
    
    '--si se ingresa algun filtro adicional
    If NulosC(Fg3.TextMatrix(Fg3.Row, Fg3.Col)) <> "" Then
        nSQLNotIn = nSQLNotIn & " and  (UCASE(mae_prov.nombre) LIKE '%" & UCase(NulosC(Fg3.TextMatrix(Fg3.Row, Fg3.Col))) & "%' OR UCASE(mae_prov.nombre) LIKE '%" & UCase(NulosC(Fg3.TextMatrix(Fg3.Row, Fg3.Col))) & "%' ) "
    End If
    
    Fg3.TextMatrix(Fg3.Row, Fg3.Col) = ""
    
    nSQL = "SELECT 0 as xsel,* FROM mae_prov where mae_prov.tipper=1 and mae_prov.idtipdoc=5 " & nSQLNotIn & " order by nombre asc"

    
    If Seleccionar = False Then
        CARGAR_DLL_EPSBUSCAR xCon, xRs, nSQL, xCampos(), "Buscando Prestador de Servicio", "nombre", "nombre", Principio
    Else
        CARGAR_DLL_EPSBUSCAR_SEL xCon, xRs, nSQL, xCampos(), "Seleccionando Prestadores de Servicio"
    End If
