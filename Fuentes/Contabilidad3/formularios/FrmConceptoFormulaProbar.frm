VERSION 5.00
Begin VB.Form FrmConceptoFormulaProbar 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Contabilidad - Concepto - Probar Fórmula"
   ClientHeight    =   5055
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   5055
   ...
   Begin VB.TextBox txt_formula 
      ...
      TabIndex        =   1
      Text            =   "FrmConceptoFormulaProbar.frx":0000
      Top             =   3885
      Width           =   5010
   End
   Begin VB.TextBox txt 
   ...
   End
End
Attribute VB_Name = "FrmConceptoFormulaProbar"
...
Private Sub cmdCalcular_Click()
    '--aplicar la formula
    '--primero cargar los valores a las variables
    Dim i           As Long
    Dim J           As Long
